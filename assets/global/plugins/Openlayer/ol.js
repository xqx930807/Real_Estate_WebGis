...
(function(root, factory) {
	...
	function u(a, c, d) { a = a.split(".");
		d = d || aa;
		a[0] in d || !d.execScript || d.execScript("var " + a[0]);
		for (var e; a.length && (e = a.shift());) !a.length && ba(c) ? d[e] = c : d[e] ? d = d[e] : d = d[e] = {} }

	function da(a) { a.Zb = function() {
	...
	function ea(a) {
		...
		if ("object" == c)
			if (a) {
				...
				if ("[object Function]" == d || "undefined" != typeof a.call && "undefined" != typeof a.propertyIsEnumerable && !a.propertyIsEnumerable("call")) return "function" } else return "null";
	...
	function pa(a, c, d) { pa = Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? na : oa;
	...
	function xa(a) {
		if (!ya.test(a)) return a; - 1 != a.indexOf("&") && (a = a.replace(za, "&amp;")); - 1 != a.indexOf("<") && (a = a.replace(Ba, "&lt;")); - 1 != a.indexOf(">") && (a = a.replace(Ca, "&gt;")); - 1 != a.indexOf('"') && (a = a.replace(Ea, "&quot;")); - 1 != a.indexOf("'") && (a = a.replace(Fa, "&#39;")); - 1 != a.indexOf("\x00") && (a = a.replace(Ga, "&#0;"));
		return a }
	var za = /&/g,
		Ba = /</g,
		Ca = />/g,
	...
	function Ka(a, c) {
		for (var d = 0, e = wa(String(a)).split("."), f = wa(String(c)).split("."), g = Math.max(e.length, f.length), h = 0; 0 == d && h < g; h++) {
			var k = e[h] || "",
				m = f[h] || "",
				n = RegExp("(\\d*)(\\D*)", "g"),
				p = RegExp("(\\d*)(\\D*)", "g");
			do {
				...
				d = La(0 == q[1].length ? 0 : parseInt(q[1], 10), 0 == r[1].length ? 0 : parseInt(r[1], 10)) || La(0 == q[2].length, 0 == r[2].length) || La(q[2], r[2]) } while (0 == d) }
		return d }
	...
	var Na = function() {
		var a; "cosh" in Math ? a = Math.cosh : a = function(a) { a = Math.exp(a);
			return (a + 1 / a) / 2 };
		return a }();
	...
	function Sa(a) {
		return function(c) {
			if (c) return [Ma(c[0], a[0], a[2]), Ma(c[1], a[1], a[3])] } }
	...
	function Wa(a, c, d) {
		...
		if (!(c <= a[e - 1]))
			if (0 < d)
				for (d = 1; d < e; ++d) {
					if (a[d] < c) return d - 1 } else if (0 > d)
					for (d = 1; d < e; ++d) {
						if (a[d] <= c) return d } else
						for (d = 1; d < e; ++d) {
							if (a[d] == c) return d;
	...
	function eb(a, c) {
		var d;
		return a.every(function(e, f) { d = f;
			return !c(e, f, a) }) ? -1 : d };

	function fb(a) {
		return function(c, d, e) {
			if (void 0 !== c) return c = Wa(a, c, e), c = Ma(c + d, 0, a.length - 1), a[c] } }
	...
	function lb(a, c, d) { this.center = a;
		this.resolution = c;
		this.rotation = d };
	...
	function tb(a, c, d, e) {
		for (var f, g = 0, h = a.length; g < h; ++g)
			if (f = a[g], f.listener === c && f.dg === d) return e && (f.deleteIndex = g), f }
	...
	function wb(a, c) {
		var d = ub(a, c);
		if (d) {
			for (var e = 0, f = d.length; e < f; ++e) a.removeEventListener(c, d[e].eg), nb(d[e]);
			d.length = 0;
	...
	function D(a, c, d, e, f) {
		var g = vb(a),
			h = g[c];
		h || (h = g[c] = []);
		(g = tb(h, d, e, !1)) ? f || (g.fg = !1): (g = { dg: e, fg: !!f, listener: d, target: a, type: c }, a.addEventListener(c, rb(g)), h.push(g));
		return g }
	...
	function sb(a) {
		if (a && a.target) { a.target.removeEventListener(a.type, a.eg);
	...
	function zb() { 0 != Ab && (Bb[x(this)] = this);
		this.Ga = this.Ga;
		this.ua = this.ua }
	var Ab = 0,
		Bb = {};
	...
	function Cb(a, c) { a.Ga ? c.call(void 0) : (a.ua || (a.ua = []), a.ua.push(ba(void 0) ? pa(c, void 0) : c)) }
	zb.prototype.fa = function() {
		if (this.ua)
			for (; this.ua.length;) this.ua.shift()() };

	function Db(a) { a && "function" == typeof a.Rd && a.Rd() };

	function Eb(a, c) { this.type = a;
		this.target = c }
	Eb.prototype.preventDefault = Eb.prototype.stopPropagation = function() { this.Jn = !0 };

	function Fb(a) { a.stopPropagation() }

	function Gb(a) { a.preventDefault() };
	...
	Hb.prototype.addEventListener = function(a, c) {
		var d = this.ta[a];
		d || (d = this.ta[a] = []); - 1 === d.indexOf(c) && d.unshift(c) };
	Hb.prototype.b = function(a) { a = "string" === typeof a ? new Eb(a) : a;
		var c = a.type;
		a.target = this;
		if (c = this.ta[c])
			for (var d = c.length - 1; 0 <= d; --d)
				if (!1 === c[d].call(this, a) || a.Jn) return !1 };
	Hb.prototype.fa = function() {
		var a = vb(this),
			c;
		for (c in a) wb(this, c);
		Hb.ha.fa.call(this) };
	...
	function Kb(a) {
		if (Array.isArray(a))
			for (var c = 0, d = a.length; c < d; ++c) sb(a[c]);
		else sb(a) }
	l = Jb.prototype;
	l.u = function() {++this.g;
		this.b("change") };
	...
	l.I = function(a, c, d) {
		if (Array.isArray(a)) {
			for (var e = a.length, f = Array(e), g = 0; g < e; ++g) f[g] = D(this, a[g], c, d);
			return f }
		return D(this, a, c, d) };
	l.M = function(a, c, d) {
		if (Array.isArray(a)) {
	...
	l.K = function(a, c, d) {
		if (Array.isArray(a))
			for (var e = 0, f = a.length; e < f; ++e) yb(this, a[e], c, d);
		else yb(this, a, c, d) };
	l.N = Kb;

	function Lb(a, c, d) { Eb.call(this, a);
		this.key = c;
		this.oldValue = d }
	y(Lb, Eb);

	function Mb(a) { Jb.call(this);
		x(this);
		this.T = {};
		void 0 !== a && this.C(a) }
	y(Mb, Jb);
	...
	l.set = function(a, c, d) { d ? this.T[a] = c : (d = this.T[a], this.T[a] = c, d !== c && Pb(this, a, d)) };
	l.C = function(a, c) {
	...
	function Qb(a, c, d) { void 0 === d && (d = [0, 0]);
		d[0] = a[0] + 2 * c;
		d[1] = a[1] + 2 * c;
		return d }

	function Rb(a, c, d) { void 0 === d && (d = [0, 0]);
		d[0] = a[0] * c + .5 | 0;
		d[1] = a[1] * c + .5 | 0;
		return d }
	...
	var Tb = Array.prototype,
		Ub = Tb.indexOf ? function(a, c, d) {
			return Tb.indexOf.call(a, c, d) } : function(a, c, d) { d = null == d ? 0 : 0 > d ? Math.max(0, a.length + d) : d;
			if (ha(a)) return ha(c) && 1 == c.length ? a.indexOf(c, d) : -1;
			for (; d < a.length; d++)
				if (d in a && a[d] === c) return d;
			return -1 },
		Vb = Tb.forEach ? function(a, c, d) { Tb.forEach.call(a, c, d) } : function(a, c, d) {
			for (var e = a.length, f = ha(a) ? a.split("") : a, g = 0; g < e; g++) g in f && c.call(d, f[g], g, a) },
		Wb = Tb.filter ? function(a, c, d) {
			return Tb.filter.call(a, c, d) } : function(a, c, d) {
			for (var e = a.length, f = [],
					g = 0, h = ha(a) ? a.split("") : a, k = 0; k < e; k++)
				if (k in h) {
					var m = h[k];
	...
	function dc(a, c, d) { a = $b(a + 180, 360) - 180;
	...
	function kc(a) { this.length = a.length || a;
		for (var c = 0; c < this.length; c++) this[c] = a[c] || 0 }
	kc.prototype.b = 4;
	kc.prototype.set = function(a, c) { c = c || 0;
	...
	function lc(a) { this.length = a.length || a;
		for (var c = 0; c < this.length; c++) this[c] = a[c] || 0 }
	lc.prototype.b = 8;
	lc.prototype.set = function(a, c) { c = c || 0;
		for (var d = 0; d < a.length && c + d < this.length; d++) this[c + d] = a[d] };
	lc.prototype.toString = Array.prototype.join;
	if ("undefined" == typeof Float64Array) {
		try { lc.BYTES_PER_ELEMENT = 8 } catch (a) {}
	...
	function oc(a, c, d, e, f, g, h, k, m, n, p, q, r, t, v, w, z) { a[0] = c;
		a[1] = d;
		a[2] = e;
		a[3] = f;
		a[4] = g;
	...
	function tc(a, c) {
		...
		0 != Pa && (Pa = 1 / Pa, c[0] = (k * ab - m * Ia + n * Da) * Pa, c[1] = (-e * ab + f * Ia - g * Da) * Pa, c[2] = (w * P - z * M + C * J) * Pa, c[3] = (-q * P + r * M - t * J) * Pa, c[4] = (-h * ab + m * ca - n * I) * Pa, c[5] = (d * ab - f * ca + g * I) * Pa, c[6] = (-v * P + z * L - C * B) * Pa, c[7] = (p * P - r * L + t * B) * Pa,
			c[8] = (h * Ia - k * ca + n * Aa) * Pa, c[9] = (-d * Ia + e * ca - g * Aa) * Pa, c[10] = (v * M - w * L + C * A) * Pa, c[11] = (-p * M + q * L - t * A) * Pa, c[12] = (-h * Da + k * I - m * Aa) * Pa, c[13] = (d * Da - e * I + f * Aa) * Pa, c[14] = (-v * J + w * B - z * A) * Pa, c[15] = (p * J - q * B + r * A) * Pa)
	}
	...
	function vc(a, c, d) { oc(a, a[0] * c, a[1] * c, a[2] * c, a[3] * c, a[4] * d, a[5] * d, a[6] * d, a[7] * d, 1 * a[8], 1 * a[9], 1 * a[10], 1 * a[11], a[12], a[13], a[14], a[15]) }
	...
	function xc(a) {
		for (var c = yc(), d = 0, e = a.length; d < e; ++d) zc(c, a[d]);
		return c }
	...
	function Cc(a, c, d) { c = c < a[0] ? a[0] - c : a[2] < c ? c - a[2] : 0;
	...
	function Kc(a, c, d, e, f) { f = Ic(Infinity, Infinity, -Infinity, -Infinity, f);
		return Lc(f, a, c, d, e) }

	function Mc(a, c) {
		return a[0] == c[0] && a[2] == c[2] && a[1] == c[1] && a[3] == c[3] }

	function Nc(a, c) { c[0] < a[0] && (a[0] = c[0]);
		c[2] > a[2] && (a[2] = c[2]);
		c[1] < a[1] && (a[1] = c[1]);
		c[3] > a[3] && (a[3] = c[3]);
		return a }

	function zc(a, c) { c[0] < a[0] && (a[0] = c[0]);
		c[0] > a[2] && (a[2] = c[0]);
		c[1] < a[1] && (a[1] = c[1]);
		c[1] > a[3] && (a[3] = c[1]) }
	...
	function cd(a, c, d) { a = [a[0], a[1], a[0], a[3], a[2], a[1], a[2], a[3]];
		c(a, a, 2);
	...
	*/
	...
	function nd(a) {
		...
		if ("function" == typeof e && void 0 === c[d]) {
			...
			if (void 0 !== f) {
				...
				for (var g in c) c = e.defs(g), void 0 !== c && (a = qd(g), c === f ? rd([a, this]) : (c = e(g, d), sd(a, this, c.forward, c.inverse)))
			}
		}
	}
	l = nd.prototype;
	...
	l.Tk = function() {
		return this.g };
	l.uo = function(a) { this.g = a;
		this.b = !(!a || !this.c) };
	l.nm = function(a) { this.c = a;
		this.b = !(!this.g || !a) };
	l.Co = function(a) { this.i = a };
	l.to = function(a) { this.l = a };
	l.Xj = function(a, c) {
	...
	function rd(a) { wd(a);
		a.forEach(function(c) { a.forEach(function(a) { c !== a && xd(c, a, yd) }) }) }

	function zd() {
		var a = Ad,
			c = Bd,
			d = Cd;
		Dd.forEach(function(e) { a.forEach(function(a) { xd(e, a, c);
				xd(a, e, d) }) }) }

	function Ed(a) { od[a.lb] = a;
		xd(a, a, yd) }

	function wd(a) {
		var c = [];
		a.forEach(function(a) { c.push(Ed(a)) }) }

	function Fd(a) {
		return a ? "string" === typeof a ? qd(a) : a : qd("EPSG:3857") }

	function xd(a, c, d) { a = a.lb;
		c = c.lb;
		a in vd || (vd[a] = {});
		vd[a][c] = d }

	function sd(a, c, d, e) { a = qd(a);
		c = qd(c);
		xd(a, c, Gd(d));
		xd(c, a, Gd(e)) }
	...
	function qd(a) {
		var c;
		if (a instanceof nd) c = a;
		else if ("string" === typeof a) { c = od[a];
			var d = pd || aa.proj4;
			void 0 === c && "function" == typeof d && void 0 !== d.defs(a) && (c = new nd({ code: a }), Ed(c)) } else c = null;
		return c }
	...
	function Ld(a, c, d) { c = Id(c, d);
		return cd(a, c) };

	function Md() { Mb.call(this);
		this.A = yc();
		this.B = -1;
		this.j = {};
		this.s = this.l = 0 }
	...
	l.xc = ed;
	l.G = function(a) { this.B != this.g && (this.A = this.Pd(this.A), this.B = this.g);
		var c = this.A;
		a ? (a[0] = c[0], a[1] = c[1], a[2] = c[2], a[3] = c[3]) : a = c;
		return a };
	l.Bb = function(a) {
		return this.sd(a * a) };
	l.fb = function(a, c) { this.Hc(Id(a, c));
		return this };
	...
	l.Mb = function() {
		return this.f };
	l.sd = function(a) { this.s != this.g && (nb(this.j), this.l = 0, this.s = this.g);
		if (0 > a || 0 !== this.l && a <= this.l) return this;
		var c = a.toString();
	...
	function Rd(a, c, d, e) {
		...
		a.f = c;
		a.a = d }
	l.Hc = function(a) { this.v && (a(this.v, this.v, this.a), this.u()) };
	l.Rc = function(a, c) {
		var d = this.ga();
		if (d) {
			var e = d.length,
	...
	function Ud(a, c, d, e, f, g, h) {
		...
		if (0 !== n || 0 !== p)
			...
			for (f = 0; f < e; ++f) h[f] = ac(a[c + f], a[d + f], g);
			h.length = e;
			return }
	...
	function Xd(a, c, d, e, f, g, h, k, m, n, p) {
		if (c == d) return n;
		var q;
		if (0 === f) { q = Qa(h, k, a[c], a[c + 1]);
			if (q < n) {
				for (p = 0; p < e; ++p) m[p] = a[c + p];
				m.length = e;
				return q }
			return n }
		for (var r = p ? p : [NaN, NaN], t = c + e; t < d;)
			if (Ud(a, t - e, t, e, h, k, r), q = Qa(h, k, r[0], r[1]), q < n) { n = q;
				for (p = 0; p < e; ++p) m[p] = r[p];
				m.length = e;
				t += e } else t += e * Math.max((Math.sqrt(q) - Math.sqrt(n)) / f | 0, 1);
		if (g && (Ud(a, d - e, c, e, h, k, r), q = Qa(h, k, r[0], r[1]), q < n)) { n = q;
			for (p = 0; p < e; ++p) m[p] = r[p];
			m.length = e }
		return n }

	function Yd(a, c, d, e, f, g, h, k, m, n, p) { p = p ? p : [NaN, NaN];
		var q, r;
		q = 0;
	...
	function ae(a, c, d, e, f) { f = f ? f : [];
		var g = 0,
			h, k;
		h = 0;
		for (k = d.length; h < k; ++h) c = $d(a, c, d[h], e), f[g++] = c;
		f.length = g;
		return f };

	function be(a, c, d, e, f) { f = void 0 !== f ? f : [];
		for (var g = 0; c < d; c += e) f[g++] = a.slice(c, c + e);
		f.length = g;
		return f }

	function ce(a, c, d, e, f) { f = void 0 !== f ? f : [];
		var g = 0,
			h, k;
		h = 0;
			...
			a: {
				...
				if (c != r) {
					...
					var A = void 0,
						B = void 0;
					do
						if (A = v * Math.round(q[c] / v), B = v * Math.round(q[c + 1] / v), c += t, c == r) { w[h++] = A;
							w[h++] = B;
							break a }
					while (A == z && B == C);
					for (; c < r;) {
						...
						if (L != A || J != B) {
							var M = A - z,
								...
								Aa = L - z,
								I = J - C;
							M * I == P * Aa && (0 > M && Aa < M || M == Aa || 0 < M && Aa > M) && (0 > P && I < P || P == I || 0 < P && I > P) ||
								(w[h++] = A, w[h++] = B, z = A, C = B);
							A = L;
							B = J
						}
	...
	l.W = function() {
		return "LinearRing" };
	l.la = function(a, c) { a ? (Rd(this, c, a, 1), this.v || (this.v = []), this.v.length = $d(this.v, 0, a, this.a), this.u()) : ge(this, "XY", null) };

	function ge(a, c, d) { Qd(a, c, d);
		a.u() };

	function E(a, c) { Od.call(this);
		this.la(a, c) }
	y(E, Od);
	l = E.prototype;
	l.clone = function() {
	...
	l.la = function(a, c) { a ? (Rd(this, c, a, 0), this.v || (this.v = []), this.v.length = Zd(this.v, a), this.u()) : this.ba("XY", null) };
	l.ba = function(a, c) { Qd(this, a, c);
		this.u() };
	...
	function je(a, c, d, e, f, g) {
		if (0 === d.length || !ie(a, c, d[0], e, f, g)) return !1;
		var h;
		c = 1;
		for (h = d.length; c < h; ++c)
			if (ie(a, d[c - 1], d[c], e, f, g)) return !1;
		return !0 };
	...
	function ke(a, c, d, e, f, g, h) {
		...
		n = a[v - e];
		q = a[v - e + 1];
		for (k = c; k < v; k += e) { p = a[k];
			m = a[k + 1];
			if (r <= q && m <= r || q <= r && r <= m) n = (r - q) / (m - q) * (p - n) + n, t.push(n);
			n = p;
			q = m }
		v = NaN;
		q = -Infinity;
	...
	function le(a, c, d, e, f, g) {
		for (var h = [a[c], a[c + 1]], k = [], m; c + e < d; c += e) { k[0] = a[c + e];
			k[1] = a[c + e + 1];
	...
	function ne(a, c, d, e, f) {
		var g = d[0];
		if (!(me(a, c, g, e, f) || ie(a, c, g, e, f[0], f[1]) || ie(a, c, g, e, f[0], f[3]) || ie(a, c, g, e, f[2], f[1]) || ie(a, c, g, e, f[2], f[3]))) return !1;
		if (1 === d.length) return !0;
		c = 1;
		for (g = d.length; c < g; ++c)
			if (he(a, d[c - 1], d[c], e, f)) return !1;
		return !0 };
	...
	function pe(a, c, d, e) {
		...
		for (h = c.length; g < h; ++g) {
			var k = c[g],
				f = oe(a, f, k, d);
			if (0 === g) {
				if (e && f || !e && !f) return !1 } else if (e && !f || !e && f) return !1;
			f = k }
		return !0 }

	function qe(a, c, d, e, f) { f = void 0 !== f ? f : !1;
		var g, h;
		g = 0;
		for (h = d.length; g < h; ++g) {
			var k = d[g],
	...
	function re(a, c, d, e) {
		var f = 0,
			g, h;
		g = 0;
		for (h = c.length; g < h; ++g) f = qe(a, f, c[g], d, e);
		return f };

	function F(a, c) { Od.call(this);
		this.c = [];
		this.J = -1;
		this.D = null;
	...
	y(F, Od);
	l = F.prototype;
	l.fj = function(a) { this.v ? Ya(this.v, a.ga()) : this.v = a.ga().slice();
	...
	l.ba = function(a, c, d) { Qd(this, a, c);
		this.c = d;
		this.u() };
	...
	function te(a, c, d, e) {
		...
		e = [];
		var g;
		for (g = 0; g < f; ++g) Ya(e, a.offset(c, d, 2 * Math.PI * g / f));
		e.push(e[0], e[1]);
		a = new F(null);
		a.ba("XY", e, [e.length]);
		return a }
	...
	function we(a, c, d, e) {
		var f = a.ga(),
			...
			m = f.length / h - 1;
		e = e ? e : 0;
		for (var n, p, q = 0; q <= m; ++q) p = q * h, n = e + 2 * $b(q, m) * Math.PI / m, f[p] = c[0] + d * Math.cos(n), f[p + 1] = c[1] + d * Math.sin(n);
		a.ba(g, f, k) };
	...
	function xe(a) {
		...
		if (void 0 !== a.resolutions) d = a.resolutions, e = d[0], f = d[d.length - 1], d = fb(d);
		else {
			e = Fd(a.projection);
			f = e.G();
	...
	l.V = function() {
		var a = this.Wa(),
			...
			d = this.Z(),
			e = this.Ka();
		return { center: [Math.round(a[0] / d) * d, Math.round(a[1] / d) * d], projection: void 0 !== c ? c : null, resolution: d, rotation: e } };
	l.ik = function() {
		var a, c = this.Z();
		if (void 0 !== c) {
			var d, e = 0;
			do { d = this.constrainResolution(this.a, e);
				if (d == c) { a = e;
					break }++e } while (d > this.l) }
	...
	l.Xe = function(a, c, d) {
		...
		var k = a.ga(),
			...
			r = -Infinity;
		a = a.qa();
		for (var t = 0, v = k.length; t < v; t += a) var w = k[t] * e - k[t + 1] * m,
			z = k[t] * m + k[t + 1] * e,
			n = Math.min(n, w),
			p = Math.min(p, z),
			q = Math.max(q, w),
	...
	l.rotate = function(a, c) {
		if (void 0 !== c) {
			...
			this.mb(d) }
		this.je(a) };
	l.mb = function(a) { this.set("center", a) };

	function Be(a, c) { a.f[1] += c }
	l.Vb = function(a) { this.set("resolution", a) };
	l.je = function(a) { this.set("rotation", a) };
	l.Do = function(a) { a = this.constrainResolution(this.a, a - this.c, 0);
		this.Vb(a) };
	...
	function Qe(a) { this.a = a.html;
		this.b = a.tileRanges ? a.tileRanges : null }
	Qe.prototype.g = function() {
		return this.a };

	function Re(a, c, d) { Eb.call(this, a, d);
		this.element = c }
	y(Re, Eb);

	function Se(a) { Mb.call(this);
		this.a = a ? a : [];
		Te(this) }
	y(Se, Mb);
	l = Se.prototype;
	l.clear = function() {
		for (; 0 < this.ac();) this.pop() };
	l.jf = function(a) {
		var c, d;
		c = 0;
		for (d = a.length; c < d; ++c) this.push(a[c]);
		return this };
	l.forEach = function(a, c) { this.a.forEach(a, c) };
	l.il = function() {
		return this.a };
	l.item = function(a) {
		return this.a[a] };
	...
	l.ce = function(a, c) { this.a.splice(a, 0, c);
		Te(this);
	...
	l.qo = function(a, c) {
		var d = this.ac();
		if (a < d) d = this.a[a], this.a[a] = c, this.b(new Re("remove", d, this)), this.b(new Re("add", c, this));
		else {
			for (; d < a; ++d) this.ce(d, void 0);
			this.ce(a, c) } };

	function Te(a) { a.set("length", a.a.length) };
	...
	var Ye = function() {
		...
		return function(d) {
			...
			if (a.hasOwnProperty(d)) e = a[d];
				...
				var g, h;
				Ue.exec(d) ? (h = 3 == d.length - 1 ? 1 : 2, e = parseInt(d.substr(1 + 0 * h, h), 16), f = parseInt(d.substr(1 + 1 * h, h), 16), g = parseInt(d.substr(1 + 2 * h, h), 16), 1 == h && (e = (e << 4) + e, f = (f << 4) + f, g = (g << 4) + g), e = [e, f, g, 1]) : (h = We.exec(d)) ? (e = Number(h[1]), f = Number(h[2]), g = Number(h[3]), h = Number(h[4]), e = [e, f, g, h], e = $e(e, e)) : (h = Ve.exec(d)) ? (e = Number(h[1]), f = Number(h[2]), g = Number(h[3]),
					e = [e, f, g, 1], e = $e(e, e)) : e = void 0;
				a[d] = e;
				++c
			}
			return e
	...
	function hf(a, c) {
		for (var d, e, f = 1; f < arguments.length; f++) { e = arguments[f];
			for (d in e) a[d] = e[d];
			for (var g = 0; g < gf.length; g++) d = gf[g], Object.prototype.hasOwnProperty.call(e, d) && (a[d] = e[d]) } };
	...
	function of() {
		var a = bf;
		if (mf) return /rv\:([^\);]+)(\)|;)/.exec(a);
		if (lf) return /Edge\/([\d\.]+)/.exec(a);
		if (kf) return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);
		if (nf) return /WebKit\/(\S+)/.exec(a) }
	...
	function wf(a, c) { this.x = ba(a) ? a : 0;
		this.y = ba(c) ? c : 0 }
	l = wf.prototype;
	l.clone = function() {
	...
	function Cf(a, c) { ff(c, function(c, e) { "style" == e ? a.style.cssText = c : "class" == e ? a.className = c : "for" == e ? a.htmlFor = c : Df.hasOwnProperty(e) ? a.setAttribute(Df[e], c) : 0 == e.lastIndexOf("aria-", 0) || 0 == e.lastIndexOf("data-", 0) ? a.setAttribute(e, c) : a[e] = c }) }
	...
	function Ef(a, c, d) {
		var e = arguments,
			...
			g = e[0],
			h = e[1];
		if (!vf && h && (h.name || h.type)) { g = ["<", g];
			h.name && g.push(' name="', xa(h.name), '"');
			if (h.type) { g.push(' type="', xa(h.type), '"');
				var k = {};
				hf(k, h);
				delete k.type;
				h = k }
	...
	function Ff(a, c, d) {
		function e(d) { d && c.appendChild(ha(d) ? a.createTextNode(d) : d) }
		for (var f = 2; f < d.length; f++) {
			var g = d[f];!ga(g) || ka(g) && 0 < g.nodeType ? e(g) : Vb(Gf(g) ? Yb(g) : g, e) } }

	function Hf(a) {
		for (var c; c = a.firstChild;) a.removeChild(c) }

	function If(a, c, d) { a.insertBefore(c, a.childNodes[d] || null) }

	function Jf(a) { a && a.parentNode && a.parentNode.removeChild(a) }
	...
	function zf(a) { this.b = a || aa.document || document }
	zf.prototype.C = Cf;

	function Nf() {
		return !0 }
	zf.prototype.appendChild = function(a, c) { a.appendChild(c) };
	...
	function Qf(a, c) { a.classList ? a.classList.add(c) : Pf(a, c) || (a.className += 0 < a.className.length ? " " + c : c) }

	function Rf(a, c) { a.classList ? a.classList.remove(c) : Pf(a, c) && (a.className = Wb(Of(a), function(a) {
			return a != c }).join(" ")) }

	function Sf(a, c) { Pf(a, c) ? Rf(a, c) : Qf(a, c) };

	function Tf(a, c, d, e) { this.top = a;
		this.right = c;
		this.bottom = d;
		this.left = e }
	l = Tf.prototype;
	...
	l.ceil = function() { this.top = Math.ceil(this.top);
		this.right = Math.ceil(this.right);
		this.bottom = Math.ceil(this.bottom);
		this.left = Math.ceil(this.left);
		return this };
	l.floor = function() { this.top = Math.floor(this.top);
	...
	function Uf(a, c, d, e) { this.left = a;
		this.top = c;
		this.width = d;
		this.height = e }
	l = Uf.prototype;
	...
	function Yf(a) {
		var c;
		try { c = a.getBoundingClientRect() } catch (d) {
	...
	function Zf(a) {
		if (1 == a.nodeType) return a = Yf(a), new wf(a.left, a.top);
		a = a.changedTouches ? a.changedTouches[0] : a;
		return new wf(a.clientX, a.clientY) }

	function Xf(a) { "number" == typeof a && (a = a + "px");
		return a }

	function $f(a) {
		var c = ag;
		if ("none" != (Vf(a, "display") || (a.currentStyle ? a.currentStyle.display : null) || a.style && a.style.display)) return c(a);
		var d = a.style,
			e = d.display,
			f = d.visibility,
			g = d.position;
	...
	function bg(a, c) { a.style.display = c ? "" : "none" }
	...
	function ig(a, c, d) { Eb.call(this, a);
		this.map = c;
		this.frameState = void 0 !== d ? d : null }
	y(ig, Eb);

	function jg(a) { Mb.call(this);
	...
	y(jg, Mb);
	jg.prototype.fa = function() { Jf(this.element);
		jg.ha.fa.call(this) };
	jg.prototype.i = function() {
		return this.a };
	jg.prototype.setMap = function(a) { this.a && Jf(this.element);
		for (var c = 0, d = this.s.length; c < d; ++c) sb(this.s[c]);
		this.s.length = 0;
		if (this.a = a)(this.S ? this.S : a.A).appendChild(this.element), this.render !== ua && this.s.push(D(a, "postrender", this.render, this)), a.render() };
	jg.prototype.c = function(a) { this.S = Bf(a) };

	function kg() { this.g = 0;
		this.f = {};
		this.a = this.b = null }
	l = kg.prototype;
	l.clear = function() { this.g = 0;
		this.f = {};
		this.a = this.b = null };
	...
	l.forEach = function(a, c) {
		for (var d = this.b; d;) a.call(c, d.mc, d.de, this), d = d.xb };
	l.get = function(a) { a = this.f[a];
		if (a === this.a) return a.mc;
	...
	l.O = function() {
		var a = Array(this.g),
			c = 0,
			d;
		for (d = this.a; d; d = d.hc) a[c++] = d.de;
		return a };
	l.vc = function() {
		var a = Array(this.g),
			c = 0,
			d;
		for (d = this.a; d; d = d.hc) a[c++] = d.mc;
		return a };
	l.pop = function() {
		var a = this.b;
		delete this.f[a.de];
		...
		return a.mc };
	l.replace = function(a, c) { this.get(a);
		this.f[a].mc = c };
	l.set = function(a, c) {
		var d = { de: a, xb: null, hc: this.a, mc: c };
		this.a ? this.a.xb = d : this.b = d;
		this.a = d;
		this.f[a] = d;++this.g };

	function mg(a) { kg.call(this);
	...
	function og(a, c) {
		for (var d, e; ng(a) && !(d = a.b.mc, e = d.ja[0].toString(), e in c && c[e].contains(d.ja));) a.pop().Rd() };

	function pg(a, c) { Hb.call(this);
		this.ja = a;
		this.state = c;
		this.a = null;
		this.key = "" }
	...
	function sg(a) {
		return a.J }
	l.ma = function(a) { this.Ca = a;
		this.u() };

	function tg(a, c) { a.wa = c;
		a.u() };
	...
	function ug(a) {
		...
		void 0 !== a.sizes ? this.b = a.sizes.map(function(a) {
			return new Me(Math.min(0, a[0]), Math.max(a[0] - 1, -1),
	...
	function xg(a, c, d, e, f) { f = a.Da(c, f);
		for (c = c[0] - 1; c >= a.minZoom;) {
			if (d.call(null, c, yg(a, f, c, e))) return !0;--c }
		return !1 }
	l = ug.prototype;
	l.G = function() {
		return this.s };
	...
	function Ag(a, c, d, e) { Bg(a, c[0], c[1], d, !1, wg);
		var f = wg[1],
			g = wg[2];
		Bg(a, c[2], c[3], d, !0, wg);
		a = wg[1];
	...
	function Bg(a, c, d, e, f, g) {
		...
		return Ke(h, c, d, g) }
	l.ud = function(a, c, d) { c = this.Z(c);
		return Bg(this, a[0], a[1], c, !1, d) };
	l.Ua = function(a) {
	...
	function vg(a, c) {
		for (var d = a.a.length, e = Array(d), f = a.minZoom; f < d; ++f) e[f] = yg(a, c, f);
		a.b = e }
	...
	function Eg(a) {
		...
		if (!c) {
			var c = Fg(a),
				...
				c = new ug({ extent: c, origin: Sc(c), resolutions: d, tileSize: void 0 });
			a.j = c }
		return c }
	...
	function Gg(a, c, d) { c = void 0 !== c ? c : 42;
		var e = Xc(a);
		a = Wc(a);
		d = Sb(void 0 !== d ? d : 256);
	...
	function Fg(a) { a = qd(a);
		var c = a.G();
		c || (a = 180 * md.degrees / a.$b(), c = Ic(-a, -a, a, a));
		return c };

	function Ig(a) { rg.call(this, { attributions: a.attributions, extent: a.extent, logo: a.logo, projection: a.projection, state: a.state, wrapX: a.wrapX });
	...
	function Jg(a, c, d, e, f) { c = a.td(c);
		if (!c) return !1;
		for (var g = !0, h, k, m = e.ra; m <= e.va; ++m)
			for (var n = e.xa; n <= e.Aa; ++n) h = a.Db(d, m, n), k = !1, lg(c, h) && (h = c.get(h), (k = 2 === h.V()) && (k = !1 !== f(h))), k || (g = !1);
		return g }
	l.Ud = function() {
		return 0 };
	l.af = function() {
	...
	function Mg(a, c) { Eb.call(this, a);
		this.tile = c }
	y(Mg, Eb);
	...
	function Ng(a) {
		...
		this.H = "string" === typeof e ?
			Ef("SPAN", {}, e) : e;
		d = Ef("BUTTON", { type: "button", title: d }, this.l && !this.f ? this.D : this.H);
		D(d, "click", this.Bl, this);
		c = Ef("DIV", c + " ol-unselectable ol-control" + (this.f && this.l ? " ol-collapsed" : "") + (this.l ? "" : " ol-uncollapsible"), this.J, d);
		jg.call(this, { element: c, render: a.render ? a.render : Og, target: a.target });
		this.B = !0;
		this.o = {};
		this.j = {};
		this.U = {}
	...
	function Og(a) {
		if (a = a.frameState) {
								...
								if (g = a.usedTiles[p]) {
									...
									a: {
										...
										if (q.b) {
											...
											for (J in g)
												if (J in q.b)
													for (var L = g[J], M, A = 0, B = q.b[J].length; A < B; ++A) {
														M = q.b[J][A];
														if (Pe(M, L)) { q = !0;
															break a }
														var P = yg(z, Fg(C), parseInt(J,
																10)),
															Aa = P.va - P.ra + 1;
														if (L.ra < P.ra || L.va > P.va)
															if (Pe(M, new Me($b(L.ra, Aa), $b(L.va, Aa), L.xa, L.Aa)) || L.va - L.ra + 1 > Aa && Pe(M, P)) { q = !0;
																break a }
													}
												q = !1
										} else q = !0
			...
			d = c[0];
			c = c[1];
			for (var I in this.o) I in d ? (this.j[I] || (bg(this.o[I], !0), this.j[I] = !0), delete d[I]) : I in c ? (this.j[I] && (bg(this.o[I], !1), delete this.j[I]), delete c[I]) : (Jf(this.o[I]), delete this.o[I], delete this.j[I]);
			for (I in d) e = document.createElement("LI"), e.innerHTML = d[I].a, this.J.appendChild(e),
				this.o[I] = e, this.j[I] = !0;
			for (I in c) e = document.createElement("LI"), e.innerHTML = c[I].a, bg(e, !1), this.J.appendChild(e), this.o[I] = e;
			...
			a = a.logos;
			I = this.U;
			for (ca in I) ca in a || (Jf(I[ca]), delete I[ca]);
			for (var Da in a) Da in I || (ca = new Image, ca.src = Da, d = a[Da], "" === d ? d = ca : (d = Ef("A", { href: d }), d.appendChild(ca)), this.A.appendChild(d), I[Da] = d);
			bg(this.A, !pb(a))
		} else this.B &&
			(bg(this.element, !1), this.B = !1)
	}
	l = Ng.prototype;
	l.Bl = function(a) { a.preventDefault();
		Pg(this) };

	function Pg(a) { Sf(a.element, "ol-collapsed");
		a.f ? Kf(a.D, a.H) : Kf(a.H, a.D);
		a.f = !a.f }
	l.Al = function() {
		return this.l };
	l.Dl = function(a) { this.l !== a && (this.l = a, Sf(this.element, "ol-uncollapsible"), !a && this.f && Pg(this)) };
	l.Cl = function(a) { this.l && this.f !== a && Pg(this) };
	l.zl = function() {
		return this.f };
	...
	function Qg(a) {
		...
		d = Ef("BUTTON", { "class": c + "-reset", type: "button", title: a.tipLabel ? a.tipLabel : "Reset rotation" }, this.f);
		...
		jg.call(this, { element: c, render: d, target: a.target });
	...
	y(Qg, jg);
	Qg.prototype.B = function(a) { a.preventDefault();
		if (void 0 !== this.l) this.l();
		else { a = this.a;
			var c = a.$();
			if (c) {
				var d = c.Ka();
				void 0 !== d && (0 < this.o && (d %= 2 * Math.PI, d < -Math.PI && (d += 2 * Math.PI), d > Math.PI && (d -= 2 * Math.PI), a.Ra(Ie({ rotation: d, duration: this.o, easing: De }))), c.je(0)) } } };

	function Rg(a) {
		if (a = a.frameState) { a = a.viewState.rotation;
			if (a != this.A) {
				var c = "rotate(" + a + "rad)";
				if (this.j) {
					var d = this.element;
	...
	function Sg(a) {
		...
		var c = void 0 !== a.className ? a.className : "ol-zoom",
			...
			g = Ef("BUTTON", { "class": c + "-in", type: "button", title: void 0 !== a.zoomInTipLabel ? a.zoomInTipLabel : "Zoom in" },void 0 !== a.zoomInLabel ? a.zoomInLabel : "+");
		D(g, "click", qa(Sg.prototype.j, d), this);
		e = Ef("BUTTON", { "class": c + "-out", type: "button", title: f }, e);
		D(e, "click", qa(Sg.prototype.j, -d), this);
		c = Ef("DIV",c + " ol-unselectable ol-control", g, e);
		jg.call(this, { element: c, target: a.target });
		this.f = void 0 !== a.duration ? a.duration : 250
	}
	y(Sg, jg);
	Sg.prototype.j = function(a, c) { c.preventDefault();
		var d = this.a,
			e = d.$();
		if (e) {
			var f = e.Z();
			f && (0 < this.f && d.Ra(Je({ resolution: f, duration: this.f, easing: De })), d = e.constrainResolution(f, a), e.Vb(d)) } };
	...
	function Wg(a) { a.webkitRequestFullscreen ? a.webkitRequestFullscreen() : a.mozRequestFullScreen ? a.mozRequestFullScreen() : a.msRequestFullscreen ? a.msRequestFullscreen() : a.requestFullscreen && a.requestFullscreen() }
	...
	function Yg(a) {
		...
		c = Ef("BUTTON", { "class": this.f + "-" + Xg(), type: "button", title: c }, this.j);
		D(c, "click", this.J, this);
		D(aa.document, Ug, this.A, this);
		var d = this.f + " ol-unselectable ol-control " + (Vg() ?
				"" : "ol-unsupported"),
			c = Ef("DIV", d, c);
		jg.call(this, { element: c, target: a.target });
	...
	y(Yg, jg);
	Yg.prototype.J = function(a) { a.preventDefault();
	...
	function Zg(a) { a = a ? a : {};
		...
		jg.call(this, { element: c, render: a.render ? a.render : $g, target: a.target });
	...
	function $g(a) { a = a.frameState;
		a ? this.f != a.viewState.projection && (this.f = a.viewState.projection, this.j = null) : this.f = null;
		ah(this, this.l) }
	l = Zg.prototype;
	l.El = function() { this.j = null };
	l.rg = function() {
		return this.get("coordinateFormat") };
	l.Wg = function() {
		return this.get("projection") };
	l.Ak = function(a) { this.l = this.a.Td(a);
		ah(this, this.l) };
	l.Bk = function() { ah(this, null);
		this.l = null };
	l.setMap = function(a) { Zg.ha.setMap.call(this, a);
		a && (a = a.a, this.s.push(D(a, "mousemove", this.Ak, this), D(a, "mouseout", this.Bk, this))) };
	l.Nh = function(a) { this.set("coordinateFormat", a) };
	l.Xg = function(a) { this.set("projection", a) };
	...
	function ah(a, c) {
		...
		if (c && a.f) {
			if (!a.j) {
				var e = a.Wg();
				a.j = e ? ud(a.f, e) : Jd }
			if (e = a.a.La(c)) a.j(e, e), d = (d = a.rg()) ? d(e) : e.toString() }
		a.o && d == a.o || (a.element.innerHTML = d, a.o = d) };

	function bh(a, c) {
		var d = a;
		c && (d = pa(a, c));
		d = ch(d);!ja(aa.setImmediate) || aa.Window && aa.Window.prototype && aa.Window.prototype.setImmediate == aa.setImmediate ? (dh || (dh = eh()), dh(d)) : aa.setImmediate(d) }
	var dh;
	...
	function eh() {
		...
		if ("undefined" !== typeof a && !ef("Trident") && !ef("MSIE")) {
			...
			c.port1.onmessage = function() {
				if (ba(d.next)) { d = d.next;
					var a = d.hg;
					d.hg = null;
					a() } };
			return function(a) { e.next = { hg: a };
				e = e.next;
		...
		} : function(a) { aa.setTimeout(a, 0) }
	}
	var ch = hd;

	function fh(a, c) { this.a = {};
		this.b = [];
		this.g = 0;
		var d = arguments.length;
		if (1 < d) {
			if (d % 2) throw Error("Uneven number of arguments");
			for (var e = 0; e < d; e += 2) this.set(arguments[e], arguments[e + 1]) } else if (a) {
			var f;
			if (a instanceof fh) f = a.O(), e = a.vc();
			else {
				var d = [],
					g = 0;
				for (f in a) d[g++] = f;
	...
	function gh(a) {
		if (a.g != a.b.length) {
			...
			a.b.length = d }
		if (a.g != a.b.length) {
			for (var f = {}, d = c = 0; c < a.b.length;) e = a.b[c], hh(f, e) || (a.b[d++] = e, f[e] = 1), c++;
			a.b.length = d } }
	l.get = function(a, c) {
		return hh(this.a, a) ? this.a[a] : c };
	l.set = function(a, c) { hh(this.a, a) || (this.g++, this.b.push(a));
		this.a[a] = c };
	l.forEach = function(a, c) {
	...
	function ih() { this.b = ra() }
	new ih;
	ih.prototype.set = function(a) { this.b = a };
	...
	function jh(a, c, d) {
		...
		c.preventDefault && (this.preventDefault = function() { c.preventDefault() })
	}
	y(jh, Eb);

	function kh(a) {
		if (a.buttons || mh) a = a.buttons;
		else switch (a.which) {
			case 1:
				a = 1;
				break;
	...
	function lh(a, c) {
		...
		return d }
	var mh = !1;
	try { mh = 1 === (new MouseEvent("click", { buttons: 1 })).buttons } catch (a) {};
				...
				if (void 0 === a)
					if (aa.getComputedStyle) {
						var c = document.createElement("P"),
							d, e = { webkitTransform: "-webkit-transform", OTransform: "-o-transform", msTransform: "-ms-transform", MozTransform: "-moz-transform", transform: "transform" };
	...
	function rh(a, c) {
		...
		if (ph()) {
			...
			qh(a, "matrix3d(" + e.join(",") + ")") } else if (oh()) {
			var e = [c[0], c[1], c[4], c[5], c[12], c[13]],
				f = Array(6);
			for (d = 0; 6 > d; ++d) f[d] = e[d].toFixed(6);
			qh(a, "matrix(" + f.join(",") + ")") } else a.style.left = Math.round(c[12]) + "px", a.style.top = Math.round(c[13]) + "px" };
	var sh = ["experimental-webgl", "webgl", "webkit-3d", "moz-webgl"];

	function th(a, c) {
		var d, e, f = sh.length;
		for (e = 0; e < f; ++e) try {
			if (d = a.getContext(sh[e], c)) return d } catch (g) {}
		return null };
	var uh, vh = "undefined" !== typeof navigator ? navigator.userAgent.toLowerCase() : "",
		...
		Bh = function() {
			...
			try {
				var a = nh();
				return a ? (void 0 !== a.setLineDash && (Ah = !0), !0) : !1 } catch (c) {
				return !1 } }(),
	...
	if ("WebGLRenderingContext" in aa) try {
		...
		Kh && (Hh = !0, Ih = Kh.getParameter(Kh.MAX_TEXTURE_SIZE), Jh = Kh.getSupportedExtensions()) } catch (a) {}
	uh = Hh;
	ta = Jh;
	sa = Ih;

	function Lh(a, c) { this.b = a;
		this.c = c };

	function Mh(a) { Lh.call(this, a, { mousedown: this.Vk, mousemove: this.Wk, mouseup: this.Zk, mouseover: this.Yk, mouseout: this.Xk });
		this.a = a.g;
		this.g = [] }
	y(Mh, Lh);
	...
	function Oh(a) {
		var c = Ph(a, a),
			d = c.preventDefault;
		c.preventDefault = function() { a.preventDefault();
			d() };
		c.pointerId = 1;
		c.isPrimary = !0;
		c.pointerType = "mouse";
	...
	function Xh(a) { Lh.call(this, a, { MSPointerDown: this.dl, MSPointerMove: this.el, MSPointerUp: this.hl, MSPointerOut: this.fl, MSPointerOver: this.gl, MSPointerCancel: this.cl, MSGotPointerCapture: this.al, MSLostPointerCapture: this.bl });
		this.a = a.g;
	...
	function Yh(a, c) {
		...
		return d }
	l = Xh.prototype;
	l.dl = function(a) { this.a[a.pointerId.toString()] = a;
		var c = Yh(this, a);
		Qh(this.b, Sh, c, a) };
	l.el = function(a) {
		var c = Yh(this, a);
	...
	l.cl = function(a) {
		...
		Qh(this.b, Rh, c, a);
		delete this.a[a.pointerId.toString()] };
	l.bl = function(a) { this.b.b(new jh("lostpointercapture", a, a)) };
	l.al = function(a) { this.b.b(new jh("gotpointercapture", a, a)) };

	function Zh(a) { Lh.call(this, a, { pointerdown: this.Bn, pointermove: this.Cn, pointerup: this.Fn, pointerout: this.Dn, pointerover: this.En, pointercancel: this.An, gotpointercapture: this.jk, lostpointercapture: this.Uk }) }
	y(Zh, Lh);
	l = Zh.prototype;
	l.Bn = function(a) { $h(this.b, a) };
	l.Cn = function(a) { $h(this.b, a) };
	l.Fn = function(a) { $h(this.b, a) };
	l.Dn = function(a) { $h(this.b, a) };
	l.En = function(a) { $h(this.b, a) };
	l.An = function(a) { $h(this.b, a) };
	l.Uk = function(a) { $h(this.b, a) };
	l.jk = function(a) { $h(this.b, a) };

	function ai(a, c) { Lh.call(this, a, { touchstart: this.Io, touchmove: this.Ho, touchend: this.Go, touchcancel: this.Fo });
		this.a = a.g;
		this.j = c;
		this.g = void 0;
		this.i = 0;
	...
	y(ai, Lh);
	l = ai.prototype;
	l.Lh = function() { this.i = 0;
		this.f = void 0 };

	function bi(a, c, d) { c = Ph(c, d);
	...
	function ci(a, c, d) {
		...
		var f = Array.prototype.slice.call(c.changedTouches),
			g = f.length,
			h, k;
		for (h = 0; h < g; ++h) k = bi(a, c, f[h]), k.preventDefault = e, d.call(a, c, k) }
	l.Io = function(a) {
		var c = a.touches,
		...
		if (e >= c.length) {
			...
			for (g = 0; g < e; ++g) { h = d[g];
				k = this.a[h];
				var m;
				if (!(m = 1 == h)) a: { m = c.length;
					for (var n = void 0, p = 0; p < m; p++)
						if (n = c[p], n.identifier === h - 2) { m = !0;
							break a }
					m = !1 }
				m || f.push(k.zc) }
			for (g = 0; g < f.length; ++g) this.Se(a, f[g]) }
		...
		this.i++;
		ci(this, a, this.wn) };
	l.wn = function(a, c) { this.a[c.pointerId] = { target: c.target, zc: c, uh: c.target };
		var d = this.b;
		c.bubbles = !0;
		Qh(d, ei, c, a);
		d = this.b;
		...
		Qh(d, fi, c, a);
		Qh(this.b, Sh, c, a) };
	l.Ho = function(a) { a.preventDefault();
		ci(this, a, this.$k) };
	l.$k = function(a, c) {
		...
		if (d) {
			...
			d.zc = c;
			d.uh = c.target } };
	l.Go = function(a) { di(this, a);
		ci(this, a, this.Jo) };
	l.Jo = function(a, c) { Qh(this.b, Uh, c, a);
		this.b.zc(c, a);
		var d = this.b;
		c.bubbles = !1;
		Qh(d, gi, c, a);
	...
	l.Fo = function(a) { ci(this, a, this.Se) };
	l.Se = function(a, c) { Qh(this.b, Rh, c, a);
		this.b.zc(c, a);
		var d = this.b;
		c.bubbles = !1;
		Qh(d, gi, c, a);
	...
	function di(a, c) {
		...
		if (a.g === e.identifier) {
			...
			d.push(f);
			aa.setTimeout(function() { Za(d, f) }, 2500) } };

	function hi(a) { Hb.call(this);
		this.i = a;
		this.g = {};
		this.c = {};
		this.a = [];
		...
		a = this.a.length;
		for (var c, d = 0; d < a; d++) c = this.a[d], ji(this, Object.keys(c.c)) }
	y(hi, Hb);
	...
	function ii(a, c) {
		...
		d && (d.forEach(function(a) {
			var d = c.c[a];
			d && (this.c[a] = d.bind(c)) }, a), a.a.push(c)) }
	hi.prototype.f = function(a) {
		var c = this.c[a.type];
		c && c(a) };

	function ji(a, c) { c.forEach(function(a) { D(this.i, a, this.f, this) }, a) }

	function ki(a, c) { c.forEach(function(a) { yb(this.i, a, this.f, this) }, a) }

	function Ph(a, c) {
		for (var d = {}, e, f = 0, g = li.length; f < g; f++) e = li[f][0], d[e] = a[e] || c[e] || li[f][1];
		return d }
	hi.prototype.zc = function(a, c) { a.bubbles = !0;
		Qh(this, mi, a, c) };

	function Wh(a, c, d) { a.zc(c, d);
		var e = c.relatedTarget;
		e && Mf(c.target, e) || (c.bubbles = !1, Qh(a, gi, c, d)) }

	function Vh(a, c, d) { c.bubbles = !0;
		Qh(a, ei, c, d);
		var e = c.relatedTarget;
		e && Mf(c.target, e) || (c.bubbles = !1, Qh(a, fi, c, d)) }

	function Qh(a, c, d, e) { a.b(new jh(c, e, d)) }

	function $h(a, c) { a.b(new jh(c.type, c, c)) }
	hi.prototype.fa = function() {
		for (var a = this.a.length, c, d = 0; d < a; d++) c = this.a[d], ki(this, Object.keys(c.c));
		hi.ha.fa.call(this) };
	var Th = "pointermove",
		Sh = "pointerdown",
		Uh = "pointerup",
	...
	function ni(a, c, d, e, f) { ig.call(this, a, c, f);
		this.originalEvent = d;
		this.pixel = c.Td(d);
		this.coordinate = c.La(this.pixel);
		this.dragging = void 0 !== e ? e : !1 }
	y(ni, ig);
	ni.prototype.preventDefault = function() { ni.ha.preventDefault.call(this);
		this.originalEvent.preventDefault() };
	ni.prototype.stopPropagation = function() { ni.ha.stopPropagation.call(this);
		this.originalEvent.stopPropagation() };

	function oi(a, c, d, e, f) { ni.call(this, a, c, d.b, e, f);
		this.b = d }
	y(oi, ni);

	function pi(a) { Hb.call(this);
		this.f = a;
		this.j = 0;
		this.l = !1;
		this.c = [];
	...
	function qi(a, c) {
		...
		d = new oi(ri, a.f, c);
		a.b(d);
		0 !== a.j ? (aa.clearTimeout(a.j), a.j = 0, d = new oi(si, a.f, c), a.b(d)) : a.j = aa.setTimeout(function() { this.j = 0;
			var a = new oi(ti, this.f, c);
			this.b(a) }.bind(a), 250) }

	function ui(a, c) { c.type == vi || c.type == wi ? delete a.A[c.pointerId] : c.type == xi && (a.A[c.pointerId] = !0);
		a.T = Object.keys(a.A).length }
	l = pi.prototype;
	l.Gg = function(a) { ui(this, a);
		var c = new oi(vi, this.f, a);
		this.b(c);!this.l && 0 === a.button && qi(this, this.g);
		0 === this.T && (this.c.forEach(sb), this.c.length = 0, this.l = !1, this.g = null, Db(this.a), this.a = null) };
	l.Dk = function(a) { ui(this, a);
	...
	l.ul = function(a) {
		if (a.clientX != this.g.clientX || a.clientY != this.g.clientY) { this.l = !0;
			var c = new oi(zi, this.f, a, this.l);
			this.b(c) }
		a.preventDefault() };
	l.co = function(a) { this.b(new oi(a.type, this.f, a, !(!this.g || a.clientX == this.g.clientX && a.clientY == this.g.clientY))) };
	l.fa = function() { this.s && (sb(this.s), this.s = null);
	...
	var ti = "singleclick",
		...
		vi = "pointerup",
		wi = "pointercancel",
		Ai = { ap: ti, Qo: ri, Ro: si, Uo: zi, Xo: yi, To: xi, $o: vi, Zo: "pointerover", Yo: "pointerout", Vo: "pointerenter", Wo: "pointerleave", So: wi };

	function Bi(a) { Mb.call(this);
		var c = mb({}, a);
	...
	function Ci(a) {
		var c = a.Sb(),
			...
			h = a.Nb(),
			k = a.Ob();
		return { layer: a, opacity: Ma(c, 0, 1), H: d, visible: e, Pc: !0, extent: f, zIndex: g, maxResolution: h, minResolution: Math.max(k, 0) } }
	l = Bi.prototype;
	l.G = function() {
	...
	l.cc = function(a) { this.set("extent", a) };
	l.kc = function(a) { this.set("maxResolution", a) };
	l.lc = function(a) { this.set("minResolution", a) };
	l.dc = function(a) { this.set("opacity", a) };
	l.ec = function(a) { this.set("visible", a) };
	l.fc = function(a) { this.set("zIndex", a) };

	function Di() {};

	function Ei(a, c, d, e, f, g) { Eb.call(this, a, c);
	...
	l.lm = function() { this.u() };
	l.Jk = function() { this.o && (sb(this.o), this.o = null);
		var a = this.da();
		a && (this.o = D(a, "change", this.lm, this));
		this.u() };
	l.setMap = function(a) { this.j && (sb(this.j), this.j = null);
		a || this.u();
		...
		a && (this.j = D(a, "precompose", function(a) {
			...
			a.frameState.layerStates[x(this)] = d }, this), this.l = D(this, "change", a.render, a), this.u()) };
	l.Cc = function(a) { this.set("source", a) };

	function Hi(a, c, d, e, f) { Hb.call(this);
		this.o = f;
		this.extent = a;
		this.f = d;
		this.resolution = c;
	...
	function Ji(a, c, d, e, f, g, h, k) { rc(a);
		0 === c && 0 === d || uc(a, c, d);
		1 == e && 1 == f || vc(a, e, f);
		0 !== g && wc(a, g);
		0 === h && 0 === k || uc(a, h, k);
	...
	function Mi(a) { Jb.call(this);
		this.a = a }
	y(Mi, Jb);
	l = Mi.prototype;
	l.gb = ua;
	l.yc = function(a, c, d, e) { a = a.slice();
		Li(c.pixelToCoordinateMatrix, a, a);
		if (this.gb(a, c, fd, this)) return d.call(e, this.a) };
	l.me = ed;
	l.cd = function(a, c, d) {
		return function(e, f) {
			return Jg(a, c, e, f, function(a) { d[e] || (d[e] = {});
				d[e][a.ja.toString()] = a }) } };
	l.pm = function(a) { 2 === a.target.V() && Ni(this) };
	...
	function Pi(a, c) { c.lh() && a.postRenderFunctions.push(qa(function(a, c, f) { c = x(a).toString();
			a.mh(f.viewState.projection, f.usedTiles[c]) }, c)) }
	...
	function Si(a, c, d, e) { c = x(c).toString();
		d = d.toString();
	...
	function Ui(a, c, d, e, f, g, h, k, m, n) {
		...
		for (A = h; A >= r; --A)
			for (v = yg(d, g, A, v), w = d.Z(A), z = v.ra; z <= v.va; ++z)
				for (C = v.xa; C <= v.Aa; ++C) h - A <= k ? (t = c.Qb(A, z, C, e, f), 0 == t.V() && (q[t.ja.toString()] = !0, t.eb() in a.g || a.f([t, p, Cg(d, t.ja), w])), void 0 !== m && m.call(n, t)) : c.Of(A, z, C, f) };

	function Vi(a) { this.A = a.opacity;
	...
	l.Yd = function() {
		return this.J };
	l.te = function(a) { this.A = a };
	l.ue = function(a) { this.s = a };
	l.ve = function(a) { this.j = a };
	...
	function Wi(a) {
		...
		Vi.call(this, { opacity: void 0 !== a.opacity ? a.opacity : 1, rotation: void 0 !== a.rotation ? a.rotation : 0, scale: void 0 !== a.scale ? a.scale : 1, snapToPixel: void 0 !== a.snapToPixel ? a.snapToPixel : !0, rotateWithView: void 0 !== a.rotateWithView ? a.rotateWithView : !1 })
	}
	y(Wi, Vi);
	l = Wi.prototype;
	l.Yb = function() {
		...
		if ("fraction" == this.l || "fraction" == this.o) {
			if (!c) return null;
			a = this.c.slice(); "fraction" == this.l && (a[0] *= c[0]); "fraction" == this.o && (a[1] *= c[1]) }
		if ("top-left" != this.a) {
			if (!c) return null;
	...
	l.load = function() { this.b.load() };
	l.Nf = function(a, c) { yb(this.b, "change", a, c) };

	function Yi(a, c, d, e, f, g) { Hb.call(this);
		this.l = null;
	...
	function Zi(a) {
		var c = nh(1, 1);
		try { c.drawImage(a.a, 0, 0), c.getImageData(0, 0, 1, 1) } catch (d) { a.s = !0 } }
	Yi.prototype.A = function() { this.g = 3;
		this.i.forEach(sb);
		this.i = null;
		this.b("change") };
	Yi.prototype.T = function() { this.g = 2;
		this.f = [this.a.width, this.a.height];
		this.i.forEach(sb);
		this.i = null;
		Zi(this);
		if (!this.s && null !== this.j) { this.c.width = this.a.width;
	...
	Yi.prototype.load = function() {
		if (0 == this.g) { this.g = 1;
			this.i = [xb(this.a, "error", this.A, this), xb(this.a, "load", this.T, this)];
			try { this.a.src = this.o } catch (a) { this.A() } } };

	function Xi() { this.b = {};
		this.a = 0 }
	da(Xi);
	Xi.prototype.clear = function() { this.b = {};
		this.a = 0 };
	Xi.prototype.get = function(a, c, d) { a = c + ":" + a + ":" + (d ? Ze(d) : "null");
		return a in this.b ? this.b[a] : null };
	Xi.prototype.set = function(a, c, d, e) { this.b[c + ":" + a + ":" + (d ? Ze(d) : "null")] = e;++this.a };

	function $i(a, c) { zb.call(this);
		this.i = c;
		this.g = {};
		this.s = {} }
	y($i, zb);
	...
	l = $i.prototype;
	l.fa = function() {
		for (var a in this.g) Db(this.g[a]);
		$i.ha.fa.call(this) };
	...
	function bj() {
		...
		if (32 < a.a) {
			var c = 0,
				d, e;
			for (d in a.b) e = a.b[d], 0 !== (c++ & 3) || Ib(e) || (delete a.b[d], --a.a) } }
	...
	l.gh = function(a, c, d, e, f, g) {
		var h, k = c.viewState.resolution,
			...
			n;
		for (n = m.length - 1; 0 <= n; --n) { h = m[n];
			var p = h.layer;
			if (Gi(h, k) && f.call(g, p) && (h = cj(this, p).yc(a, c, d, e))) return h } };
	...
	function dj(a, c) {
		for (var d in a.g)
			if (!(d in c.layerStates)) { c.postRenderFunctions.push(a.ko.bind(a));
				break } }

	function db(a, c) {
		return a.zIndex - c.zIndex };

	function ej(a, c) { this.o = a;
		this.i = c;
		this.b = [];
		this.a = [];
		this.g = {} }
	ej.prototype.clear = function() { this.b.length = 0;
		this.a.length = 0;
		nb(this.g) };
	...
	function ij(a) {
		var c = a.o,
			...
			g = d.length,
			h, k, m;
		for (k = 0; k < g; ++k) h = d[k], m = c(h), Infinity == m ? delete a.g[a.i(h)] : (e[f] = m, d[f++] = h);
		d.length = f;
		e.length = f;
		for (c = (a.b.length >> 1) - 1; 0 <= c; c--) gj(a, c) };

	function jj(a, c) { ej.call(this, function(c) {
			return a.apply(null, c) }, function(a) {
			return a[0].eb() });
		this.s = c;
		this.c = 0;
		this.j = {} }
	...
	jj.prototype.f = function(a) {
		...
		return c };
	jj.prototype.l = function(a) { a = a.target;
		var c = a.V();
		if (2 === c || 3 === c || 4 === c) yb(a, "change", this.l, this), a = a.eb(), a in this.j && (delete this.j[a], --this.c), this.s() };

	function kj(a, c, d) {
		for (var e = 0, f; a.c < c && e < d && 0 < a.rc();) f = fj(a)[0], 0 === f.V() && (a.j[f.eb()] = !0, ++a.c, ++e, f.load()) };

	function lj(a, c, d) { this.f = a;
		this.g = c;
		this.i = d;
		this.b = [];
		this.a = this.c = 0 }
	...
	function mj(a, c) {
		...
		return He({ source: c, duration: g, easing: function(a) {
				return e * (Math.exp(d * a * g) - 1) / f } }) };

	function nj(a) { Mb.call(this);
		this.A = null;
		this.i(!0);
	...
	nj.prototype.j = function() {
		return this.A };
	nj.prototype.i = function(a) { this.set("active", a) };
	nj.prototype.setMap = function(a) { this.A = a };

	function oj(a, c, d, e, f) {
		if (void 0 !== d) {
			var g = c.Ka(),
				h = c.Wa();
			void 0 !== g && h && f && 0 < f && (a.Ra(Ie({ rotation: g, duration: f, easing: De })), e && a.Ra(He({ source: h, duration: f, easing: De })));
			c.rotate(d, e) } }
	...
	function qj(a, c, d, e, f) {
		if (d) {
			var g = c.Z(),
				h = c.Wa();
			void 0 !== g && h && d !== g && f && 0 < f && (a.Ra(Je({ resolution: g, duration: f, easing: De })), e && a.Ra(He({ source: h, duration: f, easing: De })));
			if (e) {
				var k;
				a = c.Wa();
				f = c.Z();
	...
	function tj(a) { a = a.originalEvent;
		return a.altKey && !(a.metaKey || a.ctrlKey) && a.shiftKey }

	function uj(a) { a = a.originalEvent;
	...
	function xj(a) { a = a.originalEvent;
		return !a.altKey && !(a.metaKey || a.ctrlKey) && !a.shiftKey }

	function yj(a) { a = a.originalEvent;
		return !a.altKey && !(a.metaKey || a.ctrlKey) && a.shiftKey }

	function zj(a) { a = a.originalEvent.target.tagName;
	...
	function Cj(a) {
		if (!(a instanceof oi)) return !0;
		var c = !1,
			d = a.type;
		if (d === xi || d === zi || d === vi) d = a.b, a.type == vi ? delete this.Ca[d.pointerId] : a.type == xi ? this.Ca[d.pointerId] = d : d.pointerId in this.Ca && (this.Ca[d.pointerId] = d), this.l = ob(this.Ca);
		this.J && (a.type == zi ? this.$c(a) : a.type == vi && (this.J = this.Ni(a)));
		a.type == xi ? (this.J = a = this.Ec(a), c = this.Dc(a)) : a.type == yi && this.Me(a);
		return !c }
	Bj.prototype.Dc = hd;

	function Ej(a) { Bj.call(this, { handleDownEvent: Fj, handleDragEvent: Gj, handleUpEvent: Hj });
		a = a ? a : {};
		this.a = a.kinetic;
		this.c = this.o = null;
	...
	function Ij(a) { a = a ? a : {};
		Bj.call(this, { handleDownEvent: Jj, handleDragEvent: Kj, handleUpEvent: Lj });
	...
	function Mj(a) { this.f = null;
		this.a = document.createElement("div");
		this.a.style.position = "absolute";
		this.a.className = "ol-box " + a;
		this.g = this.c = this.b = null }
	y(Mj, zb);
	Mj.prototype.fa = function() { this.setMap(null);
		Mj.ha.fa.call(this) };
	...
	Mj.prototype.setMap = function(a) {
		if (this.b) { this.b.B.removeChild(this.a);
			var c = this.a.style;
			c.left = c.top = c.width = c.height = "inherit" }(this.b = a) && this.b.B.appendChild(this.a) };
	...
	function Pj(a, c, d) { Eb.call(this, a);
		this.coordinate = c;
		this.mapBrowserEvent = d }
	y(Pj, Eb);

	function Qj(a) { Bj.call(this, { handleDownEvent: Rj, handleDragEvent: Sj, handleUpEvent: Tj });
		a = a ? a : {};
	...
	function Rj(a) {
		if (Aj(a) && uj(a) && this.D(a)) { this.c = a.pixel;
			this.a.setMap(a.map);
			var c = this.a,
				d = this.c;
			c.c = this.c;
	...
	function Vj(a) { a = a ? a : {};
		...
		Qj.call(this, { condition: c, className: a.className || "ol-dragzoom" }) }
	y(Vj, Qj);
	Vj.prototype.s = function() {
		var a = this.A,
			...
			f = c.Z(),
			g = c.Wa();
		a.Ra(Je({ resolution: f, duration: this.o, easing: De }));
		a.Ra(He({ source: g, duration: this.o, easing: De }));
		c.mb(Yc(e));
		c.Vb(d) };

	function Wj(a) { nj.call(this, { handleEvent: Xj });
		a = a || {};
	...
	function Xj(a) {
		...
		if ("keydown" == a.type) {
			...
			if (this.a(a) && (40 == d || 37 == d || 39 == d || 38 == d)) {
				...
				gc(d, c.Ka());
				f = this.c;
				if (g = c.Wa()) f && 0 < f && e.Ra(He({ source: g, duration: f, easing: Fe })), e = c.Qd([g[0] + d[0], g[1] + d[1]]), c.mb(e);
				a.preventDefault();
				c = !0 } }
		return !c };

	function Yj(a) { nj.call(this, { handleEvent: Zj });
		a = a ? a : {};
	...
	function ak(a) { nj.call(this, { handleEvent: bk });
		a = a || {};
		this.c = 0;
	...
	function bk(a) {
		...
		if ("wheel" == a.type || "mousewheel" == a.type) {
			...
			var e; "wheel" == a.type ? (e = d.deltaY, wh && d.deltaMode === aa.WheelEvent.DOM_DELTA_PIXEL && (e /= zh), d.deltaMode === aa.WheelEvent.DOM_DELTA_LINE && (e *= 40)) : "mousewheel" == a.type && (e = -d.wheelDeltaY, xh && (e /= 3));
			this.c += e;
	...
	ak.prototype.B = function(a) {
		...
		this.a = null;
		this.o = this.l = void 0 };
	ak.prototype.D = function(a) { this.s = a;
		a || (this.a = null) };

	function ck(a) { Bj.call(this, { handleDownEvent: dk, handleDragEvent: ek, handleUpEvent: fk });
		a = a || {};
		this.c = null;
		this.o = void 0;
		this.a = !1;
	...
	function gk(a) { Bj.call(this, { handleDownEvent: hk, handleDragEvent: ik, handleUpEvent: jk });
		a = a ? a : {};
		this.c = null;
	...
	function kk(a) {
		...
		(void 0 !== a.doubleClickZoom ? a.doubleClickZoom : 1) && c.push(new rj({ delta: a.zoomDelta, duration: a.zoomDuration }));
		...
		if (void 0 !== a.keyboard ? a.keyboard : 1) c.push(new Wj), c.push(new Yj({
			delta: a.zoomDelta,
	...
	y(lk, Bi);
	l = lk.prototype;
	l.ae = function() { this.wb() && this.u() };
	l.wk = function() { this.f.forEach(sb);
		this.f.length = 0;
		var a = this.Sc();
		...
		var a = a.a,
			d, e;
		c = 0;
		for (d = a.length; c < d; c++) e = a[c], this.a[x(e).toString()] = [D(e, "propertychange", this.ae, this), D(e, "change", this.ae, this)];
		this.u() };
	l.vk = function(a) { a = a.element;
		var c = x(a).toString();
		this.a[c] = [D(a, "propertychange", this.ae, this), D(a, "change", this.ae, this)];
		this.u() };
	l.xk = function(a) { a = x(a.element).toString();
		this.a[a].forEach(sb);
		delete this.a[a];
		this.u() };
	l.Sc = function() {
		return this.get("layers") };
	l.dh = function(a) { this.set("layers", a) };
	l.bf = function(a) {
		var c = void 0 !== a ? a : [],
			d = c.length;
		this.Sc().forEach(function(a) { a.bf(c) });
		a = Ci(this);
		var e, f;
		for (e = c.length; d < e; d++) f = c[d], f.opacity *= a.opacity, f.visible = f.visible && a.visible, f.maxResolution = Math.min(f.maxResolution, a.maxResolution), f.minResolution = Math.max(f.minResolution, a.minResolution), void 0 !== a.extent && (f.extent = void 0 !== f.extent ? $c(f.extent, a.extent) : a.extent);
		return c };
	l.df = function() {
		return "ready" };

	function mk(a) { nd.call(this, { code: a, units: "m", extent: nk, global: !0, worldExtent: ok }) }
	y(mk, nd);
	...
	function rk(a, c) { nd.call(this, { code: a, units: "degrees", extent: sk, axisOrientation: c, global: !0, metersPerUnit: tk, worldExtent: sk }) }
	y(rk, nd);
	...
	function vk(a) { Fi.call(this, a ? a : {}) }
	y(vk, Fi);
	...
	G.prototype.c = function(a) { this.set("preload", a) };
	G.prototype.f = function() {
		return this.get("useInterimTilesOnError") };
	G.prototype.i = function(a) { this.set("useInterimTilesOnError", a) };
	var wk = [0, 0, 0, 1],
		xk = [],
		yk = [0, 0, 0, 1];

	function zk(a, c, d, e) { 0 !== c && (a.translate(d, e), a.rotate(c), a.translate(-d, -e)) };
	...
	Ak.prototype.g = function() {
		return this.b };
	Ak.prototype.f = function(a) { this.b = a;
		this.a = void 0 };

	function Bk(a) { void 0 === a.a && (a.a = a.b instanceof CanvasPattern || a.b instanceof CanvasGradient ? x(a.b).toString() : "f" + (a.b ? Ze(a.b) : "-"));
		return a.a };

	function Ck() { this.a = -1 };

	function Dk() { this.a = -1;
		this.a = 64;
		this.b = Array(4);
		this.c = Array(this.a);
		this.f = this.g = 0;
	...
	function Fk(a, c) {
		...
		for (var e = d - a.a, f = a.c, g = a.g, h = 0; h < d;) {
			...
			if (ha(c))
				for (; h < d;) {
					if (f[g++] = c.charCodeAt(h++), g == a.a) { Ek(a, f);
						g = 0;
						break } } else
					for (; h < d;)
						if (f[g++] = c[h++], g == a.a) { Ek(a, f);
							g = 0;
							break } }
		a.g = g;
		a.f += d };
	...
	l.an = function() {
		return this.a };
	l.bn = function(a) { this.b = a;
		this.j = void 0 };
	l.vo = function(a) { this.f = a;
		this.j = void 0 };
	l.cn = function(a) { this.g = a;
		this.j = void 0 };
	l.wo = function(a) { this.c = a;
		this.j = void 0 };
	l.xo = function(a) { this.i = a;
		this.j = void 0 };
	l.Bo = function(a) { this.a = a;
		this.j = void 0 };
	...
	function Hk(a) {
		if (void 0 === a.j) {
			...
			if (8192 >= c.length) d = String.fromCharCode.apply(null,
				...
				for (d = "", e = 0; e < c.length; e += 8192) f = Zb(c, e, e + 8192), d += String.fromCharCode.apply(null, f);
			a.j = d
		}
		return a.j
	};
	...
	function Ik(a) {
		...
		var h = 2 * (this.g + g) + 1;
		f = { strokeStyle: f, Dd: g, size: h, lineDash: e };
		if (void 0 === c) this.b = document.createElement("CANVAS"), this.b.height = h, this.b.width = h, d = h = this.b.width, c = this.b.getContext("2d"), this.qh(f, c, 0, 0), this.f ?
			this.i = this.b : (c = this.i = document.createElement("CANVAS"), c.height = f.size, c.width = f.size, c = c.getContext("2d"), this.ph(f, c, 0, 0));
		else { h = Math.round(h);
		...
		this.D = [h, h];
		this.o = [d, d];
		Vi.call(this, { opacity: 1, rotateWithView: !1, rotation: 0, scale: 1, snapToPixel: void 0 !== a.snapToPixel ? a.snapToPixel : !0 })
	}
	y(Ik, Vi);
	l = Ik.prototype;
	l.Yb = function() {
	...
	l.load = ua;
	l.Nf = ua;
	l.qh = function(a, c, d, e) { c.setTransform(1, 0, 0, 1, 0, 0);
		c.translate(d, e);
		c.beginPath();
		...
		c.closePath() };
	l.ph = function(a, c, d, e) { c.setTransform(1, 0, 0, 1, 0, 0);
		c.translate(d, e);
		c.beginPath();
		c.arc(a.size / 2, a.size / 2, this.g, 0, 2 * Math.PI, !0);
		c.fillStyle = Ze(wk);
	...
	l.gn = function() {
		return this.b };
	l.th = function(a) { ja(a) ? this.f = a : "string" === typeof a ? this.f = function(c) {
			return c.get(a) } : a ? void 0 !== a && (this.f = function() {
			return a }) : this.f = Lk;
		this.i = a };
	l.hn = function(a) { this.b = a };
	...
	function Ok() {
		if (!Nk) {
			var a = new Ak({ color: "rgba(255,255,255,0.4)" }),
				c = new Gk({ color: "#3399CC", width: 1.25 });
			Nk = [new Kk({ image: new Ik({ fill: a, stroke: c, radius: 5 }), fill: a, stroke: c })] }
		return Nk }
	...
	function Pk() {
		...
		a.LineString = [new Kk({ stroke: new Gk({ color: c, width: 5 }) }), new Kk({ stroke: new Gk({ color: d, width: 3 }) })];
		a.MultiLineString = a.LineString;
		a.Circle = a.Polygon.concat(a.LineString);
		a.Point = [new Kk({ image: new Ik({ radius: 6, fill: new Ak({ color: d }), stroke: new Gk({ color: c, width: 1.5 }) }), zIndex: Infinity })];
	...
	H.prototype.D = function() {
		return this.f };
	H.prototype.c = function(a) { this.B = void 0 !== a ? a : Ok;
	...
	K.prototype.S = function() {
		return this.get("useInterimTilesOnError") };
	K.prototype.U = function(a) { this.set("preload", a) };
	K.prototype.aa = function(a) { this.set("useInterimTilesOnError", a) };

	function Rk(a, c, d, e, f) { this.T = {};
		this.g = a;
		this.J = c;
		this.c = d;
		this.H = e;
	...
	function Tk(a, c, d, e) {
		...
		if (a.U && "" !== a.f) {
			...
			var g = a.U,
				h = a.g,
				k = a.wa;
			k ? (k.font != g.font && (k.font = h.font = g.font), k.textAlign != g.textAlign && (k.textAlign = h.textAlign = g.textAlign), k.textBaseline != g.textBaseline && (k.textBaseline = h.textBaseline = g.textBaseline)) : (h.font = g.font, h.textAlign = g.textAlign, h.textBaseline = g.textBaseline, a.wa = { font: g.font, textAlign: g.textAlign, textBaseline: g.textBaseline });
	...
	function Xk(a, c, d, e, f) {
		var g = a.g,
			h, k;
		h = 0;
		for (k = e.length; h < k; ++h) d = Wk(a, c, d, e[h], f, !0), g.closePath();
		return d }
	l = Rk.prototype;
	l.ld = function(a, c) {
		var d = a.toString(),
	...
	l.Ic = function(a) {
		if (ad(this.c, a.G())) {
			if (this.a || this.b) { this.a && Uk(this, this.a);
				...
				this.a && e.fill();
				this.b && e.stroke() } "" !== this.f && Tk(this, a.vd(), 2, 2) } };
	l.We = function(a, c) {
		var d = (0, c.f)(a);
		if (d && ad(this.c, d.G())) {
			var e = c.b;
			void 0 === e && (e = 0);
			this.ld(e, function(a) { a.hb(c.c, c.g);
				a.yb(c.a);
				a.ib(c.Fa());
	...
	l.Ib = function(a) {
		var c = a.ga();
		a = a.qa();
		this.i && Sk(this, c, c.length); "" !== this.f && Tk(this, c, c.length, a) };
	l.Hb = function(a) {
		var c = a.ga();
		a = a.qa();
		this.i && Sk(this, c, c.length); "" !== this.f && Tk(this, c, c.length, a) };
	l.Xb = function(a) {
		if (ad(this.c, a.G())) {
			if (this.b) { Vk(this, this.b);
				var c = this.g,
					d = a.ga();
				c.beginPath();
				Wk(this, d, 0, d.length, a.qa(), !1);
				c.stroke() } "" !== this.f && (a = Zk(a), Tk(this, a, 2, 2)) } };
	l.Jc = function(a) {
		var c = a.G();
		if (ad(this.c, c)) {
			if (this.b) { Vk(this, this.b);
				...
				var h, k;
				h = 0;
				for (k = f.length; h < k; ++h) e = Wk(this, d, e, f[h], g, !1);
				c.stroke() } "" !== this.f && (a = $k(a), Tk(this, a, a.length, 2)) } };
	l.Lc = function(a) {
		if (ad(this.c, a.G())) {
			if (this.b || this.a) { this.a && Uk(this, this.a);
				this.b && Vk(this, this.b);
				var c = this.g;
				c.beginPath();
				Xk(this, a.Rb(), 0, a.Cb(), a.qa());
				this.a && c.fill();
				this.b && c.stroke() } "" !== this.f && (a = se(a), Tk(this, a, 2, 2)) } };
	l.Kc = function(a) {
		if (ad(this.c, a.G())) {
			if (this.b || this.a) { this.a && Uk(this, this.a);
				this.b && Vk(this, this.b);
				...
				for (k = f.length; h < k; ++h) {
					...
					e = Xk(this, d, e, m, g);
					this.a && c.fill();
					this.b && c.stroke() } } "" !== this.f && (a = bl(a), Tk(this, a, a.length, 2)) } };
	...
	function cl(a) {
		...
		d = 0;
		for (e = c.length; d < e; ++d)
			for (f = a.T[c[d].toString()], g = 0, h = f.length; g < h; ++g) f[g](a) }
	...
	l.hb = function(a, c) {
		if (a) {
			var d = a.b;
			this.a = { fillStyle: af(d ? d : wk) } } else this.a = null;
		if (c) {
			var d = c.b,
				e = c.f,
				f = c.g,
				...
				h = c.a,
				k = c.i;
			this.b = { lineCap: void 0 !== e ? e : "round", lineDash: f ? f : xk, lineJoin: void 0 !== g ? g : "round", lineWidth: this.J * (void 0 !== h ? h : 1), miterLimit: void 0 !== k ? k : 10, strokeStyle: Ze(d ? d : yk) } } else this.b = null };
	l.yb = function(a) {
		if (a) {
			var c = a.Yb(),
				d = a.gc(1),
		...
		if (a) {
			...
			if (d) {
				var c = d.b,
					...
					h = d.a,
					d = d.i;
				this.s = { lineCap: void 0 !== e ? e : "round", lineDash: f ? f : xk, lineJoin: void 0 !== g ? g : "round", lineWidth: void 0 !== h ? h : 1, miterLimit: void 0 !== d ? d : 10, strokeStyle: Ze(c ? c : yk) } } else this.s = null;
			var c = a.g,
				e = a.f,
				f = a.c,
				g = a.i,
				...
				k = a.l;
			a = a.o;
			this.U = { font: void 0 !== c ? c : "10px sans-serif", textAlign: void 0 !== k ? k : "center", textBaseline: void 0 !== a ? a : "middle" };
			this.f = void 0 !== d ?
				d : "";
	...
	var Yk = { Point: Rk.prototype.Ib, LineString: Rk.prototype.Xb, Polygon: Rk.prototype.Lc, MultiPoint: Rk.prototype.Hb, MultiLineString: Rk.prototype.Jc, MultiPolygon: Rk.prototype.Kc, GeometryCollection: Rk.prototype.Sd, Circle: Rk.prototype.Ic };

	function dl(a) { Mi.call(this, a);
		this.H = nc() }
	y(dl, Mi);
	...
	function fl(a, c, d, e) { el(a, "postcompose", c, d, e) }
	...
	function jl(a, c, d, e, f, g) {
		var h = a.coordinates.length,
			...
			p = !0,
			q, r, t;
		for (q = d + f; q < e; q += f) n[0] = c[q], n[1] = c[q + 1], t = Hc(k, n), t !== r ? (p && (a.coordinates[h++] = m[0], a.coordinates[h++] = m[1]), a.coordinates[h++] = n[0], a.coordinates[h++] = n[1], p = !1) : 1 === t ? (a.coordinates[h++] = n[0], a.coordinates[h++] = n[1], p = !1) : p = !0, m[0] = n[0], m[1] = n[1], r = t;
		q === d + f && (a.coordinates[h++] = m[0], a.coordinates[h++] = m[1]);
		g && (a.coordinates[h++] = c[d], a.coordinates[h++] = c[d + 1]);
		return h }

	function kl(a, c) { a.ta = [0, c, 0];
		a.a.push(a.ta);
		a.ua = [0, c, 0];
		a.b.push(a.ua) }
			...
			switch (B[0]) {
				...
				case 4:
					...
					for (B[10] && (C += f); r < t; r += 2) {
						...
						if (1 != A || 0 !== C) tc(v, a), c.transform(a[0],
				...
				case 5:
					...
					A = B[7] * d;
					L = B[8];
					for (J = B[9]; r < t; r += 2) { B = n[r] + Aa;
						P = n[r + 1] + I;
						if (1 != A || 0 !== C) Ji(v, B, P, A, A, C, -B, -P), c.transform(v[0], v[1], v[4], v[5], v[12], v[13]);
						ca = M.split("\n");
						Da = ca.length;
						1 < Da ? (Ia = Math.round(1.5 * c.measureText("M").width), P -= (Da - 1) / 2 * Ia) : Ia = 0;
						for (ab = 0; ab < Da; ab++) Pa = ca[ab], J && c.strokeText(Pa, B, P), L && c.fillText(Pa, B, P), P += Ia;
						if (1 != A || 0 !== C) tc(v, a), c.transform(a[0], a[1], a[4], a[5], a[12], a[13]) }++p;
					break;
				case 6:
					if (void 0 !==
				...
				case 8:
					...
					C = B + .5 | 0;
					A = P + .5 | 0;
					if (C !== w || A !== z) c.moveTo(B, P), w = C, z = A;
					for (r += 2; r < t; r += 2)
						if (B = n[r], P = n[r + 1], C = B + .5 | 0, A = P + .5 | 0, C !== w || A !== z) c.lineTo(B, P), w = C, z = A;
						++p;
					break;
				case 9:
					c.fillStyle = B[1];
	...
	function nl(a, c) { a.ta[2] = a.a.length;
		a.ta = null;
		a.ua[2] = a.b.length;
		a.ua = null;
		var d = [6, c];
	...
	function pl(a, c, d) { il.call(this, a, c, d);
		this.l = this.S = null;
	...
	pl.prototype.Hb = function(a, c) {
		if (this.l) { kl(this, c);
			...
			this.b.push([4, e, d, this.S, this.g, this.i, this.j, this.o, this.s, this.A, this.T, this.B, this.J, this.D, this.H]);
			nl(this, c) } };
	pl.prototype.le = function() { ml(this);
	...
	function ql(a, c, d) { il.call(this, a, c, d);
		this.g = { jd: void 0, dd: void 0, ed: null, fd: void 0, gd: void 0, hd: void 0, gf: 0, strokeStyle: void 0, lineCap: void 0, lineDash: null, lineJoin: void 0, lineWidth: void 0, miterLimit: void 0 } }
	y(ql, il);
	...
	function rl(a, c, d, e, f) {
		...
		return e }
	l = ql.prototype;
	l.Ye = function() { this.f || (this.f = Bc(this.Ga), 0 < this.c && Ac(this.f, this.resolution * (this.c + 1) / 2, this.f));
		return this.f };
	...
	l.Jc = function(a, c) {
		var d = this.g,
			e = d.lineWidth;
		if (void 0 !== d.strokeStyle && void 0 !== e) { sl(this);
			kl(this, c);
			...
			var d = a.Cb(),
				...
				h, k;
			h = 0;
			for (k = d.length; h < k; ++h) g = rl(this, e, g, d[h], f);
			this.b.push([12]);
			nl(this, c) } };
	l.le = function() { this.g.gf != this.coordinates.length && this.a.push([12]);
		ml(this);
		this.g = null };
	l.hb = function(a, c) {
		var d = c.b;
	...
	function tl(a, c, d) { il.call(this, a, c, d);
		this.g = { kg: void 0, jd: void 0, dd: void 0, ed: null, fd: void 0, gd: void 0, hd: void 0, fillStyle: void 0, strokeStyle: void 0, lineCap: void 0, lineDash: null, lineJoin: void 0, lineWidth: void 0, miterLimit: void 0 } }
	y(tl, il);
	...
	l.Ic = function(a, c) {
		var d = this.g,
			e = d.strokeStyle;
		if (void 0 !== d.fillStyle || void 0 !== e) { vl(this);
			kl(this, c);
			this.b.push([9, Ze(wk)]);
	...
	l.Lc = function(a, c) {
		var d = this.g,
			e = d.strokeStyle;
		if (void 0 !== d.fillStyle || void 0 !== e) vl(this), kl(this, c), this.b.push([9, Ze(wk)]), void 0 !== d.strokeStyle && this.b.push([10, d.strokeStyle, d.lineWidth, d.lineCap, d.lineJoin, d.miterLimit, d.lineDash]), d = a.Cb(), e = a.Rb(), ul(this, e, 0, d, a.qa()), nl(this, c) };
	l.Kc = function(a, c) {
		var d = this.g,
			e = d.strokeStyle;
		if (void 0 !== d.fillStyle || void 0 !== e) { vl(this);
			...
			var d = a.c,
				...
				h, k;
			h = 0;
			for (k = d.length; h < k; ++h) g = ul(this, e, g, d[h], f);
			nl(this, c) } };
	l.le = function() { ml(this);
		this.g = null;
		var a = this.na;
		if (0 !== a) {
	...
	l.hb = function(a, c) {
		...
		if (a) {
			var e = a.b;
			d.fillStyle = af(e ? e : wk) } else d.fillStyle = void 0;
	...
	function wl(a, c, d) { il.call(this, a, c, d);
	...
	wl.prototype.Jb = function(a, c, d, e, f, g) {
		if ("" !== this.l && this.j && (this.g || this.i)) {
			...
			this.i && (f = this.i, h = this.J, h && h.lineCap == f.lineCap && h.lineDash == f.lineDash && h.lineJoin == f.lineJoin && h.lineWidth == f.lineWidth && h.miterLimit == f.miterLimit && h.strokeStyle == f.strokeStyle || (k = [10, f.strokeStyle, f.lineWidth, f.lineCap, f.lineJoin, f.miterLimit,
				f.lineDash, !1
			], this.a.push(k), this.b.push(k), h ? (h.lineCap = f.lineCap, h.lineDash = f.lineDash, h.lineJoin = f.lineJoin, h.lineWidth = f.lineWidth, h.miterLimit = f.miterLimit, h.strokeStyle = f.strokeStyle) : this.J = { lineCap: f.lineCap, lineDash: f.lineDash, lineJoin: f.lineJoin, lineWidth: f.lineWidth, miterLimit: f.miterLimit, strokeStyle: f.strokeStyle }));
			f = this.j;
			h = this.D;
			h && h.font == f.font && h.textAlign == f.textAlign && h.textBaseline == f.textBaseline || (k = [11, f.font, f.textAlign, f.textBaseline], this.a.push(k), this.b.push(k), h ?
				(h.font = f.font, h.textAlign = f.textAlign, h.textBaseline = f.textBaseline) : this.D = { font: f.font, textAlign: f.textAlign, textBaseline: f.textBaseline });
			kl(this, g);
		...
		if (a) {
			...
			if (d) {
				...
				if (this.i) {
					...
					k.lineWidth = h;
					k.miterLimit = d;
					k.strokeStyle = c } else this.i = { lineCap: e, lineDash: f, lineJoin: g, lineWidth: h, miterLimit: d, strokeStyle: c } } else this.i = null;
			var m = a.g,
				c = a.f,
				e = a.c,
				f = a.i,
			...
			g = void 0 !== g ? g : "center";
			k = void 0 !== k ? k : "middle";
			this.j ? (m = this.j, m.font = a, m.textAlign = g, m.textBaseline = k) : this.j = { font: a, textAlign: g, textBaseline: k };
			this.l = void 0 !== d ? d : "";
			this.o = void 0 !== c ? c : 0;
			this.s = void 0 !== e ? e : 0;
			this.A = void 0 !== f ? f : 0;
	...
	xl.prototype.a = function(a, c, d, e, f, g) {
		...
		for (m = h.length; g < m; ++g)
			for (p = this.g[h[g].toString()], n = 0, k = hl.length; n < k; ++n) q = p[hl[n]], void 0 !== q && ll(q, a, c, d, e, f, q.a, void 0);
		a.restore() };
	...
	function zl(a, c, d, e, f, g, h) {
		...
		for (n = k.length; m < n; ++m)
			for (q = a.g[k[m].toString()], p = hl.length - 1; 0 <= p; --p)
				if (r = q[hl[p]], void 0 !== r && (r = ll(r, c, 1, d, e, f, r.b, g, h))) return r }
	var Al = { Image: pl, LineString: ql, Polygon: tl, Text: wl };

	function Bl(a, c, d, e) { this.g = a;
		this.b = c;
		this.c = d;
		this.f = e }
	l = Bl.prototype;
	...
	l.Cb = function() {
		return this.c };
	l.G = function() { this.a || (this.a = "Point" === this.g ? Jc(this.b) : Kc(this.b, 0, this.b.length, 2));
		return this.a };
	l.Rb = function() {
		return this.b };
	...
	function El(a, c, d, e, f, g) {
		var h = !1,
			k, m;
		if (k = d.a) m = k.wd(), 2 == m || 3 == m ? k.Nf(f, g) : (0 == m && k.load(), k.hf(f, g), h = !0);
		if (f = (0, d.f)(c)) e = f.sd(e), (0, Fl[e.W()])(a, e, d, c);
		return h }
	var Fl = {
		...
		GeometryCollection: function(a, c, d, e) { c = c.i;
			var f, g;
			f = 0;
			for (g = c.length; f < g; ++f)(0, Fl[c[f].W()])(a, c[f], d, e) },
	...
	function Gl(a, c, d, e, f, g) { this.c = void 0 !== g ? g : null;
		Hi.call(this, a, c, d, void 0 !== g ? 0 : 2, e);
		this.g = f }
	y(Gl, Hi);
	Gl.prototype.i = function(a) { this.state = a ? 3 : 2;
		Ii(this) };
	Gl.prototype.load = function() { 0 == this.state && (this.state = 1, Ii(this), this.c(this.i.bind(this))) };
	...
	function Kl(a, c, d, e, f, g, h, k, m, n, p) {
		...
		q.scale(d, d);
		var r = yc();
		m.forEach(function(a) { Nc(r, a.extent) });
		var t = nh(Math.round(d * Wc(r) / e), Math.round(d * Xc(r) / e)),
			v = d / e;
		m.forEach(function(a) { t.drawImage(a.image, n, n, a.image.width - 2 * n, a.image.height - 2 * n, (a.extent[0] - r[0]) * v, -(a.extent[3] - r[3]) * v, Wc(a.extent) * v, Xc(a.extent) * v) });
		var w = Sc(h);
		k.f.forEach(function(a) {
			...
			a: {
				...
				for (m = 0; m < k; m++) {
					for (var n = m, Ia = Math.abs(h[m][m]), ab = m + 1; ab < k; ab++) {
					...
					h[m] = Ia;
					for (n = m + 1; n < k; n++)
						for (Ia = -h[n][m] / h[m][m], ab = m; ab < k + 1; ab++) h[n][ab] = m == ab ? 0 : h[n][ab] + Ia * h[m][ab] }
				m = Array(k);
				for (n = k - 1; 0 <= n; n--)
					for (m[n] = h[n][k] / h[n][n], Ia = n - 1; 0 <= Ia; Ia--) h[Ia][k] -= h[Ia][n] * m[n];h = m
			}
		...
		if (this.l) {
			...
			this.f.forEach(function(a) {
				if (Math.max(a.source[0][0], a.source[1][0], a.source[2][0]) - p > this.b / 2) {
					...
					Math.max(c[0][0], c[1][0], c[2][0]) - Math.min(c[0][0], c[1][0], c[2][0]) < this.b / 2 && (a.source = c) } }, this)
		}
		g = {}
	}
	...
	function Ml(a, c, d, e, f, g, h, k, m, n) {
		var p = xc([g, h, k, m]),
			...
			t = !1;
		if (0 < n) {
			if (a.c.g && a.j) var v = xc([c, d, e, f]),
				t = t | .25 < Wc(v) / a.j;!r && a.g.g && q && (t |= .25 < q) }
		if (t || !a.i || ad(p, a.i)) {
			if (!(t || isFinite(g[0]) && isFinite(g[1]) && isFinite(h[0]) && isFinite(h[1]) && isFinite(k[0]) && isFinite(k[1]) && isFinite(m[0]) && isFinite(m[1])))
				if (0 < n) t = !0;
				else return;
			if (0 < n && (t || (q = a.a([(c[0] + e[0]) / 2, (c[1] + e[1]) / 2]), p = r ? ($b(g[0], a.b) + $b(k[0], a.b)) / 2 - $b(q[0], a.b) : (g[0] + k[0]) / 2 - q[0], q = (g[1] + k[1]) / 2 - q[1],
					t = p * p + q * q > a.s), t)) { Math.abs(c[0] - e[0]) <= Math.abs(c[1] - e[1]) ? (r = [(d[0] + e[0]) / 2, (d[1] + e[1]) / 2], p = a.a(r), q = [(f[0] + c[0]) / 2, (f[1] + c[1]) / 2], t = a.a(q), Ml(a, c, d, r, q, g, h, p, t, n - 1), Ml(a, q, r, e, f, t, p, k, m, n - 1)) : (r = [(c[0] + d[0]) / 2, (c[1] + d[1]) / 2], p = a.a(r), q = [(e[0] + f[0]) / 2, (e[1] + f[1]) / 2], t = a.a(q), Ml(a, c, r, q, f, g, p, t, m, n - 1), Ml(a, r, d, e, q, p, h, k, t, n - 1));
				return }
			if (r) {
				if (!a.o) return;
				a.l = !0 }
	...
	function Nl(a) {
		var c = yc();
		a.f.forEach(function(a) { a = a.source;
			zc(c, a[0]);
			zc(c, a[1]);
			zc(c, a[2]) });
		return c };

	function Ol(a, c, d, e, f, g) { this.A = c;
		this.s = a.G();
		var h = c.G(),
			k = h ? $c(d, h) : d,
			h = Il(a, c, Yc(k), e);
	...
	y(Ol, Hi);
	Ol.prototype.fa = function() { 1 == this.state && (sb(this.Cd), this.Cd = null);
		Ol.ha.fa.call(this) };
	Ol.prototype.a = function() {
		return this.i };
	Ol.prototype.Bd = function() {
		var a = this.ob.V();
		2 == a && (this.i = Kl(Wc(this.g) / this.c, Xc(this.g) / this.c, this.l, this.ob.Z(), 0, this.c, this.g, this.j, [{ extent: this.ob.G(), image: this.ob.a() }], 0));
		this.state = a;
		Ii(this) };
	Ol.prototype.load = function() {
		if (0 == this.state) { this.state = 1;
			Ii(this);
			var a = this.ob.V();
			2 == a || 3 == a ? this.Bd() : (this.Cd = D(this.ob, "change", function() {
				var a = this.ob.V();
				if (2 == a || 3 == a) sb(this.Cd), this.Cd = null, this.Bd() }, this), this.ob.load()) } };

	function Pl(a) { rg.call(this, { attributions: a.attributions, extent: a.extent, logo: a.logo, projection: a.projection, state: a.state });
	...
	Pl.prototype.B = function(a, c, d, e) {
		...
		if (f && e && !Hd(f, e)) {
			if (this.a) {
				if (this.na == this.g && Hd(this.a.A, e) && this.a.Z() == c && this.a.f == d && Mc(this.a.G(), a)) return this.a;
				this.a.Rd();
				this.a = null }
			this.a = new Ol(f, e, a, c, d, function(a, c, d) {
				return this.pd(a, c, d, f) }.bind(this));
			this.na = this.g;
			return this.a }
		f && (e = f);
		return this.pd(a, c, d, e) };
	Pl.prototype.l = function(a) { a = a.target;
		switch (a.V()) {
			case 1:
				this.b(new Rl(Sl, a));
				break;
	...
	function Vl(a, c) { a.a().src = c }

	function Rl(a, c) { Eb.call(this, a);
		this.image = c }
	y(Rl, Eb);
	...
	function Wl(a) { Pl.call(this, { attributions: a.attributions, logo: a.logo, projection: a.projection, resolutions: a.resolutions, state: a.state });
		this.aa = a.canvasFunction;
		this.S = null;
		this.U = 0;
		this.oa = void 0 !== a.ratio ? a.ratio : 1.5 }
	y(Wl, Pl);
	Wl.prototype.pd = function(a, c, d, e) { c = Ql(this, c);
		var f = this.S;
		if (f && this.U == this.g && f.Z() == c && f.f == d && Gc(f.G(), a)) return f;
		a = a.slice();
		bd(a, this.oa);
	...
	l.bc = function() {
		return this.j };
	l.ml = function() { this.u() };
	l.$d = function() { this.f && (sb(this.f), this.f = null);
		var a = this.X();
		a && (this.f = D(a, "change", this.ml, this));
		this.u() };
	l.Pa = function(a) { this.set(this.a, a) };
	l.lf = function(a) { this.j = (this.c = a) ? Yl(a) : void 0;
		this.u() };
	l.jc = function(a) { this.i = a;
		this.u() };
	l.Bc = function(a) { yb(this, Ob(this.a), this.$d, this);
		this.a = a;
		D(this, Ob(this.a), this.$d, this);
		this.$d() };
	...
	function Zl(a, c, d, e, f) { pg.call(this, a, c);
		this.o = nh();
		this.j = e;
		this.i = null;
		this.c = { kd: !1, Kf: null, Kh: -1, Vc: null };
		this.A = f;
		this.l = d }
	y(Zl, pg);
	l = Zl.prototype;
	l.fa = function() { Zl.ha.fa.call(this) };
	l.xl = function() {
		return this.j };
	l.eb = function() {
		return this.l };
	l.load = function() { 0 == this.state && (this.state = 1, qg(this), this.A(this, this.l), this.s(null, NaN, null)) };
	l.Ph = function(a) { this.i = a;
		this.state = 2;
		qg(this) };
	l.Th = function(a) { this.s = a };

	function $l() {
		if (!kf) return !1;
		try {
			return new ActiveXObject("MSXML2.DOMDocument"), !0 } catch (a) {
			return !1 } }
	var am = kf && $l();
	...
	var cm;
	a: if (document.implementation && document.implementation.createDocument) cm = document.implementation.createDocument("", "", null);
		else {
			if (am) {
				var dm = new ActiveXObject("MSXML2.DOMDocument");
				if (dm) { dm.resolveExternals = !1;
					dm.validateOnParse = !1;
					try { dm.setProperty("ProhibitDTD", !0), dm.setProperty("MaxXMLSize", 2048), dm.setProperty("MaxElementDepth", 256) } catch (a) {} }
				if (dm) { cm = dm;
					break a } }
	...
	function jm(a, c, d) {
		if (4 == a.nodeType || 3 == a.nodeType) c ? d.push(String(a.nodeValue).replace(/(\r\n|\r|\n)/g, "")) : d.push(a.nodeValue);
			...
			for (a = a.firstChild; a; a = a.nextSibling) jm(a, c, d);
		return d }
	...
	function ym(a, c, d) {
		...
		for (var f, g, h = 0, k = a.length; h < k; ++h)
			if (f = a[h], f.namespaceURI == c && (g = f.prefix ? f.prefix + ":" + d : d, g == f.nodeName)) { e = f;
				break }
		return e }
	var vm = document.implementation && document.implementation.createDocument ? xm : ym;

	function zm(a, c, d, e) { a.setAttributeNS(c, d, e) }

	function Am(a, c, d, e) { c ? (c = a.ownerDocument.createNode(2, d, c), c.nodeValue = e, a.setAttributeNode(c)) : a.setAttribute(d, e) }
	...
	function O(a, c) {
		return function(d, e, f) { a.call(void 0 !== c ? c : this, d, e, f);
	...
	function Im(a, c) {
		return function(d, e, f) { d = e[e.length - 1].node;
			e = a;
			void 0 === e && (e = f);
			f = c;
	...
	function Nm(a, c, d, e, f, g, h) { f.push(a);
		Jm(c, d, e, f, g, h);
		f.pop() };
		...
		return function(f, g, h) {
			...
			k.onload = function() {
				if (200 <= k.status && 300 > k.status) {
					var a = c.W(),
						f; "json" == a || "text" == a ? f = k.responseText : "xml" == a ? (f = k.responseXML) || (f = Cm(k.responseText)) : "arraybuffer" == a && (f = k.response);
					f && d.call(this, c.Ea(f, { featureProjection: h }), c.Qa(f)) } else e.call(this) }.bind(this);
			k.send() } }

	function Pm(a, c) {
		return Om(a, c, function(a, c) { this.g = c;
			this.Ph(a) }, function() { this.state = 3;
			qg(this) }) }

	function Qm(a, c) {
		return Om(a, c, function(a) { this.Gc(a) }, ua) };
		...
		(function() {
			...
			function r(a, c, d, e, f) {
				for (var g, h, k, m, n; d > c;) {
					...
					m = d;
					t(a, c, e);
					for (0 < f(a[d], g) && t(a, c, d); h < m;) { t(a, h, m);
						h++;
						for (m--; 0 > f(a[h], g);) h++;
						for (; 0 < f(a[m], g);) m-- }
			...
			c.prototype = {
				...
				search: function(a) {
					...
					for (var f = [], g, h, k, m; c;) { g = 0;
						for (h = c.children.length; g < h; g++) k = c.children[g], m = c.Ja ? e(k) : k.bbox, p(a, m) && (c.Ja ? d.push(k) : n(a, m) ? this.Tf(k, d) : f.push(k));
						c = f.pop() }
					return d
				},
				load: function(a) {
				...
				za: function(a) { a && this.Xf(a, this.data.height - 1);
					return this },
				clear: function() { this.data = { children: [], height: 1, bbox: [Infinity, Infinity, -Infinity, -Infinity], Ja: !0 };
					return this },
				remove: function(a) {
					if (!a) return this;
					for (var c = this.data, d = this.kb(a), e = [], f = [], g, h, k, m; c || e.length;) {
						c || (c = e.pop(), h = e[e.length - 1], g = f.pop(), m = !0);
						if (c.Ja && (k = c.children.indexOf(a), -1 !== k)) { c.children.splice(k, 1);
							e.push(c);
							this.Si(e);
							break }
				...
				Vf: function(a, c, e, f) {
					var g = e - c + 1,
						h = this.Qe,
						k;
					if (g <= h) return k = { children: a.slice(c, e + 1), height: 1, bbox: null, Ja: !0 }, d(k, this.kb), k;
					...
					for (q(a, c, e, h, this.Te); c <= e; c += h)
						for (n = Math.min(c + h - 1, e), q(a, c, n, g, this.Ue), m = c; m <= n; m += g) p = Math.min(m + g - 1, n), k.children.push(this.Vf(a, m, p, f - 1));
					d(k, this.kb);
					return k
				},
				Ri: function(a, c, d, e) {
				...
				Xf: function(a, c, d) {
					...
					g.children.push(a);
					for (f(g.bbox, d); 0 <= c;)
						if (e[c].children.length > this.Qe) this.$i(e, c), c--;
						else break;
					this.Oi(d, e, c) },
				$i: function(a, c) {
					var e = a[c],
				...
				$f: function(a, c) { this.data = { children: [a, c], height: a.height + 1, bbox: null, Ja: !1 };
					d(this.data, this.kb) },
				Qi: function(a, c, d) {
					var f, g, h, m, n, p, q;
					n = p = Infinity;
					for (f = c; f <= d - c; f++) g = e(a, 0, f, this.kb), h = e(a, f, d, this.kb), m = Math.max(0, Math.min(g[2], h[2]) - Math.max(g[0], h[0])) * Math.max(0, Math.min(g[3], h[3]) - Math.max(g[1], h[1])), g = k(g) + k(h), m < n ? (n = m, q = f, p = g < p ? g : p) : m === n && g < p && (p = g, q = f);
					return q },
				Pi: function(a, c, d) {
				...
				Uf: function(a, c, d, g) { a.children.sort(g);
					g = this.kb;
					var h = e(a, 0, c, g),
						k = e(a, d - c, d, g),
						n = m(h) + m(k),
				...
				Si: function(a) {
					for (var c = a.length - 1, e; 0 <= c; c--) 0 === a[c].children.length ? 0 < c ? (e = a[c - 1].children, e.splice(e.indexOf(a[c]), 1)) : this.clear() : d(a[c], this.kb) },
				Ui: function(a) {
					var c = ["return a",
						" - b", ";"
					];
	...
	function bn(a) {
		a = a || {};
		rg.call(this, { attributions: a.attributions, logo: a.logo, projection: void 0, state: "ready", wrapX: void 0 !== a.wrapX ? a.wrapX : !0 });
		this.H = ua;
	...
	l.rb = function(a) {
		var c = x(a).toString();
		if (en(this, c, a)) { fn(this, c, a);
			var d = a.X();
			d ? (c = d.G(), this.a && this.a.za(c, a)) : this.i[c] = a;
			this.b(new gn("addfeature", a)) }
		this.u() };

	function fn(a, c, d) { a.o[c] = [D(d, "change", a.oh, a), D(d, "propertychange", a.oh, a)] }
	...
	function cn(a, c) {
		var d, e, f, g, h = [],
			...
			m = [];
		e = 0;
		for (f = c.length; e < f; e++) g = c[e], d = x(g).toString(), en(a, d, g) && k.push(g);
		e = 0;
		...
		a.a && a.a.load(h, m);
		e = 0;
		for (f = k.length; e < f; e++) a.b(new gn("addfeature", k[e])) }

	function dn(a, c) {
		var d = !1;
		D(a, "addfeature", function(a) { d || (d = !0, c.push(a.feature), d = !1) });
		D(a, "removefeature", function(a) { d || (d = !0, c.remove(a.feature), d = !1) });
		D(c, "add", function(a) { d || (a = a.element, d = !0, this.rb(a), d = !1) }, a);
		D(c, "remove", function(a) { d || (a = a.element, d = !0, this.nb(a), d = !1) }, a);
		a.c = c }
	l.clear = function(a) {
		if (a) {
			for (var c in this.o) this.o[c].forEach(sb);
			this.c || (this.o = {}, this.j = {}, this.l = {}) } else if (this.a) { this.a.forEach(this.Jf, this);
			for (var d in this.i) this.Jf(this.i[d]) }
		this.c && this.c.clear();
		this.a && this.a.clear();
		this.S.clear();
		this.i = {};
	...
	function hn(a, c, d) { a.ub([c[0], c[1], c[0], c[1]], function(a) {
			if (a.X().ig(c)) return d.call(void 0, a) }) }
	l.ub = function(a, c, d) {
		if (this.a) return an(this.a, a, c, d);
		if (this.c) return this.c.forEach(c, d) };
	l.ng = function(a, c, d) {
		return this.ub(a, function(e) {
			if (e.X().Ia(a) && (e = c.call(d, e))) return e }) };
	l.ug = function() {
		return this.c };
	l.oe = function() {
		var a;
	...
	l.G = function() {
		return this.a.G() };
	l.sg = function(a) { a = this.j[a.toString()];
		return void 0 !== a ? a : null };
	l.oh = function(a) { a = a.target;
		var c = x(a).toString(),
			d = a.X();
	...
	l.Oc = function(a, c, d) {
		...
		for (g = a.length; f < g; ++f) {
			var h = a[f];
			an(e, h, function(a) {
				return Gc(a.extent, h) }) || (this.H.call(this, h, c, d), e.za(h, { extent: h.slice() })) } };
	l.nb = function(a) {
		var c = x(a).toString();
	...
	function jn(a, c) {
		for (var d in a.j)
			if (a.j[d] === c) { delete a.j[d];
				break } }

	function gn(a, c) { Eb.call(this, a);
		this.feature = c }
	y(gn, Eb);

	function kn(a) { this.c = a.source;
		this.ya = nc();
		this.i = nh();
		this.j = [0, 0];
		this.s = null;
		Wl.call(this, { attributions: a.attributions, canvasFunction: this.kj.bind(this), logo: a.logo, projection: a.projection, ratio: a.ratio, resolutions: a.resolutions, state: this.c.V() });
		this.H = null;
		this.o = void 0;
		this.kh(a.style);
		...
		this.c.ub(a, function(a) {
			...
			if (!(e = h)) {
				...
				if (f) {
					...
					fa(f) || (f = [f]);
					e = 0;
					for (p = f.length; e < p; ++e) q = El(g, a, f[e], Dl(c, d), this.zm, this) || q;
					e = q } else e = !1 }
			h = e }, this);
		yl(g);
		if (h) return null;
	...
	l.zm = function() { this.u() };
	l.Am = function() { tg(this, this.c.V()) };
	l.kh = function(a) { this.H = void 0 !== a ? a : Ok;
		this.o = a ? Mk(this.H) : void 0;
		this.u() };

	function mn(a) { dl.call(this, a);
		this.f = null;
		this.o = nc();
		this.j = this.i = null }
	y(mn, dl);
	...
	mn.prototype.yc = function(a, c, d, e) {
		if (this.f && this.f.a())
			if (this.a.da() instanceof kn) {
				if (a = a.slice(), Li(c.pixelToCoordinateMatrix, a, a), this.gb(a, c, fd, this)) return d.call(e, this.a) } else if (this.i || (this.i = nc(), tc(this.o, this.i)), c = [0, 0], Li(this.i, a, c), this.j || (this.j = nh(1, 1)), this.j.clearRect(0, 0, 1, 1), this.j.drawImage(this.f ? this.f.a() : null, c[0], c[1], 1, 1, 0, 0, 1, 1), 0 < this.j.getImageData(0, 0, 1, 1).data[3]) return d.call(e, this.a) };
	...
	nn.prototype.c = function(a, c, d) {
		...
		for (var C = 0, A = w.length; C < A; ++C) {
			...
			if (!c) {
				P = [I, J, I + L, J + Aa];
				m.save();
				for (var ca = 0, Da = z.length; ca < Da; ++ca) {
					var Ia = z[ca];
					ad(P, Ia) && (m.beginPath(), m.moveTo(P[0], P[1]), m.lineTo(P[0], P[3]), m.lineTo(P[2], P[3]), m.lineTo(P[2], P[1]), m.moveTo(Ia[0], Ia[1]), m.lineTo(Ia[2], Ia[1]), m.lineTo(Ia[2], Ia[3]), m.lineTo(Ia[0], Ia[3]), m.closePath(),
						m.clip())
				}
				z.push(P)
			}
	...
	nn.prototype.l = function(a, c) {
		...
		var r = this.cd(k, g, q),
			...
			z, C, A, B;
		for (A = p.ra; A <= p.va; ++A)
			for (B = p.xa; B <= p.Aa; ++B) z = k.Qb(n, A, B, e, g), !d(z) && z.a && (z = z.a), d(z) ?
				q[n][z.ja.toString()] = z : (C = xg(m, z.ja, r, w, v), C || (z = zg(m, z.ja, w, v)) && r(n + 1, z));
		r = Object.keys(q).map(Number);
		r.sort(Ua);
		var v = [],
			L, w = 0;
		for (A = r.length; w < A; ++w)
			for (L in z = r[w], B = q[z], B) z = B[L], 2 == z.V() && v.push(z);
		this.j = v;
	...
	on.prototype.c = function(a, c, d) {
		...
		if (q && !q.Oa()) {
			...
			q.a(r, f, p, h, g);
			if (n.J && k.b && !Gc(m, e)) {
				for (var k = e[0], n = Wc(m), w = 0; k < m[0];) --w,
					p = n * w, p = gl(this, a, p), q.a(r, f, p, h, g), k += n;
				w = 0;
				for (k = e[2]; k > m[2];) ++w, p = n * w, p = gl(this, a, p), q.a(r, f, p, h, g), k -= n;
				p = gl(this, a, 0)
			}
			zk(r, h, c / 2, v / 2);
	...
	on.prototype.D = function() { Ni(this) };
	on.prototype.l = function(a) {
		function c(a) {
			...
			if (c) {
				if (c) { e = !1;
					if (fa(c))
						for (var f = 0, g = c.length; f < g; ++f) e = El(r, a, c[f], Dl(n, p), this.D, this) || e;
					else e = El(r, a, c, Dl(n, p), this.D, this) || e;
					a = e } else a = !1;
				this.j = this.j || a } }
		var d = this.a,
			e = d.da();
		...
		if (!this.j && this.B == n && this.J == g && this.T == h && Gc(this.A, m)) return !0;
		Db(this.i);
		this.i = null;
		this.j = !1;
		...
		if (h) {
			var t = [];
			e.ub(m, function(a) { t.push(a) }, this);
			t.sort(h);
			t.forEach(c, this) } else e.ub(m, c, this);
		yl(r);
		this.B = n;
		this.J = g;
		this.T = h;
	...
	function pn(a, c) {
		...
		return function(h) {
			if (h) return a.replace(d, h[0].toString()).replace(e, h[1].toString()).replace(f, function() {
				return (-h[2] - 1).toString() }).replace(g, function() {
				var a = c.b ? c.b[h[0]] : null;
				return (a.Aa - a.xa + 1 + h[2]).toString() }) } }

	function qn(a, c) {
		for (var d = a.length, e = Array(d), f = 0; f < d; ++f) e[f] = pn(a[f], c);
		return rn(e) }

	function rn(a) {
		return 1 === a.length ? a[0] : function(c, d, e) {
			if (c) return a[$b((c[1] << c[0]) + c[2], a.length)](c, d, e) } }
	...
	function tn(a) {
		...
		if (d) {
			var e = d[2].charCodeAt(0),
				f;
			for (f = d[1].charCodeAt(0); f <= e; ++f) c.push(a.replace(d[0], String.fromCharCode(f))) } else c.push(a);
		return c };

	function un(a) { Ig.call(this, { attributions: a.attributions, Re: a.Re, extent: a.extent, logo: a.logo, opaque: a.opaque, projection: a.projection, state: a.state, tileGrid: a.tileGrid, tilePixelRatio: a.tilePixelRatio, wrapX: a.wrapX });
	...
	function wn(a, c) { a.Th(Pm(c, a.j)) };

	function xn(a) { dl.call(this, a);
		this.s = nh();
		this.i = !1;
		this.A = [];
		this.T = yc();
	...
	xn.prototype.c = function(a, c, d) {
		...
		c = this.A;
		var z = r.tileGrid,
			C, A, B, L, J, M, P, Aa, I, ca, Da, Ia, ab;
		B = 0;
		for (L = c.length; B < L; ++B)
			if (ca = c[B], J = ca.c, Aa = z.Da(ca.ja, this.T),
				C = ca.ja[0], Ia = Sb(z.Ua(C), this.J), I = "tile-pixels" == ca.g.a, M = z.Z(C), Da = M / t, A = M / m, M = Math.round(e * n[0] / 2), P = Math.round(e * n[1] / 2), ab = Ia[0] * e * A, A *= Ia[1] * e, Ia = Ia[0] * e, ab < Ia / 4 || ab > 4 * Ia) I ? (Aa = Sc(Aa), Da = Ji(this.j, M, P, p * Da, p * Da, g, (Aa[0] - h[0]) / Da, (h[1] - Aa[1]) / Da)) : Da = v, J.Vc.a(q, e, Da, g, f);
			else {
				C = Kg(r, C, e, k);
				I ? Da = Ji(this.j, 0, 0, p * Da, p * Da, g, -C[0] / 2, -C[1] / 2) : (Da = Yc(Aa), Da = Ji(this.j, 0, 0, p, -p, -g, -Da[0], -Da[1]));
				ca = ca.o;
				if (J.resolution !== m || J.rotation !== g) J.resolution = m, J.rotation = g, ca.canvas.width = ab + .5, ca.canvas.height =
					A + .5, ca.translate(ab / 2, A / 2), ca.rotate(-g), J.Vc.a(ca, e, Da, g, f, !1);
	...
	function yn(a, c, d, e, f) {
		function g(a) {
			...
			if (c) { fa(c) || (c = [c]);
				...
				if (c) {
					var g = !1;
					if (fa(c))
						for (var h = 0, k = c.length; h < k; ++h) g = El(f, a, c[h], e, this.B, this) || g;
					else g = El(f, a, c, e, this.B, this) || g;
					a = g } else a = !1;
				this.i = this.i || a;
				m.kd = m.kd || a } }
		var h = d.g,
		...
		if (m.kd || m.Kh != h || m.Kf != k) {
			...
			var n = d.da(),
				...
				t = "tile-pixels" == r.a,
				v, w;
			t ? (v = Kg(n, q[0], e, c.g), v = [0, 0, v[0], v[1]]) : (v = p.Da(q), Hd(f, r) || (w = !0,
				c.g = f));
			var z = p.Z(q[0]),
				n = t ? n.uc(e) : z;
			m.kd = !1;
			...
			k && k !== m.Kf && c.sort(k);
			n = 0;
			for (p = c.length; n < p; ++n) e = c[n], w && e.X().fb(r, f), g.call(a, e);
			yl(C);
			m.Kh = h;
			m.Kf = k;
			m.Vc = C;
	...
	xn.prototype.gb = function(a, c, d, e) {
		...
		var h = this.a,
			...
			q, r, t, v, w, z;
		t = 0;
		for (v = m.length; t < v; ++t) z = m[t], r = z.ja, w = n.tileGrid.Da(r, this.T), Dc(w, a) && ("tile-pixels" === z.g.a ? (w = Sc(w), g = n.uc(f), r = p.Z(r[0]) / g, r = [(a[0] - w[0]) / r, (w[1] - a[1]) / r]) : r = a, z = z.c.Vc, q = q || z.f(r, g, c, {}, function(a) {
			var c = x(a).toString();
			if (!(c in k)) return k[c] = !0, d.call(e, a, h) }));
		return q };
	xn.prototype.B = function() { Ni(this) };
	xn.prototype.l = function(a, c) {
		...
		if (Vc(h)) return !1;
		for (var g = a.viewState, f = g.projection, k = g.resolution, g = a.pixelRatio, m = e.tileGrid, n = m.Pb(), p = n.length - 1; 0 < p && n[p] < k;) --p;
		n = yg(m, h, p);
		...
		for (z = n.ra; z <=
			n.va; ++z)
			for (C = n.xa; C <= n.Aa; ++C) k = e.Qb(p, z, C, g, f), w = k.V(), 2 == w || 4 == w || 3 == w && !r ? h[p][k.ja.toString()] = k : (w = xg(m, k.ja, q, v, t), w || (k = zg(m, k.ja, v, t)) && q(p + 1, k));
		this.i = !1;
		e = Object.keys(h).map(Number);
		e.sort(Ua);
		for (var m = [], A, p = 0, n = e.length; p < n; ++p)
			for (A in k = e[p], q = h[k], q) k = q[A], 2 == k.V() && (m.push(k), yn(this, k, d, g, f));
		this.A = m;
		return !0
	};

	function zn(a, c) { $i.call(this, 0, c);
		this.a = nh();
		this.j = nh();
	...
	zn.prototype.Ce = function(a) {
		if (a) {
			...
			if (g) { c = this.j;
				...
				this.c.width = d + .5;
				this.c.height = k + .5;
				this.j.translate(Math.round((d - e) / 2), Math.round((k - f) / 2)) } else c = this.a;
			aj(a);
			...
			var k = a.viewState.resolution,
				m, n, p, q;
			m = 0;
			for (n = d.length; m < n; ++m) q = d[m], p = q.layer, p = cj(this, p), Gi(q, k) && "ready" == q.H && p.l(a, q) &&
				p.c(a, q, c);
		...
		} else this.f && (bg(this.b, !1), this.f = !1)
	};

	function Bn(a, c) { Mi.call(this, a);
		this.target = c }
	y(Bn, Mi);
	Bn.prototype.i = ua;
	Bn.prototype.o = ua;
	...
	Cn.prototype.gb = function(a, c, d, e) {
		...
		return f.da().ne(a, c.viewState.resolution, c.viewState.rotation, c.skippedFeatureUids, function(a) {
			return d.call(e, a, f) }) };
	Cn.prototype.i = function() { Hf(this.target);
		this.f = null };
	Cn.prototype.j = function(a, c) {
		...
		h && (m = h.G(), n = h.Z(), d = nc(), Ji(d, a.size[0] / 2, a.size[1] / 2, n / f, n / f, g, (m[0] - e[0]) / n, (e[1] - m[3]) / n), h != this.f && (e = h.a(this), e.style.maxWidth = "none", e.style.position = "absolute", Hf(this.target), this.target.appendChild(e), this.f = h), Ki(d, this.c) || (rh(this.target,
			d), qc(this.c, d)), Qi(a.attributions, h.ea()), Ri(a, k));
		return !0
	};
	...
	function Dn(a) {
		...
		this.f = {} }
	y(Dn, Bn);
	Dn.prototype.i = function() { Hf(this.target);
		this.l = 0 };
	Dn.prototype.j = function(a, c) {
		if (!c.visible) return this.c && (bg(this.target, !1), this.c = !1), !0;
		var d = a.pixelRatio,
			e = a.viewState,
			f = e.projection,
			g = this.a,
		...
		var v = this.cd(h, f, t),
			...
			A, B, L, J;
		for (L = p.ra; L <= p.va; ++L)
			for (J = p.xa; J <= p.Aa; ++J) A = h.Qb(n, L, J, d, f), B = A.V(), B = 2 ==
				B || 4 == B || 3 == B && !w, !B && A.a && (A = A.a), B = A.V(), 2 == B ? t[n][A.ja.toString()] = A : 4 == B || 3 == B && !w || (B = xg(k, A.ja, v, C, z), B || (A = zg(k, A.ja, C, z)) && v(n + 1, A));
		var M;
		if (this.l != h.g) {
			for (M in this.f) w = this.f[+M], Jf(w.target);
			this.f = {};
			this.l = h.g }
		...
		for (z = m.length; P < z; ++P)
			if (M = m[P], w = this.f[M], M in t)
				if (A = w.Z(), J = w.Ha(), Ji(L, a.size[0] / 2, a.size[1] / 2, A / e.resolution, A / e.resolution, e.rotation, (J[0] - q[0]) / A, (q[1] - J[1]) / A), w.setTransform(L), M in v) {
					for (--M; 0 <= M; --M)
						if (M in this.f) { J = this.f[M].target;
							J.parentNode && J.parentNode.insertBefore(w.target, J.nextSibling);
							break }
					0 > M && If(this.target, w.target, 0) } else {
					if (!a.viewHints[0] && !a.viewHints[1]) {
						B =
							yg(w.c, r, w.g[0], C);
						M = [];
						A = J = void 0;
						for (A in w.a) J = w.a[A], B.contains(J.ja) || M.push(J);
						Aa = B = void 0;
						B = 0;
						for (Aa = M.length; B < Aa; ++B) J = M[B], A = J.ja.toString(), Jf(J.cb(w)), delete w.a[A]
					}
				}
		else Jf(w.target), delete this.f[M];
	...
	function En(a, c) { this.target = document.createElement("DIV");
	...
	En.prototype.Z = function() {
		return this.j };
	En.prototype.setTransform = function(a) { Ki(a, this.f) || (rh(this.target, a), qc(this.f, a)) };

	function Fn(a) { this.l = nh();
		var c = this.l.canvas;
	...
	Fn.prototype.gb = function(a, c, d, e) {
		if (this.f) {
			...
			return this.f.f(a, c.viewState.resolution, c.viewState.rotation, {}, function(a) {
				var c = x(a).toString();
				if (!(c in g)) return g[c] = !0, d.call(e, a, f) }) } };
	Fn.prototype.J = function() { Ni(this) };
	Fn.prototype.j = function(a) {
		function c(a) {
			...
			if (c) {
				if (c) { e = !1;
					if (fa(c))
						for (var f = 0, g = c.length; f < g; ++f) e = El(p, a, c[f], Dl(m, n), this.J, this) || e;
					else e = El(p, a, c, Dl(m, n), this.J, this) || e;
					a = e } else a = !1;
				this.c = this.c || a } }
		var d = this.a,
			e = d.da();
		...
		void 0 ===
			h && (h = Cl);
		g = Ac(g, k * m);
		if (!this.c && this.T == m && this.B == a && this.A == h && Gc(this.s, g)) return !0;
		Db(this.f);
		this.f = null;
		this.c = !1;
		...
		if (h) {
			var q = [];
			e.ub(g, function(a) { q.push(a) }, this);
			q.sort(h);
			q.forEach(c, this) } else e.ub(g, c, this);
		yl(p);
		this.T = m;
		this.B = a;
		this.A = h;
	...
	function Hn(a, c) { $i.call(this, 0, c);
		this.f = nh();
		var d = this.f.canvas;
		...
		this.a = !0 }
	y(Hn, $i);
	Hn.prototype.fa = function() { Jf(this.b);
		Hn.ha.fa.call(this) };
	Hn.prototype.Ve = function(a) {
		if (a instanceof vk) a = new Cn(a);
		else if (a instanceof G) a = new Dn(a);
		else if (a instanceof H) a = new Fn(a);
		else return null;
		return a };
	...
	Hn.prototype.Ce = function(a) {
		if (a) {
			...
			var d = a.viewState.resolution,
				e, f, g, h;
			e = 0;
			for (f = c.length; e < f; ++e) h = c[e], g = h.layer, g = cj(this, g), If(this.b, g.target, e), Gi(h, d) && "ready" == h.H ? g.j(a, h) && g.o(a, h) : g.i();
			var c = a.layerStates,
				k;
			for (k in this.g) k in c || (g = this.g[k], Jf(g.target));
		...
		} else this.a && (bg(this.b, !1), this.a = !1)
	};
	...
	function Mn() { this.b = "precision mediump float;varying vec2 a;varying float b;uniform float k;uniform sampler2D l;void main(void){vec4 texColor=texture2D(l,a);gl_FragColor.rgb=texColor.rgb;float alpha=texColor.a*b*k;if(alpha==0.0){discard;}gl_FragColor.a=alpha;}" }
	y(Mn, Kn);
	da(Mn);
	...
	function On(a, c) { this.l = a.getUniformLocation(c, "j");
	...
	function Pn(a) { this.b = void 0 !== a ? a : [] };

	function Qn(a, c) { this.A = a;
		this.a = c;
		this.g = {};
		this.i = {};
		this.c = {};
	...
	function Rn(a, c, d) {
		var e = a.a,
			f = d.b,
			g = String(x(d));
		if (g in a.g) e.bindBuffer(c, a.g[g].buffer);
		else {
	...
	l.fa = function() {
		var a = this.a;
		if (!a.isContextLost()) {
			for (var c in this.g) a.deleteBuffer(this.g[c].buffer);
			for (c in this.c) a.deleteProgram(this.c[c]);
			for (c in this.i) a.deleteShader(this.i[c]);
	...
	function Zn(a, c) { this.J = this.B = void 0;
		this.o = Yc(c);
		this.T = [];
		this.i = [];
		this.H = void 0;
	...
	function ao(a, c, d, e) {
		var f = a.B,
			...
			A = a.b.length,
			B, L, J, M, P, Aa;
		for (B = 0; B < d; B += e) P = c[B] - a.o[0], Aa = c[B + 1] - a.o[1], L = A / 8, J = -v * f, M = -v * (h - g), a.b[A++] = P, a.b[A++] = Aa, a.b[A++] = J * z - M * t, a.b[A++] = J * t + M * z, a.b[A++] = p / m, a.b[A++] = (q + h) / k, a.b[A++] = n, a.b[A++] = r, J = v * (w - f), M = -v * (h - g), a.b[A++] = P, a.b[A++] = Aa, a.b[A++] = J * z - M * t, a.b[A++] = J * t + M * z, a.b[A++] = (p + w) / m, a.b[A++] = (q + h) / k, a.b[A++] = n, a.b[A++] = r, J = v * (w - f), M =
			v * g, a.b[A++] = P, a.b[A++] = Aa, a.b[A++] = J * z - M * t, a.b[A++] = J * t + M * z, a.b[A++] = (p + w) / m, a.b[A++] = q / k, a.b[A++] = n, a.b[A++] = r, J = -v * f, M = v * g, a.b[A++] = P, a.b[A++] = Aa, a.b[A++] = J * z - M * t, a.b[A++] = J * t + M * z, a.b[A++] = p / m, a.b[A++] = q / k, a.b[A++] = n, a.b[A++] = r, a.a[C++] = L, a.a[C++] = L + 1, a.a[C++] = L + 2, a.a[C++] = L, a.a[C++] = L + 2, a.a[C++] = L + 3
	}
	Zn.prototype.Hb = function(a, c) { this.g.push(this.a.length);
		this.s.push(c);
		var d = a.ga();
		ao(this, d, d.length, a.qa()) };
	Zn.prototype.Ib = function(a, c) { this.g.push(this.a.length);
		this.s.push(c);
		var d = a.ga();
		ao(this, d, d.length, a.qa()) };
	...
	function co(a, c, d, e) {
		...
		for (h = 0; h < k; ++h) f = c[h], g = x(f).toString(), g in d ? f = d[g] : (f = Yn(e, f), d[g] = f), a[h] = f }
	...
	function eo(a, c, d, e, f, g, h, k, m, n, p) {
		...
		q.uniform1f(r.i, h);
		var v;
		if (void 0 === m) fo(a, q, c, k, a.oa, a.T);
		else {
			if (n) a: {
				f = c.f ? 5125 : 5123;c = c.f ? 4 : 2;g = a.g.length - 1;
				for (h = a.j.length - 1; 0 <= h; --h)
					for (q.bindTexture(3553, a.j[h]), n = 0 < h ? a.i[h - 1] : 0, t = a.i[h]; 0 <= g && a.g[g] >= n;) {
						v = a.g[g];
						d = a.s[g];
						e = x(d).toString();
						if (void 0 === k[e] && d.X() && (void 0 === p || ad(p, d.X().G())) && (q.clear(q.COLOR_BUFFER_BIT | q.DEPTH_BUFFER_BIT), q.drawElements(4, t - v, f, v * c), t = m(d))) { a = t;
							break a }
						t = v;
						g--
					}
			...
			else q.clear(q.COLOR_BUFFER_BIT | q.DEPTH_BUFFER_BIT), fo(a, q, c, k, a.j, a.i), a = (a = m(null)) ? a : void 0;
			v = a
		}
	...
	function fo(a, c, d, e, f, g) {
		...
		if (pb(e)) {
			...
			a = 0;
			e = f.length;
			for (k = 0; a < e; ++a) { c.bindTexture(3553, f[a]);
				var m = g[a];
				c.drawElements(4, m - k, h, k * d);
				k = m } } else { k = 0;
			var n, m = 0;
			for (n = f.length; m < n; ++m) { c.bindTexture(3553, f[m]);
	...
	function ho(a, c) {
		var d = [],
			e;
		for (e in a.g) d.push($n(a.g[e], c));
		return id.apply(null, d) }

	function io(a, c) {
		for (var d in a.g) bo(a.g[d], c) }
	...
	go.prototype.a = function(a, c, d, e, f, g, h, k) {
		var m, n;
		g = 0;
		for (m = hl.length; g < m; ++g) n = this.g[hl[g]], void 0 !== n && eo(n, a, c, d, e, f, h, k, void 0, !1) };

	function ko(a, c, d, e, f, g, h, k, m, n) {
		var p = lo,
			q, r;
		for (q = hl.length - 1; 0 <= q; --q)
			if (r = a.g[hl[q]], void 0 !== r && (r = eo(r, c, d, e, f, p, g, h, k, m, n))) return r }
	...
	function no(a, c, d, e, f, g) { this.a = a;
		this.c = c;
		this.f = g;
		this.l = f;
		this.j = e;
	...
	l.Jb = function() {};
	l.hb = function() {};
	l.yb = function(a) { this.g = a };
	l.ib = function() {};
	var oo = { Point: no.prototype.Ib, MultiPoint: no.prototype.Hb, GeometryCollection: no.prototype.Sd };

	function po() { this.b = "precision mediump float;varying vec2 a;uniform float f;uniform sampler2D g;void main(void){vec4 texColor=texture2D(g,a);gl_FragColor.rgb=texColor.rgb;gl_FragColor.a=texColor.a*f;}" }
	y(po, Kn);
	da(po);

	function qo() { this.b = "varying vec2 a;attribute vec2 b;attribute vec2 c;uniform mat4 d;uniform mat4 e;void main(void){gl_Position=e*vec4(b,0.,1.);a=(d*vec4(c,0.,1.)).st;}" }
	y(qo, Ln);
	da(qo);

	function ro(a, c) { this.g = a.getUniformLocation(c, "f");
	...
	function so(a, c) { Mi.call(this, c);
		this.f = a;
	...
	function to(a, c, d) {
		var e = a.f.f;
		if (void 0 === a.j || a.j != d) { c.postRenderFunctions.push(qa(function(a, c, d) { a.isContextLost() || (a.deleteFramebuffer(c), a.deleteTexture(d)) }, e, a.i, a.pb));
			c = Un(e, d, d);
			...
			a.pb = c;
			a.i = f;
			a.j = d } else e.bindFramebuffer(36160, a.i) }
	so.prototype.ih = function(a, c, d) { uo(this, "precompose", d, a);
		Rn(d, 34962, this.S);
		var e = d.a,
			f = po.Zb(),
			g = qo.Zb(),
	...
	function uo(a, c, d, e) { a = a.a;
		if (Ib(a, c)) {
			var f = e.viewState;
			a.b(new Ei(c, a, new no(d, f.center, f.resolution, f.rotation, e.size, e.extent), e, null, d)) } }
	so.prototype.rf = function() { this.i = this.pb = null;
		this.j = void 0 };

	function vo(a, c) { so.call(this, a, c);
	...
	vo.prototype.sf = function(a, c) {
		var d = this.f.f,
			...
			r = a.extent;
		void 0 !== c.extent && (r = $c(r, c.extent));
		q[0] || q[1] || Vc(r) || (f = p.B(r, h, e, f.projection)) && Oi(this, f) && (m = f, n = wo(this, f), this.pb && a.postRenderFunctions.push(qa(function(a, c) { a.isContextLost() || a.deleteTexture(c) }, d, this.pb)));
		m && (d = this.f.c.A, xo(this, d.width, d.height, e, g, h, k, m.G()), this.o = null, e = this.s, rc(e), vc(e, 1, -1), uc(e, 0, -1), this.c =
			m, this.pb = n, Qi(a.attributions, m.ea()), Ri(a, p));
		return !0
	};

	function xo(a, c, d, e, f, g, h, k) { c *= g;
		d *= g;
		a = a.T;
		rc(a);
		vc(a, 2 * e / c, 2 * e / d);
	...
	vo.prototype.yc = function(a, c, d, e) {
		if (this.c && this.c.a())
			if (this.a.da() instanceof kn) {
				if (a = a.slice(), Li(c.pixelToCoordinateMatrix, a, a), this.gb(a, c, fd, this)) return d.call(e, this.a) } else {
				...
				Li(this.o, a, c);
				if (!(0 > c[0] || c[0] > f[0] || 0 >
						c[1] || c[1] > f[1]) && (this.l || (this.l = nh(1, 1)), this.l.clearRect(0, 0, 1, 1), this.l.drawImage(this.c.a(), c[0], c[1], 1, 1, 0, 0, 1, 1), 0 < this.l.getImageData(0, 0, 1, 1).data[3])) return d.call(e, this.a)
			}
	};

	function yo() { this.b = "precision mediump float;varying vec2 a;uniform sampler2D e;void main(void){gl_FragColor=texture2D(e,a);}" }
	y(yo, Kn);
	da(yo);

	function zo() { this.b = "varying vec2 a;attribute vec2 b;attribute vec2 c;uniform vec4 d;void main(void){gl_Position=vec4(b*d.xy+d.zw,0.,1.);a=c;}" }
	y(zo, Ln);
	da(zo);

	function Ao(a, c) { this.g = a.getUniformLocation(c, "e");
		this.f = a.getUniformLocation(c, "d");
		this.b = a.getAttribLocation(c, "b");
		this.a = a.getAttribLocation(c, "c") };

	function Bo(a, c) { so.call(this, a, c);
		this.D = yo.Zb();
		this.U = zo.Zb();
		this.c = null;
	...
	y(Bo, so);
	l = Bo.prototype;
	l.fa = function() { Sn(this.f.c, this.J);
		Bo.ha.fa.call(this) };
	l.cd = function(a, c, d) {
		var e = this.f;
		return function(f, g) {
			return Jg(a, c, f, g, function(a) {
				...
				return c }) } };
	l.rf = function() { Bo.ha.rf.call(this);
		this.c = null };
	l.sf = function(a, c, d) {
		var e = this.f,
			f = d.a,
		...
		q = Ag(n, C, q);
		if (this.l && Oe(this.l, q) && this.o == m.g) v = this.B;
		else {
			...
			for (ca = q.ra; ca <= q.va; ++ca)
				for (Da = q.xa; Da <= q.Aa; ++Da) {
					L =
						m.Qb(p, ca, Da, t, h);
					if (void 0 !== c.extent && (I = n.Da(L.ja, J), !ad(I, c.extent))) continue;
					I = L.V();
					I = 2 == I || 4 == I || 3 == I && !P;
					!I && L.a && (L = L.a);
					I = L.V();
					if (2 == I) {
						if (lg(e.a, L.eb())) { d[p][L.ja.toString()] = L;
							continue } } else if (4 == I || 3 == I && !P) continue;
					B = !1;
					I = xg(n, L.ja, M, Aa, J);
			...
			c.sort(Ua);
			for (var M = new Float32Array(4), Ia, ab, Pa, P = 0, Aa = c.length; P < Aa; ++P)
				for (Ia in ab = d[c[P]], ab) L = ab[Ia], I = n.Da(L.ja, J), ca = 2 * (I[2] - I[0]) / A, Da = 2 * (I[3] - I[1]) / A, Pa = 2 * (I[0] - v[0]) / A - 1,
					I = 2 * (I[1] - v[1]) / A - 1, mc(M, ca, Da, Pa, I), f.uniform4fv(this.c.f, M), Co(e, L, r, w * t), f.drawArrays(5, 0, 4);
		...
		Ui(a, m, n, t, h, C, p, k.a(), function(a) {
			...
			c || Ec.f([a, Cg(n, a.ja), n.Z(a.ja[0]), r, w * t]) }, this);
		Pi(a, m);
		Ri(a, m);
		f = this.s;
		rc(f);
		...
		vc(f, a.size[0] * g.resolution / (v[2] - v[0]),
	...
	function Do(a, c) { so.call(this, a, c);
		this.o = !1;
		this.H = -1;
		this.D = NaN;
		this.B = yc();
	...
	l.yc = function(a, c, d, e) { a = a.slice();
		Li(c.pixelToCoordinateMatrix, a, a);
		if (this.me(a, c)) return d.call(e, this.a) };
	l.jh = function() { Ni(this) };
	l.sf = function(a, c, d) {
		function e(a) {
			var c, d = a.bc();
			...
			if (c) {
				if (c) { d = !1;
					if (fa(c))
						for (var e = 0, g = c.length; e < g; ++e) d = El(r, a, c[e], Dl(n, p), this.jh, this) || d;
					else d = El(r, a, c, Dl(n, p), this.jh, this) || d;
					a = d } else a = !1;
				this.o = this.o || a } }
		var f = this.a;
		c = f.da();
		...
		void 0 === m &&
			(m = Cl);
		h = Ac(h, q * n);
		if (!this.o && this.D == n && this.H == k && this.J == m && Gc(this.B, h)) return !0;
		...
		if (m) {
			var t = [];
			c.ub(h, function(a) { t.push(a) }, this);
			t.sort(m);
			t.forEach(e, this) } else c.ub(h, e, this);
		io(r, d);
		this.D = n;
		this.H = k;
		this.J = m;
	...
	function Eo(a, c) {
		...
		this.J = nh();
		this.o = !0;
		this.f = th(this.b, { antialias: !0, depth: !1, failIfMajorPerformanceCaveat: !0, preserveDrawingBuffer: !1, stencil: !0 });
	...
	function Co(a, c, d, e) {
		var f = a.f,
			g = c.eb();
		if (lg(a.a, g)) a = a.a.get(g), f.bindTexture(3553, a.pb), 9729 != a.Mg && (f.texParameteri(3553, 10240, 9729), a.Mg = 9729), 9729 != a.Ng && (f.texParameteri(3553, 10240, 9729), a.Ng = 9729);
		else {
			...
			if (0 < e) {
				...
				f.texImage2D(3553, 0, 6408, 6408, 5121, k) } else f.texImage2D(3553, 0, 6408, 6408,
				5121, c.cb());
			...
			a.a.set(g, { pb: h, Mg: 9729, Ng: 9729 })
		}
	}
	l = Eo.prototype;
	l.Ve = function(a) {
	...
	function Go(a, c, d) {
		...
		if (Ib(e, c)) {
			...
			d = 0;
			for (e = c.length; d < e; ++d)
				for (f = a.b[c[d].toString()], g = 0, h = f.length; g < h; ++g) f[g](a) } }
	l.fa = function() {
		var a = this.f;
		a.isContextLost() || this.a.forEach(function(c) { c && a.deleteTexture(c.pb) });
		Db(this.c);
		Eo.ha.fa.call(this) };
	l.mj = function(a, c) {
		for (var d = this.f, e; 1024 < this.a.rc() - this.j;) {
			if (e = this.a.b.mc) d.deleteTexture(e.pb);
			else if (+this.a.b.de == c.index) break;
			else --this.j;
			this.a.pop() } };
	l.W = function() {
		return "webgl" };
	l.qm = function(a) { a.preventDefault();
		this.a.clear();
		this.j = 0;
		a = this.g;
		for (var c in a) a[c].rf() };
	l.rm = function() { Fo(this);
		this.i.render() };
	...
	l.Ce = function(a) {
		...
		if (!a) return this.o && (bg(this.b, !1), this.o = !1), !1;
		this.A = a.focus;
		...
		var g = a.viewState.resolution,
			h, k, m, n;
		h = 0;
		for (k = f.length; h < k; ++h) n = f[h], Gi(n, g) && "ready" == n.H && (m = cj(this, n.layer), m.sf(a, n, c) && e.push(n));
		...
		h = 0;
		for (k = e.length; h < k; ++h) n = e[h], m = cj(this, n.layer), m.ih(a, n, c);
	...
	l.qf = function(a, c, d, e, f, g) {
		...
		for (n = m.length - 1; 0 <= n; --n) { h = m[n];
			var p = h.layer;
			if (Gi(h, k.resolution) && f.call(g, p) && (h = cj(this, p).gb(a, c, d, e))) return h } };
	l.hh = function(a, c, d, e) {
		var f = !1;
		if (this.f.isContextLost()) return !1;
		var g = c.viewState,
		...
		for (k = h.length - 1; 0 <= k; --k) {
			var m = h[k],
				n = m.layer;
			if (Gi(m, g.resolution) && d.call(e, n) && (f = cj(this, n).me(a, c))) return !0 }
		return f };
	l.gh = function(a, c, d, e, f) {
		...
		var g = c.viewState,
			...
			m;
		for (m = k.length - 1; 0 <= m; --m) { h = k[m];
			var n = h.layer;
			if (Gi(h, g.resolution) && f.call(e, n) && (h = cj(this, n).yc(a, c, d, e))) return h } };
	...
	function S(a) {
		...
		this.Ec = c.logos;
		this.Ca = function() { this.i = void 0;
			this.lo.call(this, Date.now()) }.bind(this);
		this.qb = nc();
		this.Me = nc();
		this.Fb = 0;
		this.f = null;
		...
		for (var d = 0, e = a.length; d < e; ++d) D(this.A, a[d], Fb);
		this.a.appendChild(this.A);
		a = new pi(this);
		for (var f in Ai) D(a, Ai[f], this.Fg, this);
		Cb(this, qa(Db, a));
		...
		D(this,
			Ob("size"), this.Ik, this);
		D(this, Ob("target"), this.Kk, this);
		this.C(c.values);
		this.l.forEach(function(a) { a.setMap(this) }, this);
		D(this.l, "add", function(a) { a.element.setMap(this) }, this);
		D(this.l, "remove", function(a) { a.element.setMap(null) }, this);
		this.j.forEach(function(a) { a.setMap(this) }, this);
		D(this.j, "add", function(a) { a.element.setMap(this) }, this);
		D(this.j, "remove", function(a) { a.element.setMap(null) }, this);
		this.o.forEach(this.cg, this);
		D(this.o, "add", function(a) { this.cg(a.element) }, this);
		D(this.o, "remove",
			function(a) {
				var c = a.element.Sa();
	...
	y(S, Mb);
	l = S.prototype;
	l.bj = function(a) { this.l.push(a) };
	l.cj = function(a) { this.j.push(a) };
	l.ag = function(a) { this.sc().Sc().push(a) };
	l.bg = function(a) { this.o.push(a) };
	l.cg = function(a) {
		var c = a.Sa();
		void 0 !== c && (this.tf[c.toString()] = a);
		a.setMap(this) };
	l.Ra = function(a) { this.render();
		Array.prototype.push.apply(this.H, arguments) };
	l.fa = function() { yb(this.a, "wheel", this.Nc, this);
	...
	l.od = function(a, c, d, e, f) {
		if (this.f) return a = this.La(a), this.J.qf(a, this.f, c, void 0 !== d ? d : null, void 0 !== e ? e : fd, void 0 !== f ? f : null) };
	l.vl = function(a, c, d, e, f) {
		if (this.f) return this.J.gh(a, this.f, c, void 0 !== d ? d : null, void 0 !== e ? e : fd, void 0 !== f ? f : null) };
	l.Ok = function(a, c, d) {
		if (!this.f) return !1;
		a = this.La(a);
	...
	l.Tj = function() {
		return this.o };
	l.Sj = function(a) { a = this.tf[a.toString()];
		return void 0 !== a ? a : null };
	l.Gj = function() {
		return this.j };
	l.sc = function() {
	...
	l.Kk = function() {
		...
		this.Xc() };
	l.Lk = function() { this.render() };
	l.Nk = function() { this.render() };
	l.Mk = function() { this.S && (sb(this.S), this.S = null);
		var a = this.$();
		a && (this.S = D(a, "propertychange", this.Nk, this));
		this.render() };
	l.sk = function() { this.render() };
	l.tk = function() { this.render() };
	l.rk = function() { this.D && (this.D.forEach(sb), this.D = null);
		var a = this.sc();
		a && (this.D = [D(a, "propertychange", this.tk, this), D(a, "change", this.sk, this)]);
		this.render() };
	l.mo = function() { this.i && aa.cancelAnimationFrame(this.i);
		this.Ca() };
	l.render = function() { void 0 === this.i && (this.i = aa.requestAnimationFrame(this.Ca)) };
	l.eo = function(a) {
	...
	l.Sh = function(a) { this.set("layergroup", a) };
	l.Mf = function(a) { this.set("size", a) };
	l.wl = function(a) { this.set("target", a) };
	l.Ao = function(a) { this.set("view", a) };
	l.ai = function(a) { a = x(a).toString();
		this.aa[a] = !0;
		this.render() };
	l.Xc = function() {
		var a = this.tc();
		if (a) {
			...
			this.Mf([a.width, a.height]) } else this.Mf(void 0) };
	l.ci = function(a) { a = x(a).toString();
		delete this.aa[a];
		this.render() };
	...
	function Io(a) {
		...
		if (void 0 === a.logo || "boolean" === typeof a.logo && a.logo) e["data:image/png;base64,"] =
			...
			var f = a.logo; "string" === typeof f ? e[f] = "" : ka(f) && (e[f.src] = f.href) }
		...
		for (k = g.length; h < k; ++h) {
			...
			if ("canvas" == m) {
				if (Bh) { f = zn;
					break } } else if ("dom" == m) { f = Hn;
				break } else if ("webgl" == m && uh) { f = Eo;
				break } }
		var n;
		void 0 !== a.controls ?
			n = fa(a.controls) ? new Se(a.controls.slice()) : a.controls : n = Tg();
		var p;
		...
		return { controls: n, interactions: p, keyboardEventTarget: c, logos: e, overlays: a, no: f, values: d }
	}
	uk();
		...
		if (void 0 !== this.get("position") && this.autoPan) {
			...
			if (void 0 !== a && a.tc()) {
				var c = Lo(a.tc(), a.Va()),
					...
					h = Lo(d, [e, f]),
					d = this.j;
				Gc(c, h) || (e = h[0] - c[0], f = c[2] - h[2], g = h[1] - c[1], h = c[3] - h[3], c = [0, 0], 0 > e ? c[0] = e - d : 0 > f && (c[0] =
					Math.abs(f) + d), 0 > g ? c[1] = g - d : 0 > h && (c[1] = Math.abs(h) + d), 0 === c[0] && 0 === c[1]) || (d = a.$().Wa(), e = a.Ta(d), c = [e[0] + c[0], e[1] + c[1]], this.i && (this.i.source = d, a.Ra(He(this.i))), a.$().mb(a.La(c)))
			}
		}
	};
	l.Fk = function() { Ko(this) };
	l.Oh = function(a) { this.set("element", a) };
	l.setMap = function(a) { this.set("map", a) };
	l.Uh = function(a) { this.set("offset", a) };
	l.mf = function(a) { this.set("position", a) };
	...
	l.Xh = function(a) { this.set("positioning", a) };

	function Mo(a, c) { a.a.visible !== c && (bg(a.f, c), a.a.visible = c) }
	...
	function Ko(a) {
		...
		if (void 0 !== c && c.f && void 0 !== d) {
			var d = c.Ta(d),
				...
				h = f[0],
				f = f[1];
			if ("bottom-right" == g || "center-right" == g || "top-right" == g) "" !== a.a.ee && (a.a.ee = c.left = ""), h = Math.round(e[0] - d[0] - h) + "px", a.a.De != h && (a.a.De = c.right = h);
			else { "" !== a.a.De && (a.a.De = c.right = "");
				if ("bottom-center" == g || "center-center" == g || "top-center" == g) h -= $f(a.f).width / 2;
				h = Math.round(d[0] + h) + "px";
				a.a.ee != h && (a.a.ee = c.left = h) }
			if ("bottom-left" == g || "bottom-center" == g || "bottom-right" ==
				g) "" !== a.a.Ee && (a.a.Ee = c.top = ""), d = Math.round(e[1] - d[1] - f) + "px", a.a.Od != d && (a.a.Od = c.bottom = d);
			else { "" !== a.a.Od && (a.a.Od = c.bottom = "");
				if ("center-left" == g || "center-center" == g || "center-right" == g) f -= $f(a.f).height / 2;
	...
	function No(a) {
		...
		d = Ef("BUTTON", { type: "button", title: d }, this.l && !this.j ? this.A : this.B);
		D(d, "click", this.Hl,
			this);
		e = document.createElement("DIV");
		e.className = "ol-overviewmap-map";
		var f = this.f = new S({ controls: new Se, interactions: new Se, target: e, view: a.view });
		a.layers && a.layers.forEach(function(a) { f.ag(a) }, this);
		var g = Ef("DIV", "ol-overviewmap-box");
		this.o = new Jo({ position: [0, 0], positioning: "bottom-left", element: g });
		this.f.bg(this.o);
		c = Ef("DIV", c + " ol-unselectable ol-control" + (this.j && this.l ? " ol-collapsed" : "") + (this.l ? "" : " ol-uncollapsible"), e, d);
		jg.call(this, { element: c, render: a.render ? a.render : Oo, target: a.target })
	}
	y(No, jg);
	l = No.prototype;
	l.setMap = function(a) {
	...
	l.zk = function(a) { "view" === a.key && ((a = a.oldValue) && yb(a, Ob("rotation"), this.be, this), a = this.a.$(), D(a, Ob("rotation"), this.be, this)) };
	l.be = function() { this.f.$().je(this.a.$().Ka()) };
	...
	function Qo(a) {
		...
		if (c.f && d.f) {
			...
			var c = f.Ka(),
				...
				f = Rc(f),
				k;
			if (a = a.a.$().Wa()) k = [g[0] - a[0], g[1] - a[1]], gc(k, c), bc(k, a);
			h.mf(k);
			d && (k = new xf(Math.abs((g[0] - f[0]) / e), Math.abs((f[1] - g[1]) / e)), c = Nf(yf(Af(d))), !kf || sf("10") || c && sf("8") ? (d = d.style, mf ? d.MozBoxSizing = "border-box" : nf ? d.WebkitBoxSizing = "border-box" : d.boxSizing = "border-box", d.width = Math.max(k.width, 0) + "px", d.height = Math.max(k.height, 0) + "px") : (a = d.style, c ? (c =
				eg(d, "padding"), d = hg(d), a.pixelWidth = k.width - d.left - c.left - c.right - d.right, a.pixelHeight = k.height - d.top - c.top - c.bottom - d.bottom) : (a.pixelWidth = k.width, a.pixelHeight = k.height)))
		}
	}
	l.Hl = function(a) { a.preventDefault();
		Ro(this) };

	function Ro(a) { Sf(a.element, "ol-collapsed");
		a.j ? Kf(a.A, a.B) : Kf(a.B, a.A);
		a.j = !a.j;
		var c = a.f;
		a.j || c.f || (c.Xc(), Po(a), xb(c, "postrender", function() { Qo(this) }, a)) }
	l.Gl = function() {
		return this.l };
	l.Jl = function(a) { this.l !== a && (this.l = a, Sf(this.element, "ol-uncollapsible"), !a && this.j && Ro(this)) };
	l.Il = function(a) { this.l && this.j !== a && Ro(this) };
	l.Fl = function() {
		return this.j };
	l.Uj = function() {
		return this.f };
	...
	function So(a) { a = a ? a : {};
		...
		this.D = void 0;
		this.B = "";
		jg.call(this, { element: this.f, render: a.render ? a.render : To, target: a.target });
	...
	function To(a) {
		...
		Vo(this) }
	So.prototype.U = function() { Vo(this) };
	So.prototype.H = function(a) { this.set("units", a) };
	...
	function Vo(a) {
		...
		if (c) {
			...
			for (var f =
					3 * Math.floor(Math.log(a.o * c) / Math.log(10)), g;;) { g = Uo[(f % 3 + 3) % 3] * Math.pow(10, Math.floor(f / 3));
				e = Math.round(g / c);
				if (isNaN(e)) { bg(a.f, !1);
					a.j = !1;
					return }
	...
	function Wo(a) { a = a ? a : {};
		...
		var c = void 0 !== a.className ? a.className : "ol-zoomslider",
			d = Ef("BUTTON", { type: "button", "class": c + "-thumb ol-unselectable" }),
			c = Ef("DIV", [c, "ol-unselectable", "ol-control"], d),
			e = new hi(c);
		Cb(this, qa(Db, e));
		D(e, Sh, this.lk, this);
		...
		D(d, "click", Fb);
		jg.call(this, { element: c, render: a.render ? a.render : Yo }) }
	y(Wo, jg);
	var Xo = 0;
	l = Wo.prototype;
	l.setMap = function(a) { Wo.ha.setMap.call(this, a);
		a && a.render() };
	...
	l.kk = function(a) {
		var c = this.a,
			d = c.$(),
			e = d.Z();
		c.Ra(Je({ resolution: e, duration: this.H, easing: De }));
		a = $o(this, ap(this, a.offsetX - this.D[0] / 2, a.offsetY - this.D[1] / 2));
		d.Vb(d.constrainResolution(a)) };
	l.lk = function(a) {
		if (!this.o && a.b.target === this.element.firstElementChild && (Be(this.a.$(), 1), this.B = a.clientX, this.J = a.clientY, this.o = !0, !this.A)) { a = this.Dg;
			var c = this.Eg;
	...
	l.Eg = function() {
		if (this.o) {
			var a = this.a,
				c = a.$();
			Be(c, -1);
			a.Ra(Je({ resolution: this.f, duration: this.H, easing: De }));
	...
	function bp(a) { a = a ? a : {};
		...
		var c = void 0 !== a.className ? a.className : "ol-zoom-extent",
			d = Ef("BUTTON", { type: "button", title: void 0 !== a.tipLabel ? a.tipLabel : "Fit to extent" }, void 0 !== a.label ? a.label : "E");
		D(d, "click", this.j, this);
		c = Ef("DIV", c + " ol-unselectable ol-control", d);
		jg.call(this, { element: c, target: a.target }) }
	y(bp, jg);
	bp.prototype.j = function(a) { a.preventDefault();
		var c = this.a;
		a = c.$();
	...
	y(cp, Mb);
	l = cp.prototype;
	l.fa = function() { this.kf(!1);
		cp.ha.fa.call(this) };
	l.tn = function(a) {
		if (null !== a.alpha) {
			var c = Ra(a.alpha);
			this.set("alpha", c); "boolean" === typeof a.absolute && a.absolute ? this.set("heading", c) : ia(a.webkitCompassHeading) && -1 != a.webkitCompassAccuracy && this.set("heading", Ra(a.webkitCompassHeading)) }
	...
	l.kf = function(a) { this.set("tracking", a) };

	function dp() { this.defaultDataProjection = null }

	function ep(a, c, d) {
		var e;
		d && (e = { dataProjection: d.dataProjection ? d.dataProjection : a.Qa(c), featureProjection: d.featureProjection });
		return fp(a, e) }

	function fp(a, c) {
		var d;
		c && (d = { featureProjection: c.featureProjection, dataProjection: c.dataProjection ? c.dataProjection : a.defaultDataProjection, rightHanded: c.rightHanded });
		return d }
	...
	function jp() { this.defaultDataProjection = null }
	y(jp, dp);
	...
	function lp(a, c, d, e, f, g) {
		...
		if (0 !== m)
			...
			m = 0;
			n = h.length;
			for (p = !1; m < n;) f = m + (n - m >> 1), k = +Ua(h[f], d), 0 > k ? m = f + 1 : (n = f, p = !k);
			f = p ? m : ~m;
	...
	function mp(a, c, d, e, f, g) {
		...
		d = [];
		var h;
		for (h = 0; h < e - 1; ++h) d.push(ac(a[(c - 1) * e + h], a[c * e + h], g));
		d.push(f);
		return d }

	function np(a, c, d, e, f, g) {
		var h = 0;
		if (g) return mp(a, h, c[c.length - 1], d, e, f);
		...
		for (g = c.length; f < g; ++f) {
			...
			if (h != k) {
				if (e < a[h + d - 1]) break;
				if (e <= a[k - 1]) return mp(a, h, k, d, e, !1);
				h = k } }
		return null };

	function T(a, c) { Od.call(this);
		this.c = null;
		this.J = this.D = this.o = -1;
		this.la(a, c) }
	y(T, Od);
	l = T.prototype;
	l.dj = function(a) { this.v ? Ya(this.v, a) : this.v = a.slice();
		this.u() };
	l.clone = function() {
		var a = new T(null);
		a.ba(this.f, this.v.slice());
	...
	function Zk(a) { a.o != a.g && (a.c = a.qg(.5, a.c), a.o = a.g);
		return a.c }
	l.Mc = function(a) {
		var c = [];
		c.length = de(this.v, 0, this.v.length, this.a, a, c, 0);
	...
	l.la = function(a, c) { a ? (Rd(this, c, a, 1), this.v || (this.v = []), this.v.length = $d(this.v, 0, a, this.a), this.u()) : this.ba("XY", null) };
	l.ba = function(a, c) { Qd(this, a, c);
		this.u() };

	function U(a, c) { Od.call(this);
		this.c = [];
		this.o = this.J = -1;
		this.la(a, c) }
	y(U, Od);
	l = U.prototype;
	l.ej = function(a) { this.v ? Ya(this.v, a.ga().slice()) : this.v = a.ga().slice();
		this.c.push(this.v.length);
		this.u() };
	l.clone = function() {
		var a = new U(null);
	...
	function pp(a, c) { Od.call(this);
		this.la(a, c) }
	y(pp, Od);
	l = pp.prototype;
	l.gj = function(a) { this.v ? Ya(this.v, a.ga()) : this.v = a.ga().slice();
		this.u() };
	l.clone = function() {
		var a = new pp(null);
		a.ba(this.f, this.v.slice());
	...
	l.Ia = function(a) {
		...
		for (f = c.length; e < f; e += d)
			if (g = c[e], h = c[e + 1], Fc(a, g, h)) return !0;
		return !1 };
	l.la = function(a, c) { a ? (Rd(this, c, a, 1), this.v || (this.v = []), this.v.length = $d(this.v, 0, a, this.a), this.u()) : this.ba("XY", null) };
	l.ba = function(a, c) { Qd(this, a, c);
		this.u() };

	function V(a, c) { Od.call(this);
		this.c = [];
		this.J = -1;
		this.D = null;
		this.U = this.H = this.S = -1;
	...
	l.hj = function(a) {
		if (this.v) {
			...
			var d, e;
			d = 0;
			for (e = a.length; d < e; ++d) a[d] += c } else this.v = a.ga().slice(), a = a.Cb().slice(), this.c.push();
		this.c.push(a);
		this.u() };
	l.clone = function() {
		for (var a = new V(null), c = this.c.length, d = Array(c), e = 0; e < c; ++e) d[e] = this.c[e].slice();
	...
	function bl(a) {
		if (a.J != a.g) {
			...
			h = [];
			k = 0;
			for (m = d.length; k < m; ++k) n = d[k], h = ke(c, f, n, e, g, 2 * k, h), f = n[n.length - 1];
			a.D = h;
			a.J = a.g }
		return a.D }
	l.Ij = function() {
	...
	l.la = function(a, c) {
		if (a) { Rd(this, c, a, 3);
			...
			var d = this.v,
				...
				k, m;
			k = 0;
			for (m = a.length; k < m; ++k) g = ae(d, g, a[k], e, f[h]), f[h++] = g, g = g[g.length - 1];
			f.length = h;
			0 === f.length ? this.v.length = 0 : (d = f[f.length - 1], this.v.length = 0 === d.length ? 0 : d[d.length - 1]);
			this.u() } else qp(this, "XY", null, this.c) };

	function qp(a, c, d, e) { Qd(a, c, d);
		a.c = e;
		a.u() }
	...
	function tp(a, c) {
		...
		if (ia(a.x) && ia(a.y)) d = "Point";
			...
			for (; d.length;) { e = d.shift();
				f = !1;
				for (h = g.length - 1; 0 <= h; h--)
					if (Gc((new fe(g[h][0])).G(), (new fe(e)).G())) { g[h].push(e);
						f = !0;
						break }
				f || g.push([e.reverse()]) }
			a = mb({}, a);
	...
	var vp = { Point: function(a) {
				return void 0 !== a.m && void 0 !== a.z ? new E([a.x, a.y, a.z, a.m], "XYZM") : void 0 !== a.z ? new E([a.x, a.y, a.z], "XYZ") : void 0 !== a.m ? new E([a.x, a.y, a.m], "XYM") : new E([a.x, a.y]) }, LineString: function(a) {
				return new T(a.paths[0], up(a)) }, Polygon: function(a) {
				return new F(a.rings, up(a)) }, MultiPoint: function(a) {
				return new pp(a.points, up(a)) }, MultiLineString: function(a) {
				return new U(a.paths, up(a)) }, MultiPolygon: function(a) {
		...
		xp = {
			...
			LineString: function(a) {
				var c = wp(a);
				return { hasZ: c.hasZ, hasM: c.hasM, paths: [a.Y()] } },
			Polygon: function(a) {
				var c = wp(a);
				return { hasZ: c.hasZ, hasM: c.hasM, rings: a.Y(!1) } },
			MultiPoint: function(a) {
				var c = wp(a);
				return { hasZ: c.hasZ, hasM: c.hasM, points: a.Y() } },
	...
	l.Af = function(a, c) {
		...
		if (a.features) {
			...
			g = 0;
			for (h = f.length; g < h; ++g) e.push(this.Tc(f[g], d));
			return e }
		return [this.Tc(a, d)] };
	l.Ah = function(a, c) {
		return tp(a, c) };
	...
	l.Yc = function(a, c) { c = fp(this, c);
		...
		return d };
	l.He = function(a, c) { c = fp(this, c);
		var d = [],
			e, f;
		e = 0;
		for (f = a.length; e < f; ++e) d.push(this.Yc(a[e], c));
		return { features: d } };

	function zp(a) { Md.call(this);
		this.i = a ? a : null;
		Ap(this) }
	y(zp, Md);
	...
	function Cp(a) {
		var c, d;
		if (a.i)
			for (c = 0, d = a.i.length; c < d; ++c) yb(a.i[c], "change", a.u, a) }

	function Ap(a) {
		var c, d;
		if (a.i)
			for (c = 0, d = a.i.length; c < d; ++c) D(a.i[c], "change", a.u, a) }
	l = zp.prototype;
	l.clone = function() {
		var a = new zp(null);
		a.Qh(this.i);
	...
	l.sb = function(a, c, d, e) {
		...
		var f = this.i,
			g, h;
		g = 0;
		for (h = f.length; g < h; ++g) e = f[g].sb(a, c, d, e);
		return e };
	l.xc = function(a, c) {
		var d = this.i,
			e, f;
		e = 0;
		for (f = d.length; e < f; ++e)
			if (d[e].xc(a, c)) return !0;
		return !1 };
	l.Pd = function(a) { Ic(Infinity, Infinity, -Infinity, -Infinity, a);
		for (var c = this.i, d = 0, e = c.length; d < e; ++d) Nc(a, c[d].G());
		return a };
	l.vg = function() {
		return Bp(this.i) };
	l.sd = function(a) { this.s != this.g && (nb(this.j), this.l = 0, this.s = this.g);
		...
		for (h = e.length; g < h; ++g) {
			...
			d.push(m);
			m !== k && (f = !0) }
		if (f) return a = new zp(null), Cp(a), a.i = d, Ap(a), a.u(), this.j[c] = a;
		this.l = a;
		return this };
	l.W = function() {
	...
	l.Hc = function(a) {
		var c = this.i,
			d, e;
		d = 0;
		for (e = c.length; d < e; ++d) c[d].Hc(a);
		this.u() };
	l.Rc = function(a, c) {
		var d = this.i,
			e, f;
		e = 0;
		for (f = d.length; e < f; ++e) d[e].Rc(a, c);
		this.u() };
	l.fa = function() { Cp(this);
		zp.ha.fa.call(this) };
	...
	var Fp = { Point: function(a) {
				return new E(a.coordinates) }, LineString: function(a) {
				return new T(a.coordinates) }, Polygon: function(a) {
				return new F(a.coordinates) }, MultiPoint: function(a) {
				return new pp(a.coordinates) }, MultiLineString: function(a) {
				return new U(a.coordinates) }, MultiPolygon: function(a) {
				return new V(a.coordinates) }, GeometryCollection: function(a, c) {
		...
		Hp = {
			...
			Polygon: function(a, c) {
				var d;
				c && (d = c.rightHanded);
				return { type: "Polygon", coordinates: a.Y(d) } },
			MultiPoint: function(a) {
			...
			MultiPolygon: function(a, c) {
				var d;
				c && (d = c.rightHanded);
				return { type: "MultiPolygon", coordinates: a.Y(d) } },
			GeometryCollection: function(a, c) {
				return { type: "GeometryCollection", geometries: a.i.map(function(a) {
						return Gp(a, c) }) } },
			Circle: function() {
				return {
	...
	l.Tc = function(a, c) {
		...
		return e };
	l.Af = function(a, c) {
		if ("Feature" == a.type) return [this.Tc(a, c)];
		if ("FeatureCollection" == a.type) {
			var d = [],
				e = a.features,
				f, g;
			f = 0;
			for (g = e.length; f < g; ++f) d.push(this.Tc(e[f], c));
			return d }
		return [] };
	l.Ah = function(a, c) {
		return Ep(a, c) };
	...
	function Ip() { this.defaultDataProjection = null }
	y(Ip, dp);
	l = Ip.prototype;
	l.W = function() {
		return "xml" };
	l.Ub = function(a, c) {
		if (pm(a)) return Jp(this, a, c);
		if (sm(a)) return this.yh(a, c);
		if ("string" === typeof a) {
			var d = Cm(a);
			return Jp(this, d, c) }
		return null };

	function Jp(a, c, d) { a = Kp(a, c, d);
		return 0 < a.length ? a[0] : null }
	l.Ea = function(a, c) {
		if (pm(a)) return Kp(this, a, c);
		if (sm(a)) return this.ic(a, c);
		if ("string" === typeof a) {
			var d = Cm(a);
			return Kp(this, d, c) }
		return [] };
	...
	function Kp(a, c, d) {
		var e = [];
		for (c = c.firstChild; c; c = c.nextSibling) 1 == c.nodeType && Ya(e, a.ic(c, d));
		return e }
	l.Uc = function(a, c) {
		if (pm(a)) return this.s(a, c);
		if (sm(a)) {
	...
	function Lp(a) { a = a ? a : {};
		...
		this.schemaLocation = "";
		this.b = {};
		this.b["http://www.opengis.net/gml"] = { featureMember: Fm(Lp.prototype.yd), featureMembers: Fm(Lp.prototype.yd) };
		this.defaultDataProjection = null }
	y(Lp, Ip);
	var Mp = /^[\s\xa0]*$/;
	l = Lp.prototype;
	l.yd = function(a, c) {
		var d = mm(a),
			e;
		if ("FeatureCollection" == d) "http://www.opengis.net/wfs" === a.namespaceURI ? e = R([], this.b, a, c, this) : e = R(null, this.b, a, c, this);
			...
			for (t in e) { f = {};
				h = 0;
				for (k = g.length; h < k; ++h)(-1 === g[h].indexOf(":") ? "p0" : g[h].split(":")[0]) === t && (f[g[h].split(":").pop()] = "featureMembers" == d ? Em(this.zf, this) : Fm(this.zf, this));
				r[e[t]] = f }
			e = R([], r, a, c)
		}
		e || (e = []);
	...
	l.ye = function(a, c) {
		...
		if (e) return gp(e, !1, d) };
	l.zf = function(a, c) {
		var d, e = a.getAttribute("fid") || wm(a, "http://www.opengis.net/gml", "id"),
			f = {},
			g;
		for (d = a.firstElementChild; d; d = d.nextElementSibling) {
			...
			if (0 === d.childNodes.length || 1 === d.childNodes.length && (3 === d.firstChild.nodeType || 4 === d.firstChild.nodeType)) {
				var k = im(d, !1);
				Mp.test(k) && (k = void 0);
				f[h] = k } else "boundedBy" !== h && (g = h), f[h] = this.ye(d, c) }
		d = new Xl(f);
		g && d.Bc(g);
		e && d.jc(e);
		return d };
	...
	l.Fh = function(a, c) {
		...
		if (d) {
			...
			rp(e, d);
			return e } };
	l.vh = function(a, c) { Mm(this.Fi, a, c, this) };
	l.Kg = function(a, c) { Mm(this.yi, a, c, this) };
	l.wh = function(a, c) { Mm(this.Gi, a, c, this) };
	l.ze = function(a, c) {
		var d = this.xe(a, c);
		if (d) {
			var e = new T(null);
	...
	l.Bi = Object({ "http://www.opengis.net/gml": { pointMember: Em(Lp.prototype.vh), pointMembers: Em(Lp.prototype.vh) } });
	l.Ai = Object({ "http://www.opengis.net/gml": { lineStringMember: Em(Lp.prototype.Kg), lineStringMembers: Em(Lp.prototype.Kg) } });
	l.Ci = Object({ "http://www.opengis.net/gml": { polygonMember: Em(Lp.prototype.wh), polygonMembers: Em(Lp.prototype.wh) } });
	...
	function Up(a, c) { Vp(a, c ? "1" : "0") }

	function Wp(a, c) { a.appendChild(em.createTextNode(c.toPrecision())) }

	function Xp(a, c) { a.appendChild(em.createTextNode(c.toString())) }

	function Vp(a, c) { a.appendChild(em.createTextNode(c)) };
	...
	l.Le = Object({ "http://www.opengis.net/gml": { innerBoundaryIs: Yp.prototype.Qk, outerBoundaryIs: Yp.prototype.vn } });
	l.ui = Object({ "http://www.opengis.net/gml": { coordinates: Em(Yp.prototype.zh) } });
	l.Sf = Object({ "http://www.opengis.net/gml": { Point: Fm(Lp.prototype.Gh), MultiPoint: Fm(Lp.prototype.Eh), LineString: Fm(Lp.prototype.ze), MultiLineString: Fm(Lp.prototype.Dh), LinearRing: Fm(Lp.prototype.Ch), Polygon: Fm(Lp.prototype.Ae), MultiPolygon: Fm(Lp.prototype.Fh), Box: Fm(Yp.prototype.Mn) } });
	...
	l.Un = function(a, c) {
		...
		if (d) {
			...
			rp(e, d);
			return e } };
	l.lg = function(a, c) { Mm(this.vi, a, c, this) };
	l.bi = function(a, c) { Mm(this.Ki, a, c, this) };
	l.Xn = function(a, c) {
	...
	l.Qn = function(a, c) {
		for (var d = im(a, !1), e = /^\s*([+\-]?\d*\.?\d+(?:[eE][+\-]?\d+)?)\s*/, f = [], g; g = e.exec(d);) f.push(parseFloat(g[1])), d = d.substr(g[0].length);
		if ("" === d) { d = c[0].srsName;
			e = "enu";
			d && (e = td(qd(d)));
			if ("neu" === e)
	...
	l.Df = function(a, c) {
		...
		for (var h, k, m = [], n = 0, p = d.length; n < p; n += e) f = parseFloat(d[n]), h = parseFloat(d[n + 1]), k = 3 === e ? parseFloat(d[n + 2]) : 0, "en" === g.substr(0, 2) ? m.push(f, h, k) : m.push(h, f, k);
		return m };
	l.Hd = Object({ "http://www.opengis.net/gml": { pos: Fm(Zp.prototype.Qn), posList: Fm(Zp.prototype.Df) } });
	l.Le = Object({ "http://www.opengis.net/gml": { interior: Zp.prototype.Sk, exterior: Zp.prototype.nj } });
	l.Sf = Object({ "http://www.opengis.net/gml": { Point: Fm(Lp.prototype.Gh), MultiPoint: Fm(Lp.prototype.Eh), LineString: Fm(Lp.prototype.ze), MultiLineString: Fm(Lp.prototype.Dh), LinearRing: Fm(Lp.prototype.Ch), Polygon: Fm(Lp.prototype.Ae), MultiPolygon: Fm(Lp.prototype.Fh), Surface: Fm(Zp.prototype.Ih), MultiSurface: Fm(Zp.prototype.Un), Curve: Fm(Zp.prototype.xh), MultiCurve: Fm(Zp.prototype.Tn), Envelope: Fm(Zp.prototype.On) } });
	l.zi = Object({ "http://www.opengis.net/gml": { curveMember: Em(Zp.prototype.lg), curveMembers: Em(Zp.prototype.lg) } });
	l.Di = Object({ "http://www.opengis.net/gml": { surfaceMember: Em(Zp.prototype.bi), surfaceMembers: Em(Zp.prototype.bi) } });
	l.vi = Object({ "http://www.opengis.net/gml": { LineString: Em(Lp.prototype.ze), Curve: Em(Zp.prototype.xh) } });
	l.Ki = Object({ "http://www.opengis.net/gml": { Polygon: Em(Lp.prototype.Ae), Surface: Em(Zp.prototype.Ih) } });
	...
	l.xi = Object({ "http://www.opengis.net/gml": { lowerCorner: Em(Zp.prototype.Df), upperCorner: Em(Zp.prototype.Df) } });
	...
	function $p(a, c, d) { d = d[d.length - 1].srsName;
		c = c.Y();
		for (var e = c.length, f = Array(e), g, h = 0; h < e; ++h) { g = c[h];
			var k = h,
				m = "enu";
			d && (m = td(qd(d)));
	...
	var aq = { "http://www.opengis.net/gml": { lowerCorner: O(Vp), upperCorner: O(Vp) } };
	l = Zp.prototype;
	l.Mo = function(a, c, d) {
		var e = d[d.length - 1].srsName;
		e && a.setAttribute("srsName", e);
	...
	l.Ke = function(a, c, d) {
		var e = d[d.length - 1].srsName; "PolygonPatch" !== a.nodeName && e && a.setAttribute("srsName", e); "Polygon" === a.nodeName || "PolygonPatch" === a.nodeName ? (c = c.Vd(), Nm({ node: a, srsName: e }, bq, this.Ii, c, d, void 0, this)) : "Surface" === a.nodeName && (e = hm(a.namespaceURI, "patches"), a.appendChild(e), a = hm(e.namespaceURI, "PolygonPatch"), e.appendChild(a), this.Ke(a, c, d)) };
	l.Fe = function(a, c, d) {
	...
	l.oi = function(a, c, d) {
		...
		c = c.Wd();
		Nm({ node: a, srsName: f, surface: e }, cq, this.f, c, d, void 0, this) };
	l.No = function(a, c, d) {
		var e = d[d.length - 1].srsName;
		e && a.setAttribute("srsName", e);
		c = c.ke();
		Nm({ node: a, srsName: e }, dq, Im("pointMember"), c, d, void 0, this) };
	l.ni = function(a, c, d) {
		var e = d[d.length - 1],
			f = e.srsName,
			e = e.curve;
		f && a.setAttribute("srsName", f);
		c = c.rd();
		Nm({ node: a, srsName: f, curve: e }, eq, this.f, c, d, void 0, this) };
	l.ri = function(a, c, d) {
	...
	var cq = { "http://www.opengis.net/gml": { surfaceMember: O(Zp.prototype.si), polygonMember: O(Zp.prototype.si) } },
		dq = { "http://www.opengis.net/gml": { pointMember: O(Zp.prototype.Oo) } },
		eq = { "http://www.opengis.net/gml": { lineStringMember: O(Zp.prototype.li), curveMember: O(Zp.prototype.li) } },
		bq = { "http://www.opengis.net/gml": { exterior: O(Zp.prototype.ri), interior: O(Zp.prototype.ri) } },
		fq = {
		...
		gq = { MultiLineString: "lineStringMember", MultiCurve: "curveMember", MultiPolygon: "polygonMember", MultiSurface: "surfaceMember" };
	...
	Zp.prototype.o = function(a, c) { c = fp(this, c);
		var d = hm("http://www.opengis.net/gml", "geom"),
			e = { node: d, srsName: this.srsName, curve: this.c, surface: this.l, multiSurface: this.j, multiCurve: this.i };
		c && mb(e, c);
		this.Ie(d, a, [e]);
		return d };
	Zp.prototype.a = function(a, c) { c = fp(this, c);
		...
		var e = { srsName: this.srsName, curve: this.c, surface: this.l, multiSurface: this.j, multiCurve: this.i, featureNS: this.featureNS, featureType: this.featureType };
		c && mb(e, c);
		var e = [e],
			f = e[e.length - 1],
			g = f.featureType,
	...
	function jq(a, c, d) { a.push(parseFloat(c.getAttribute("lon")), parseFloat(c.getAttribute("lat"))); "ele" in d ? (a.push(d.ele), delete d.ele) : a.push(0); "time" in d ? (a.push(d.time), delete d.time) : a.push(0);
		return a }
	...
	function mq(a, c) { c[c.length - 1].extensionsNode_ = a }
	...
	function pq(a, c) {
		var d = c[0],
			e = R({ flatCoordinates: [], ends: [] }, qq, a, c);
		if (e) {
			var f = e.flatCoordinates;
			delete e.flatCoordinates;
			var g = e.ends;
	...
	function rq(a, c) {
		...
		if (e) {
			...
			d.C(e);
			return d } }
	var tq = { rte: nq, trk: pq, wpt: rq },
		uq = Q(iq, { rte: Em(nq), trk: Em(pq), wpt: Em(rq) }),
		lq = Q(iq, { text: N(W, "linkText"), type: N(W, "linkType") }),
		oq = Q(iq, { name: N(W), cmt: N(W), desc: N(W), src: N(W), link: kq, number: N(Sp), extensions: mq, type: N(W), rtept: function(a, c) {
				var d = R({}, vq, a, c);
				d && jq(c[c.length - 1].flatCoordinates, a, d) } }),
		vq = Q(iq, { ele: N(Qp), time: N(Pp) }),
		qq = Q(iq, { name: N(W), cmt: N(W), desc: N(W), src: N(W), link: kq, number: N(Sp), type: N(W), extensions: mq, trkseg: function(a, c) {
				var d = c[c.length - 1];
				Mm(wq, a, c);
		...
		wq = Q(iq, { trkpt: function(a, c) {
				var d = R({}, xq, a, c);
				d && jq(c[c.length - 1].flatCoordinates, a, d) } }),
		xq = Q(iq, { ele: N(Qp), time: N(Pp) }),
		sq = Q(iq, { ele: N(Qp), time: N(Pp), magvar: N(Qp), geoidheight: N(Qp), name: N(W), cmt: N(W), desc: N(W), src: N(W), link: kq, sym: N(W), type: N(W), fix: N(W), sat: N(Sp), hdop: N(Qp), vdop: N(Qp), pdop: N(Qp), ageofdgpsdata: N(Qp), dgpsid: N(Sp), extensions: mq });
	...
	hq.prototype.yh = function(a, c) {
		if (!Va(iq, a.namespaceURI)) return null;
	...
	hq.prototype.ic = function(a, c) {
		if (!Va(iq, a.namespaceURI)) return [];
		if ("gpx" == a.localName) {
			var d = R([], uq, a, [ep(this, a, c)]);
			if (d) return yq(this, d), d }
		return [] };

	function zq(a, c, d) { a.setAttribute("href", c);
	...
	function Cq(a, c, d) {
		...
		c = Dq[f];
		e = Lm(g, c);
		Nm({ node: a, properties: g }, Eq, Km, e, d, c) }
	var Bq = ["text", "type"],
		Aq = Q(iq, { text: O(Vp), type: O(Vp) }),
		Fq = Q(iq, "name cmt desc src link number type rtept".split(" ")),
		Gq = Q(iq, { name: O(Vp), cmt: O(Vp), desc: O(Vp), src: O(Vp), link: O(zq), number: O(Xp), type: O(Vp), rtept: Hm(O(Cq)) }),
		Hq = Q(iq, "name cmt desc src link number type trkseg".split(" ")),
		Kq = Q(iq, { name: O(Vp), cmt: O(Vp), desc: O(Vp), src: O(Vp), link: O(zq), number: O(Xp), type: O(Vp), trkseg: Hm(O(function(a, c, d) { Nm({ node: a, geometryLayout: c.f, properties: {} }, Iq, Jq, c.Y(), d) })) }),
		Jq = Im("trkpt"),
		Iq = Q(iq, { trkpt: O(Cq) }),
		...
		Lq = { Point: "wpt", LineString: "rte", MultiLineString: "trk" };

	function Mq(a, c) {
		var d = a.X();
		if (d && (d = Lq[d.W()])) return hm(c[c.length - 1].node.namespaceURI, d) }
	var Nq = Q(iq, {
		rte: O(function(a, c, d) {
			var e = d[0],
				f = c.P();
			a = { node: a, properties: f };
			if (c = c.X()) c = gp(c, !0, e), a.geometryLayout = c.f, f.rtept = c.Y();
		...
		trk: O(function(a, c, d) {
			var e = d[0],
				f = c.P();
			a = { node: a, properties: f };
			if (c = c.X()) c = gp(c, !0, e), f.trkseg = c.rd();
		...
		wpt: O(function(a, c, d) {
			var e = d[0],
				f = d[d.length - 1];
			f.properties = c.P();
			if (c = c.X()) c = gp(c, !0, e), f.geometryLayout = c.f, Cq(a, c.Y(),
				d)
		})
	});
	hq.prototype.a = function(a, c) { c = fp(this, c);
		var d = hm("http://www.topografix.com/GPX/1/1", "gpx");
		Nm({ node: d }, Nq, Mq, a, [c]);
		return d };

	function Oq() { this.defaultDataProjection = null }
	y(Oq, dp);
			...
			if ("B" == q.charAt(0)) {
				if (r = Rq.exec(q)) {
					var q = parseInt(r[1], 10),
						t = parseInt(r[2], 10),
						v = parseInt(r[3], 10),
						w = parseInt(r[4], 10) + parseInt(r[5], 10) / 6E4; "S" == r[6] && (w = -w);
					var z = parseInt(r[7], 10) + parseInt(r[8], 10) / 6E4; "W" == r[9] && (z = -z);
					g.push(z, w); "none" != d && g.push("gps" == d ? parseInt(r[11], 10) : "barometric" == d ? parseInt(r[12], 10) : 0);
					g.push(Date.UTC(h, k, m, q, t, v) / 1E3) } } else if ("H" == q.charAt(0))
				if (r =
					Tq.exec(q)) m = parseInt(r[1], 10), k = parseInt(r[2], 10) - 1, h = 2E3 + parseInt(r[3], 10);
				else if (r = Sq.exec(q)) f[r[1]] = r[2].trim(), Tq.exec(q)
		}
	...
	function Yq(a, c, d) {
		if (fa(c))
			for (var e = 0; e < c.length; e++) Yq(a, String(c[e]), d);
		else null != c && d.push("&", a, "" === c ? "" : "=", encodeURIComponent(String(c))) }

	function Zq(a, c) {
		for (var d in c) Yq(d, c[d], a);
		return a };

	function $q(a, c) { this.a = this.j = this.g = "";
		this.l = null;
		this.f = this.b = "";
		this.c = !1;
		var d;
	...
	$q.prototype.toString = function() {
		...
		c && a.push(fr(c, gr, !0), ":");
		var d = this.a;
		if (d || "file" == c) a.push("//"), (c = this.j) && a.push(fr(c, gr, !0), "@"), a.push(encodeURIComponent(String(d)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), d = this.l, null != d && a.push(":", String(d));
		if (d = this.b) this.a && "/" != d.charAt(0) && a.push("/"), a.push(fr(d, "/" == d.charAt(0) ? hr : ir, !0));
	...
	function ar(a, c, d) { a.g = d ? dr(c, !0) : c;
		a.g && (a.g = a.g.replace(/:$/, "")) }
	...
	function cr(a, c, d) { c instanceof er ? (a.i = c, kr(a.i, a.c)) : (d || (c = fr(c, lr)), a.i = new er(c, 0, a.c)) }
	...
	function or(a) { a = a.charCodeAt(0);
	...
	function er(a, c, d) { this.a = this.b = null;
		this.g = a || null;
		this.f = !!d }

	function pr(a) { a.b || (a.b = new fh, a.a = 0, a.g && Wq(a.g, function(c, d) {
			...
			a.a++ })) }
	l = er.prototype;
	l.rc = function() { pr(this);
		return this.a };
	l.remove = function(a) { pr(this);
		a = qr(this, a);
		return hh(this.b.a, a) ? (this.g = null, this.a -= this.b.get(a).length, this.b.remove(a)) : !1 };
	l.clear = function() { this.b = this.g = null;
		this.a = 0 };
	l.Oa = function() { pr(this);
		return 0 == this.a };

	function rr(a, c) { pr(a);
		c = qr(a, c);
		return hh(a.b.a, c) }
	l.O = function() { pr(this);
		for (var a = this.b.vc(), c = this.b.O(), d = [], e = 0; e < c.length; e++)
			for (var f = a[e], g = 0; g < f.length; g++) d.push(c[e]);
		return d };
	l.vc = function(a) { pr(this);
		var c = [];
		if (ha(a)) rr(this, a) && (c = Xb(c, this.b.get(qr(this, a))));
		else { a = this.b.vc();
			for (var d = 0; d < a.length; d++) c = Xb(c, a[d]) }
		return c };
	l.set = function(a, c) { pr(this);
		this.g = null;
		a = qr(this, a);
	...
	l.toString = function() {
		...
		if (!this.b) return "";
		for (var a = [], c = this.b.O(), d = 0; d < c.length; d++)
			for (var e = c[d], f = encodeURIComponent(String(e)), e = this.vc(e), g = 0; g < e.length; g++) {
				var h = f; "" !== e[g] && (h += "=" + encodeURIComponent(String(e[g])));
				a.push(h) }
	...
	function kr(a, c) { c && !a.f && (pr(a), a.g = null, a.b.forEach(function(a, c) {
			var f = c.toLowerCase();
			c != f && (this.remove(c), this.remove(f), 0 < a.length && (this.g = null, this.b.set(qr(this, f), Yb(a)), this.a += a.length)) }, a));
		a.f = c };
	...
	l.dk = function() {
		return this.o };
	l.so = function(a) { this.g = a };
	l.Vh = function(a) { this.f = a };
	l.Wh = function(a) { this.c = a };
	l.ro = function(a) { this.b = a };
	l.nn = function(a) { this.i = a };
	l.pn = function(a) { this.a = a };
	l.yo = function(a) { this.j = a };
	l.Yh = function(a) { this.s = a };
	l.Zh = function(a) { this.l = a };
	l.zo = function(a) { this.o = a };
	...
	var vr = ["http://www.google.com/kml/ext/2.2"],
		...
		zr = [20, 2],
		Ar = [64, 64],
		Br = new Wi({ anchor: zr, anchorOrigin: "bottom-left", anchorXUnits: "pixels", anchorYUnits: "pixels", crossOrigin: "anonymous", rotation: 0, scale: .5, size: Ar, src: "https://maps.google.com/mapfiles/kml/pushpin/ylw-pushpin.png" }),
		Cr = new Gk({ color: xr, width: 1 }),
		Dr = new sr({
			font: "bold 16px Helvetica",
			fill: yr,
			stroke: new Gk({ color: [51, 51, 51, 1], width: 2 }),
			scale: .8
		}),
		ur = [new Kk({ fill: yr, image: Br, text: Dr, stroke: Cr, zIndex: 0 })],
		Er = { fraction: "fraction", pixels: "pixels" };
	...
	function Fr(a, c) {
		...
		if (pb(a.Fa())) d = new sr({ text: c, offsetX: e[0], offsetY: e[1], textAlign: f });
		else {
			var d = a.Fa(),
				g = {},
				h;
	...
	function Gr(a, c, d, e, f) {
		return function() {
			...
			if (a) return g ? (g = Fr(a[0], h), a.concat(g)) : a;
			if (c) {
				var k = Hr(c, d, e);
	...
	function Ur(a, c) {
		...
		if (e) {
			if ("Point" == f) { g = d[0];
				...
				f = g.ga();
				h = 1;
				for (k = d.length; h < k; ++h) g = d[h], Ya(f, g.ga());
				g = new pp(null);
				g.ba(e, f);
				Wr(g, d);
				return g }
	...
	function Yr(a, c) {
		...
		if (e && e[0]) {
			var f = new F(null),
				...
				k, m;
			k = 1;
			for (m = e.length; k < m; ++k) Ya(g, e[k]), h.push(g.length);
			f.ba("XYZ", g, h);
			f.C(d);
			return f } }
	...
	function $r(a, c) {
		...
		var f = "imageStyle" in d ? d.imageStyle : Br,
			...
			d = d.outline;
		void 0 === d || d || (h = null);
		return [new Kk({ fill: e, image: f, stroke: h, text: g, zIndex: void 0 })] }
	...
	function bs(a, c) { Mm(cs, a, c) }
	var ds = Q(wr, { value: Fm(W) }),
		cs = Q(wr, { Data: function(a, c) {
				var d = a.getAttribute("name");
				if (null !== d) {
					var e = R(void 0, ds, a, c);
					e && (c[c.length - 1][d] = e) } }, SchemaData: function(a, c) { Mm(es, a, c) } }),
		Rr = Q(wr, { extrude: N(Np), altitudeMode: N(W) }),
		Nr = Q(wr, { coordinates: Fm(Jr) }),
		Zr = Q(wr, { innerBoundaryIs: function(a, c) {
				var d = R(void 0, fs, a, c);
				d && c[c.length - 1].push(d) }, outerBoundaryIs: function(a, c) {
		...
		hs = Q(wr, { href: N(Kr) }, Q(vr, { x: N(Qp), y: N(Qp), w: N(Qp), h: N(Qp) })),
		is = Q(wr, { Icon: N(function(a, c) {
				var d = R({}, hs, a, c);
				return d ? d : null }), heading: N(Qp), hotSpot: N(function(a) {
				var c = a.getAttribute("xunits"),
					d = a.getAttribute("yunits");
				return { x: parseFloat(a.getAttribute("x")), Qf: Er[c], y: parseFloat(a.getAttribute("y")), Rf: Er[d] } }), scale: N(Lr) }),
		fs = Q(wr, { LinearRing: Fm(Mr) }),
		js = Q(wr, { color: N(Ir), scale: N(Lr) }),
		ks = Q(wr, {
			color: N(Ir),
			width: N(Qp)
		}),
		Vr = Q(wr, { LineString: Em(Qr), LinearRing: Em(Tr), MultiGeometry: Em(Ur), Point: Em(Xr), Polygon: Em(Yr) }),
		ls = Q(vr, { Track: Em(Or) }),
		ns = Q(wr, { ExtendedData: bs, Link: function(a, c) { Mm(ms, a, c) }, address: N(W), description: N(W), name: N(W), open: N(Np), phoneNumber: N(W), visibility: N(Np) }),
		ms = Q(wr, { href: N(Kr) }),
		gs = Q(wr, { LinearRing: Fm(Mr) }),
		os = Q(wr, { Style: N($r), key: N(W), styleUrl: N(function(a) {
				var c = im(a, !1).trim();
		...
		qs = Q(wr, {
			...
			styleUrl: N(Kr),
			visibility: N(Np)
		}, Q(vr, { MultiTrack: N(function(a, c) {
				var d = R([], ls, a, c);
				if (d) {
					var e = new U(null);
					op(e, d);
					return e } }, "geometry"), Track: N(Or, "geometry") })),
		rs = Q(wr, {
			color: N(Ir),
			fill: N(Np),
			outline: N(Np)
		...
		as = Q(wr, {
			IconStyle: function(a, c) {
				...
				if (d) {
					...
					h = new Wi({ anchor: h, anchorOrigin: "bottom-left", anchorXUnits: k, anchorYUnits: m, crossOrigin: "anonymous", offset: p, offsetOrigin: "bottom-left", rotation: t, scale: d, size: r, src: g });
					e.imageStyle = h
				}
			},
			LabelStyle: function(a, c) {
				var d = R({}, js, a, c);
				d && (c[c.length - 1].textStyle = new sr({ fill: new Ak({ color: "color" in d ? d.color : xr }), scale: d.scale }))
			},
			LineStyle: function(a, c) {
				var d = R({}, ks, a, c);
				d && (c[c.length - 1].strokeStyle = new Gk({ color: "color" in d ? d.color : xr, width: "width" in d ? d.width : 1 })) },
	...
	l = tr.prototype;
	l.xf = function(a, c) { mm(a);
		var d = Q(wr, { Document: Dm(this.xf, this), Folder: Dm(this.xf, this), Placemark: Em(this.Ff, this), Style: this.ao.bind(this), StyleMap: this.$n.bind(this) });
		if (d = R([], d, a, c, this)) return d };
	l.Ff = function(a, c) {
	...
	l.$n = function(a, c) {
		...
		if (null !== d) {
			...
			e && (d = a.baseURI ? nr(a.baseURI, "#" + d).toString() : "#" + d, this.b[d] = e) } };
	l.yh = function(a, c) {
		if (!Va(wr, a.namespaceURI)) return null;
		var d = this.Ff(a, [ep(this, a, c)]);
		return d ? d : null };
	l.ic = function(a, c) {
		if (!Va(wr, a.namespaceURI)) return [];
		var d;
		d = mm(a);
		if ("Document" == d || "Folder" == d) return (d = this.xf(a, [ep(this, a, c)])) ? d : [];
		...
		return [] };
	l.Vn = function(a) {
		if (pm(a)) return ss(this, a);
		if (sm(a)) return ts(this, a);
		if ("string" === typeof a) return a = Cm(a), ss(this, a) };
	...
	function ts(a, c) {
		...
		for (d = c.firstElementChild; d; d = d.nextElementSibling)
			if (Va(wr, d.namespaceURI) && "name" == d.localName) return W(d);
		for (d = c.firstElementChild; d; d = d.nextElementSibling) {
			var e = mm(d);
			if (Va(wr, d.namespaceURI) && ("Document" == e || "Folder" == e || "Placemark" == e || "kml" == e) && (e = ts(a, d))) return e } }
	l.Wn = function(a) {
		var c = [];
	...
	function us(a, c) {
		var d, e = [];
		for (d = c.firstChild; d; d = d.nextSibling) 1 == d.nodeType && Ya(e, vs(a, d));
		return e }
	...
	function vs(a, c) {
		...
		for (d = c.firstElementChild; d; d = d.nextElementSibling)
			if (Va(wr, d.namespaceURI) && "NetworkLink" == d.localName) {
				var f = R({}, ns, d, []);
				e.push(f) }
		for (d = c.firstElementChild; d; d = d.nextElementSibling) f = mm(d), !Va(wr, d.namespaceURI) || "Document" != f && "Folder" != f && "kml" != f || Ya(e, vs(a, d));
		return e }
	...
	function xs(a, c, d) { Nm({ node: a }, ys, zs, [c], d) }
	...
	function Hs(a, c, d) { c = c.Vd();
		var e = c.shift();
		a = { node: a };
		Nm(a, Is, Js, c, d);
		Nm(a, Is, Ks, [e], d) }

	function Ls(a, c) { Wp(a, c * c) }
	var Ms = Q(wr, ["Document", "Placemark"]),
		Ps = Q(wr, { Document: O(function(a, c, d) { Nm({ node: a }, Ns, Os, c, d, void 0, this) }), Placemark: O(As) }),
		Ns = Q(wr, { Placemark: O(As) }),
		Qs = { Point: "Point", LineString: "LineString", LinearRing: "LinearRing", Polygon: "Polygon", MultiPoint: "MultiGeometry", MultiLineString: "MultiGeometry", MultiPolygon: "MultiGeometry" },
		Rs = Q(wr, ["href"], Q(vr, ["x", "y", "w", "h"])),
		Ss = Q(wr, { href: O(Vp) }, Q(vr, { x: O(Wp), y: O(Wp), w: O(Wp), h: O(Wp) })),
		...
		Vs = Q(wr, {
			Icon: O(function(a,
				...
				Nm(a, Ss, Us, f, d, e) }),
			heading: O(Wp),
			hotSpot: O(function(a, c) { a.setAttribute("x", c.x);
		...
		Ws = Q(wr, ["color", "scale"]),
		Xs = Q(wr, { color: O(ws), scale: O(Ls) }),
		Ys = Q(wr, ["color", "width"]),
		Zs = Q(wr, { color: O(ws), width: O(Wp) }),
		ys = Q(wr, { LinearRing: O(Es) }),
		$s = Q(wr, { LineString: O(Es), Point: O(Es), Polygon: O(Hs) }),
		Bs = Q(wr,
			"name open visibility address phoneNumber description styleUrl Style".split(" ")),
		Cs = Q(wr, {
			MultiGeometry: O(function(a, c, d) { a = { node: a };
				var e = c.W(),
					f, g; "MultiPoint" == e ? (f = c.ke(), g = at) : "MultiLineString" == e ? (f = c.rd(), g = bt) : "MultiPolygon" == e && (f = c.Wd(), g = ct);
				Nm(a, $s, g, f, d) }),
			LineString: O(Es),
			LinearRing: O(Es),
			Point: O(Es),
		...
		Fs = Q(wr, { coordinates: O(function(a, c, d) { d = d[d.length - 1];
				var e = d.layout;
				d = d.stride;
				var f; "XY" == e || "XYM" == e ? f = 2 : ("XYZ" == e || "XYZM" == e) && (f = 3);
				var g, h = c.length,
					k = "";
				if (0 < h) { k += c[0];
					for (e = 1; e < f; ++e) k += "," + c[e];
				...
				Vp(a, k) }) }),
		Is = Q(wr, { outerBoundaryIs: O(xs), innerBoundaryIs: O(xs) }),
		ft = Q(wr, { color: O(ws) }),
		dt = Q(wr, ["IconStyle", "LabelStyle", "LineStyle", "PolyStyle"]),
		et = Q(wr, {
			IconStyle: O(function(a, c, d) { a = { node: a };
				var e = {},
					f = c.Eb(),
					g = c.qd(),
					h = { href: c.b.o };
				if (f) { h.w = f[0];
					...
					k && 0 !== k[0] && k[1] !== f[1] && (e.hotSpot = { x: k[0], Qf: "pixels", y: f[1] - k[1], Rf: "pixels" }) }
				e.Icon = h;
				f = c.j;
				1 !== f && (e.scale = f);
				c = c.s;
			...
			LineStyle: O(function(a, c, d) { a = { node: a };
				var e = Ys[d[d.length - 1].node.namespaceURI];
				c = Lm({ color: c.b, width: c.a }, e);
				Nm(a, Zs, Km, c, d, e) }),
			PolyStyle: O(function(a, c, d) { Nm({ node: a }, ft, gt, [c.b], d) })
		});
	...
	function Ds(a, c) {
		if (a) return hm(c[c.length - 1].node.namespaceURI, Qs[a.W()]) }
	var gt = Im("color"),
		Gs = Im("coordinates"),
	...
	(function() {
		var a = {},
			c = { ia: a };
		(function(d) {
			if ("object" === typeof a && "undefined" !== typeof c) c.ia = d();
			else {
				var e; "undefined" !== typeof window ? e = window : "undefined" !== typeof global ? e = global : "undefined" !== typeof self ? e = self : e = this;
				e.hp = d() } })(function() {
			return function e(a, c, h) {
				...
				1: [function(a, c) {
					...
					function h(a) {
						for (var c = a.length, e = [], f = 0, g, h; f < c; f++) {
							...
							if (55295 < g && 57344 > g)
								if (h)
									if (56320 >
										g) { e.push(239, 191, 189);
										h = g;
										continue } else g = h - 55296 << 10 | g - 56320 | 65536, h = null;
							else { 56319 < g || f + 1 === c ? e.push(239, 191, 189) : h = g;
								continue } else h && (e.push(239, 191, 189), h = null);
					...
					m = {
						...
						jg: function(a, c) { c = c || 0;
							for (var e = 0; e < this.length; e++) a[c + e] = this[e] }
					};
					m.ki = m.Pf;
					g.byteLength = function(a) { n = a;
						p = h(a);
						return p.length };
				...
				2: [function(a, c) {
					(function(g) {
						function h(a) { this.Gb = k.isBuffer(a) ? a : new k(a || 0);
							this.ca = 0;
						...
						h.prototype = {
							...
							bo: function() {
								var a = this.ca,
									c = this.Ba();
								if (c < m) return c;
								for (var e = this.ca - 2; 255 === this.Gb[e];) e--;
								e < a && (e = a);
								for (var f = c = 0; f < e - a + 1; f++) var g = ~this.Gb[a + f] & 127,
							...
							Eo: function(a) {
								...
								else if (a === h.b) this.ca = this.Ba() + this.ca;
	...
	(function() {
		...
		(function(d) {
			...
			return function e(a, c, h) {
				...
				1: [function(a, c) { c.ia.Mi = a("./lib/vectortile.js");
					c.ia.bp = a("./lib/vectortilefeature.js");
					c.ia.cp = a("./lib/vectortilelayer.js") }, { "./lib/vectortile.js": 2, "./lib/vectortilefeature.js": 3, "./lib/vectortilelayer.js": 4 }],
				2: [function(a, c) {
					function g(a, c, e) { 3 === a && (a = new h(e, e.Ba() + e.ca), a.length && (c[a.name] = a)) }
				...
				3: [function(a, c) {
					function g(a, c, e, f, g) { this.properties = {};
						this.extent = e;
						this.type = 0;
						this.pc = a;
						this.Ne = -1;
					...
					function h(a, c, e) {
						if (1 == a) c.fp = e.Ba();
							...
							for (a = e.Ba() + e.ca; e.ca < a;) {
								var f = c.Kd[e.Ba()],
									g = c.Md[e.Ba()];
								c.properties[f] = g } else 3 == a ? c.type = e.Ba() : 4 == a && (c.Ne = e.ca) }
					...
					g.prototype.Lg = function() {
						...
						a.ca = this.Ne;
						for (var c = a.Ba() +
								a.ca, e = 1, f = 0, g = 0, h = 0, v = [], w; a.ca < c;)
							if (f || (f = a.Ba(), e = f & 7, f = f >> 3), f--, 1 === e || 2 === e) g += a.Ad(), h += a.Ad(), 1 === e && (w && v.push(w), w = []), w.push(new k(g, h));
					...
					g.prototype.bbox = function() {
						var a = this.pc;
						a.ca = this.Ne;
						for (var c = a.Ba() + a.ca, e = 1, f = 0, g = 0, h = 0, k = Infinity, w = -Infinity, z = Infinity, C = -Infinity; a.ca < c;)
							if (f || (f = a.Ba(), e = f & 7, f = f >> 3), f--, 1 === e || 2 === e) g += a.Ad(), h += a.Ad(), g < k && (k = g), g > w && (w = g), h < z && (z = h), h > C &&
								(C = h);
				...
				4: [function(a, c) {
					...
					function h(a, c, e) { 15 === a ? c.version = e.Ba() : 1 === a ? c.name = e.Hf() : 5 === a ? c.extent = e.Ba() : 2 === a ? c.Jd.push(e.ca) : 3 === a ? c.Kd.push(e.Hf()) : 4 === a && c.Md.push(k(e)) }

					function k(a) {
						for (var c = null, e = a.Ba() + a.ca; a.ca < e;) c = a.Ba() >> 3, c = 1 === c ? a.Hf() :
							2 === c ? a.Rn() : 3 === c ? a.Nn() : 4 === c ? a.bo() : 5 === c ? a.Ba() : 6 === c ? a.Ad() : 7 === c ? a.Ln() : null;
						return c
					}
					var m = a("./vectortilefeature.js");
					c.ia = g;
					g.prototype.feature = function(a) {
						if (0 > a || a >= this.Jd.length) throw Error("feature index out of bounds");
						this.pc.ca = this.Jd[a];
						a = this.pc.Ba() + this.pc.ca;
						return new m(this.pc, a, this.extent, this.Kd, this.Md) }
				}, { "./vectortilefeature.js": 3 }],
				5: [function(a, c) {
					function g(a, c) { this.x = a;
						this.y = c }
					c.ia = g;
					g.prototype = {
						clone: function() {
						...
						Yi: function(a) {
							...
							this.y = e;
							return this },
						Zi: function() { this.x = Math.round(this.x);
							this.y = Math.round(this.y);
							return this }
					};
					g.b = function(a) {
	...
	function ht(a) { this.defaultDataProjection = null;
		a = a ? a : {};
		this.defaultDataProjection = new nd({ code: "", units: "tile-pixels" });
				...
				for (var n = 0, p = h.length; n < p; ++n) {
					if (g === Bl) {
						...
						if (0 === z) z = null;
							...
							C.ba("XY", w, r);
							z = C }(v = gp(z, !1, fp(this, v))) && (t[this.g] = v);
						k.C(t);
						k.Bc(this.g)
					}
					f.push(k)
	...
	ht.prototype.Qa = function() {
		return this.defaultDataProjection };
	ht.prototype.c = function(a) { this.f = a };
	...
	function jt() { this.defaultDataProjection = null;
		this.defaultDataProjection = qd("EPSG:4326") }
	y(jt, Ip);

	function kt(a, c) { c[c.length - 1].Ed[a.getAttribute("k")] = a.getAttribute("v") }
	var lt = [null],
		mt = Q(lt, { nd: function(a, c) { c[c.length - 1].Qc.push(a.getAttribute("ref")) }, tag: kt }),
		ot = Q(lt, {
			node: function(a, c) {
				var d = c[0],
					e = c[c.length - 1],
			...
			way: function(a, c) {
				for (var d = c[0], e = a.getAttribute("id"), f = R({ Qc: [], Ed: {} }, mt, a, c), g = c[c.length - 1], h = [], k = 0, m = f.Qc.length; k < m; k++) Ya(h, g.Og[f.Qc[k]]);
	...
	jt.prototype.ic = function(a, c) {
		var d = ep(this, a, c);
		return "osm" == a.localName && (d = R({ Og: {}, features: [] }, ot, a, [d]), d.features) ? d.features : [] };
	...
	var tt = [null, "http://www.opengis.net/ows/1.1"],
		st = Q(tt, { ServiceIdentification: N(function(a, c) {
				return R({}, ut, a, c) }), ServiceProvider: N(function(a, c) {
				return R({}, vt, a, c) }), OperationsMetadata: N(function(a, c) {
				return R({}, wt, a, c) }) }),
		xt = Q(tt, { DeliveryPoint: N(W), City: N(W), AdministrativeArea: N(W), PostalCode: N(W), Country: N(W), ElectronicMailAddress: N(W) }),
		...
		Dt = Q(tt, { HTTP: N(function(a, c) {
				return R({}, Ct, a, c) }) }),
		Ct = Q(tt, { Get: Gm(function(a, c) {
				var d = pt(a);
				return d ? R({ href: d }, Et, a, c) : void 0 }), Post: void 0 }),
		...
		wt = Q(tt, { Operation: function(a, c) {
				var d = a.getAttribute("name"),
					e = R({}, Ft, a, c);
				e && (c[c.length - 1][d] = e) } }),
		At = Q(tt, { Voice: N(W), Facsimile: N(W) }),
		Et = Q(tt, { Constraint: Gm(function(a, c) {
				var d = a.getAttribute("name");
				return d ? R({ name: d }, zt, a, c) : void 0 }) }),
		Gt = Q(tt, { IndividualName: N(W), PositionName: N(W), ContactInfo: N(function(a, c) {
				return R({}, Bt, a, c) }) }),
		ut = Q(tt, { Title: N(W), ServiceTypeVersion: N(W), ServiceType: N(W) }),
		vt = Q(tt, { ProviderName: N(W), ProviderSite: N(pt), ServiceContact: N(function(a, c) {
				return R({}, Gt, a, c) }) });
	...
	l.Gd = function(a, c) { a = gp(a, !0, fp(this, c));
		var d = a.ga(),
			e = a.qa();
		Ht(d, d.length, e, d);
	...
	function Pt(a, c, d, e, f) { a = a.geometries;
		var g = [],
			h, k;
		h = 0;
		for (k = a.length; h < k; ++h) g[h] = Qt(a[h], c, d, e, f);
		return g }
		...
		if ("Topology" == a.type) {
			...
			if (d) { d = e;
				...
				for (m = g.length; k < m; ++k)
					for (var n = g[k], p = d, q = h, r = 0, t = 0, v = void 0, w = void 0, z = void 0, w = 0, z = n.length; w < z; ++w) v = n[w], r += v[0], t += v[1], v[0] = r, v[1] = t, St(v, p, q) }
			d = [];
			h = ob(a.objects);
			k = 0;
			for (m = h.length; k < m; ++k) "GeometryCollection" === h[k].type ? (n = h[k], d.push.apply(d, Pt(n, g, e, f, c))) : (n = h[k], d.push(Qt(n, g, e, f, c)));
			return d }
		return [] };

	function St(a, c, d) { a[0] = a[0] * c[0] + d[0];
		a[1] = a[1] * c[1] + d[1] }
	Nt.prototype.Qa = function() {
		return this.defaultDataProjection };
	var Rt = {
		Point: function(a, c, d) { a = a.coordinates;
			c && d && St(a, c, d);
			return new E(a) },
		...
		Polygon: function(a, c) {
			var d = [],
				e, f;
			e = 0;
			for (f = a.arcs.length; e < f; ++e) d[e] = Ot(a.arcs[e], c);
			return new F(d) },
		MultiPoint: function(a, c, d) { a = a.coordinates;
			var e, f;
			if (c && d)
		...
		MultiPolygon: function(a, c) {
			var d = [],
				e, f, g, h, k, m;
			k = 0;
			for (m = a.arcs.length; k < m; ++k) { e = a.arcs[k];
				f = [];
				g = 0;
	...
	Tt.prototype.ic = function(a, c) {
		var d = { featureType: this.c, featureNS: this.g };
		mb(d, ep(this, a, c ? c : {}));
		d = [d];
	...
	Tt.prototype.j = function(a) {
		if (pm(a)) return Ut(a);
		if (sm(a)) return R({}, Vt, a, []);
		if ("string" === typeof a) return a = Cm(a), Ut(a) };
	Tt.prototype.i = function(a) {
		if (pm(a)) return Wt(this, a);
		if (sm(a)) return Xt(this, a);
		if ("string" === typeof a) return a = Cm(a), Wt(this, a) };

	function Wt(a, c) {
		for (var d = c.firstChild; d; d = d.nextSibling)
			if (1 == d.nodeType) return Xt(a, d) }
	...
	function Xt(a, c) {
		...
		return R(d, Yt, c, [], a.b) }
	var Zt = { "http://www.opengis.net/wfs": { totalInserted: N(Sp), totalUpdated: N(Sp), totalDeleted: N(Sp) } },
		$t = { "http://www.opengis.net/ogc": { FeatureId: Em(function(a) {
					return a.getAttribute("fid") }) } },
		au = { "http://www.opengis.net/wfs": { Feature: function(a, c) { Mm($t, a, c) } } },
		Vt = { "http://www.opengis.net/wfs": { TransactionSummary: N(function(a, c) {
					return R({}, Zt, a, c) }, "transactionSummary"), InsertResults: N(function(a, c) {
					return R([], au, a, c) }, "insertIds") } };

	function Ut(a) {
		for (a = a.firstChild; a; a = a.nextSibling)
			if (1 == a.nodeType) return R({}, Vt, a, []) }
	...
	var du = {
			"http://www.opengis.net/wfs": {
				...
				Property: O(function(a, c, d) {
					...
					a.appendChild(e);
					Vp(e, c.name);
					void 0 !== c.value && null !== c.value && (e = hm("http://www.opengis.net/wfs", "Value"), a.appendChild(e), c.value instanceof Md ? Zp.prototype.Ie(e,
						c.value, d) : Vp(e, c.value))
				}),
				Native: O(function(a, c) { c.Lo && a.setAttribute("vendorId", c.Lo);
	...
	Tt.prototype.l = function(a) {
		...
		Bm(c, "http://www.w3.org/2001/XMLSchema-instance",
			"xsi:schemaLocation", this.f);
		var d = a.featureTypes;
		a = [{ node: c, srsName: a.srsName, featureNS: a.featureNS ? a.featureNS : this.g, featurePrefix: a.featurePrefix, geometryName: a.geometryName, bbox: a.bbox, propertyNames: a.propertyNames ? a.propertyNames : [] }];
	...
	Tt.prototype.A = function(a, c, d, e) {
		...
		a && (k = { node: g, featureNS: e.featureNS, featureType: e.featureType, featurePrefix: e.featurePrefix }, mb(k, h), Nm(k, du, Im("Insert"), a, f));
		c && (k = {
			node: g,
		...
		d && Nm({ node: g, featureNS: e.featureNS, featureType: e.featureType, featurePrefix: e.featurePrefix }, du, Im("Delete"), d, f);
		e.nativeElements && Nm({ node: g, featureNS: e.featureNS, featureType: e.featureType, featurePrefix: e.featurePrefix }, du, Im("Native"), e.nativeElements, f);
		return g
	};
	Tt.prototype.Gf = function(a) {
		for (a = a.firstChild; a; a = a.nextSibling)
			if (1 == a.nodeType) return this.Be(a);
		return null };
	...
	function iu(a) {
		var c = [];
		a = a.Vd();
		for (var d = 0, e = a.length; d < e; ++d) c.push("(" + hu(a[d]) + ")");
		return c.join(",") }
	...
	var ku = { Point: gu, LineString: hu, Polygon: iu, MultiPoint: function(a) {
			var c = [];
			a = a.ke();
			for (var d = 0, e = a.length; d < e; ++d) c.push("(" + gu(a[d]) + ")");
			return c.join(",") }, MultiLineString: function(a) {
			var c = [];
			a = a.rd();
			for (var d = 0, e = a.length; d < e; ++d) c.push("(" + hu(a[d]) + ")");
			return c.join(",") }, MultiPolygon: function(a) {
			var c = [];
			a = a.Wd();
			for (var d = 0, e = a.length; d < e; ++d) c.push("(" + iu(a[d]) + ")");
			return c.join(",") }, GeometryCollection: function(a) {
			var c = [];
			a = a.vg();
			for (var d = 0, e = a.length; d < e; ++d) c.push(ju(a[d]));
			return c.join(",") } };
	l = fu.prototype;
	l.xd = function(a, c) {
		var d = this.zd(a, c);
	...
	l.Bf = function(a, c) {
		...
		for (var f = [], g = 0, h = d.length; g < h; ++g) e = new Xl, e.Pa(d[g]), f.push(e);
		return f };
	l.zd = function(a, c) {
		var d;
		d = new lu(new mu(a));
	...
	l.Ge = function(a, c) {
		...
		return d ? this.Gd(d, c) : "" };
	l.ii = function(a, c) {
		if (1 == a.length) return this.Ge(a[0], c);
		for (var d = [], e = 0, f = a.length; e < f; ++e) d.push(a[e].X());
		d = new zp(d);
		return this.Gd(d, c) };
	l.Gd = function(a, c) {
		return ju(gp(a, !0, c)) };
	...
	function nu(a) {
		var c = a.a.charAt(++a.b),
			d = { position: a.b, value: c };
		if ("(" == c) d.type = 2;
		else if ("," == c) d.type = 5;
		else if (")" == c) d.type = 3;
		else if (pu(c) || "-" == c) { d.type = 4;
			var e, c = a.b,
				f = !1,
				g = !1;
			do {
				...
				e = a.a.charAt(++a.b) } while (pu(e, f) || !g && ("e" == e || "E" == e) || g && ("-" == e || "+" == e));
			a = parseFloat(a.a.substring(c, a.b--));
			d.value = a } else if ("a" <= c && "z" >= c || "A" <= c && "Z" >= c) {
			d.type = 1;
			c = a.b;
	...
	l = lu.prototype;
	l.match = function(a) {
		if (a = this.b.type == a) this.b = nu(this.a);
		return a };
	...
	function ou(a) {
		...
		if (a.match(1)) {
			var d = c.value;
			if ("GEOMETRYCOLLECTION" == d) { a: {
					if (a.match(2)) { c = [];
						do c.push(ou(a)); while (a.match(5));
						if (a.match(3)) { a = c;
							break a } } else if (qu(a)) { a = [];
						break a }
					throw Error(ru(a)); }
				return new zp(a) }
			var e = su[d],
	...
	l.vf = function() {
		if (this.match(2)) {
			var a = uu(this);
			if (this.match(3)) return a } else if (qu(this)) return null;
		throw Error(ru(this)); };
	l.uf = function() {
		if (this.match(2)) {
			var a = vu(this);
			if (this.match(3)) return a } else if (qu(this)) return [];
		throw Error(ru(this)); };
	l.wf = function() {
		if (this.match(2)) {
			var a = wu(this);
	...
	l.yn = function() {
		if (this.match(2)) {
			var a;
			if (2 == this.b.type)
				for (a = [this.vf()]; this.match(5);) a.push(this.vf());
			else a = vu(this);
			if (this.match(3)) return a } else if (qu(this)) return [];
		throw Error(ru(this)); };
	l.xn = function() {
	...
	l.zn = function() {
		if (this.match(2)) {
			for (var a = [this.wf()]; this.match(5);) a.push(this.wf());
			if (this.match(3)) return a } else if (qu(this)) return [];
		throw Error(ru(this)); };
	...
	function vu(a) {
		for (var c = [uu(a)]; a.match(5);) c.push(uu(a));
		return c }

	function wu(a) {
		for (var c = [a.uf()]; a.match(5);) c.push(a.uf());
		return c }
	...
	var tu = { POINT: E, LINESTRING: T, POLYGON: F, MULTIPOINT: pp, MULTILINESTRING: U, MULTIPOLYGON: V },
		su = { POINT: lu.prototype.vf, LINESTRING: lu.prototype.uf, POLYGON: lu.prototype.wf, MULTIPOINT: lu.prototype.yn, MULTILINESTRING: lu.prototype.xn, MULTIPOLYGON: lu.prototype.zn };

	function xu() { this.version = void 0 }
	y(xu, qt);
	xu.prototype.a = function(a) {
		for (a = a.firstChild; a; a = a.nextSibling)
			if (1 == a.nodeType) return this.b(a);
		return null };
	xu.prototype.b = function(a) { this.version = a.getAttribute("version").trim();
	...
	var Gu = [null, "http://www.opengis.net/wms"],
		yu = Q(Gu, { Service: N(function(a, c) {
				return R({}, Hu, a, c) }), Capability: N(function(a, c) {
				return R({}, Iu, a, c) }) }),
		Iu = Q(Gu, { Request: N(function(a, c) {
				return R({}, Ju, a, c) }), Exception: N(function(a, c) {
				return R([], Ku, a, c) }), Layer: N(function(a, c) {
				return R({}, Lu, a, c) }) }),
		Hu = Q(Gu, {
			Name: N(W),
			Title: N(W),
		...
		Mu = Q(Gu, { ContactPersonPrimary: N(function(a, c) {
				return R({}, Nu, a, c) }), ContactPosition: N(W), ContactAddress: N(function(a, c) {
				return R({}, Ou, a, c) }), ContactVoiceTelephone: N(W), ContactFacsimileTelephone: N(W), ContactElectronicMailAddress: N(W) }),
		Nu = Q(Gu, { ContactPerson: N(W), ContactOrganization: N(W) }),
		Ou = Q(Gu, { AddressType: N(W), Address: N(W), City: N(W), StateOrProvince: N(W), PostCode: N(W), Country: N(W) }),
		Ku = Q(Gu, { Format: Em(W) }),
		Lu = Q(Gu, {
			Name: N(W),
			Title: N(W),
			...
			Layer: Gm(function(a, c) {
				...
				if (e) {
					...
					e.fixedHeight = f;
					["Style", "CRS", "AuthorityURL"].forEach(function(a) { a in d && (e[a] = (e[a] || []).concat(d[a])) });
					"EX_GeographicBoundingBox BoundingBox Dimension Attribution MinScaleDenominator MaxScaleDenominator".split(" ").forEach(function(a) { a in e || (e[a] = d[a]) });
					return e
				}
			})
		}),
		Qu = Q(Gu, { Title: N(W), OnlineResource: N(pt), LogoURL: N(Du) }),
		Pu = Q(Gu, {
		...
		Ju = Q(Gu, { GetCapabilities: N(Bu), GetMap: N(Bu), GetFeatureInfo: N(Bu) }),
		Cu = Q(Gu, { Format: Gm(W), DCPType: Gm(function(a, c) {
				return R({}, Su, a, c) }) }),
		Su = Q(Gu, { HTTP: N(function(a, c) {
				return R({}, Tu, a, c) }) }),
		Tu = Q(Gu, { Get: N(zu), Post: N(zu) }),
		Ru = Q(Gu, { Name: N(W), Title: N(W), Abstract: N(W), LegendURL: Gm(Du), StyleSheetURL: N(zu), StyleURL: N(zu) }),
		Au = Q(Gu, { Format: N(W), OnlineResource: N(pt) }),
	...
	function Vu() { this.g = new rt }
	y(Vu, qt);
	Vu.prototype.a = function(a) {
		for (a = a.firstChild; a; a = a.nextSibling)
			if (1 == a.nodeType) return this.b(a);
		return null };
	Vu.prototype.b = function(a) { this.version = a.getAttribute("version").trim();
		var c = this.g.b(a);
		if (!c) return null;
	...
	var Yu = [null, "http://www.opengis.net/wmts/1.0"],
		...
		Wu = Q(Yu, { Contents: N(function(a, c) {
				return R({}, $u, a, c) }) }),
		$u = Q(Yu, { Layer: Gm(function(a, c) {
				return R({}, av, a, c) }), TileMatrixSet: Gm(function(a, c) {
				return R({}, bv, a, c) }) }),
		av = Q(Yu, {
			Style: Gm(function(a, c) {
				var d = R({}, cv, a, c);
			...
			ResourceURL: Gm(function(a) {
				...
				a && (e.resourceType = a);
				return e })
		}, Q(Zu, { Title: N(W), Abstract: N(W), WGS84BoundingBox: N(function(a, c) {
				var d = R([], fv, a, c);
				return 2 != d.length ? void 0 : xc(d) }), Identifier: N(W) })),
		cv = Q(Yu, { LegendURL: Gm(function(a) {
				var c = {};
				c.format = a.getAttribute("format");
				c.href = pt(a);
				return c }) }, Q(Zu, { Title: N(W), Identifier: N(W) })),
		dv = Q(Yu, { TileMatrixSet: N(W) }),
		ev = Q(Yu, { Default: N(W), Value: Gm(W) }, Q(Zu, { Identifier: N(W) })),
		fv = Q(Zu, { LowerCorner: Em(Xu), UpperCorner: Em(Xu) }),
		bv = Q(Yu, { WellKnownScaleSet: N(W), TileMatrix: Gm(function(a, c) {
				return R({}, gv, a, c) }) }, Q(Zu, { SupportedCRS: N(W), Identifier: N(W) })),
		gv = Q(Yu, { TopLeftCorner: N(Xu), ScaleDenominator: N(Qp), TileWidth: N(Sp), TileHeight: N(Sp), MatrixWidth: N(Sp), MatrixHeight: N(Sp) }, Q(Zu, { Identifier: N(W) }));

	function hv(a) { Mb.call(this);
		a = a || {};
		this.a = null;
		this.c = Jd;
		this.f = void 0;
	...
	l.Sg = function(a) { this.set("projection", a) };
	l.ge = function(a) { this.set("tracking", a) };
	l.$h = function(a) { this.set("trackingOptions", a) };

	function iv(a, c, d) { Od.call(this);
		this.Lf(a, c ? c : 0, d) }
	y(iv, Od);
	l = iv.prototype;
	l.clone = function() {
	...
	l.sb = function(a, c, d, e) {
		...
		if (c < e) {
			if (0 === c)
				...
				for (e = this.nf() / Math.sqrt(c), d[0] = f[0] + e * a, d[1] = f[1] + e * g, e = 2; e < this.a; ++e) d[e] = f[e];
			d.length = this.a;
			return c }
		return e };
	l.xc = function(a, c) {
	...
	l.Lf = function(a, c, d) {
		if (a) { Rd(this, d, a, 0);
			...
			d.length = a } else Qd(this, "XY", null);
		this.u() };
	l.Ll = function(a) { this.v[this.a] = this.v[0] + a;
		this.u() };

	function kv(a, c, d) {
		for (var e = [], f = a(0), g = a(1), h = c(f), k = c(g), m = [g, f], n = [k, h], p = [1, 0], q = {}, r = 1E5, t, v, w, z, C; 0 < --r && 0 < p.length;) w = p.pop(), f = m.pop(), h = n.pop(), g = w.toString(), g in q || (e.push(h[0], h[1]), q[g] = !0), z = p.pop(), g = m.pop(), k = n.pop(), C = (w + z) / 2, t = a(C), v = c(t), Oa(v[0], v[1], h[0], h[1], k[0], k[1]) < d ? (e.push(k[0], k[1]), g = z.toString(), q[g] = !0) : (p.push(z, C, C, w), n.push(k, v, v, h), m.push(g, t, t, f));
		return e }

	function lv(a, c, d, e, f) {
		var g = qd("EPSG:4326");
		return kv(function(e) {
			return [a, c + (d - c) * e] }, Id(g, e), f) }

	function mv(a, c, d, e, f) {
		var g = qd("EPSG:4326");
		return kv(function(e) {
			return [c + (d - c) * e, a] }, Id(g, e), f) };
	...
	l.Hg = function(a) {
		...
		if (!this.c || !Hd(this.c, g)) {
			...
			this.c = g }
		k = 0;
		g.b && (g = g.G(), k = Wc(g), d = d.focus[0], d < g[0] || d > g[2]) && (k *= Math.ceil((g[0] - d) / k), e = [e[0] +
			k, e[1], e[2] + k, e[3]
		]);
		d = this.s[0];
		g = this.s[1];
		...
		r = [];
		h = 0;
		for (m = pv.length; h < m; ++h) { t = pv[h] / 2;
			q[0] = d - t;
			q[1] = g - t;
			r[0] = d + t;
			r[1] = g + t;
		...
		if (-1 == h) this.b.length = this.a.length = 0;
			...
			for (k = 0; q != this.f && k++ < g;) q = Math.max(q - h, this.f), m = qv(this, q, r, n, a, e, m);
			q = Ma(f, this.f, this.g);
			for (k = 0; q != this.g && k++ < g;) q = Math.min(q + h, this.g), m = qv(this, q, r, n, a, e, m);
			this.b.length = m;
			d = Math.floor(d / h) * h;
			f = Ma(d, this.j, this.i);
			m = rv(this, f, a, e, 0);
			for (k = 0; f != this.j && k++ < g;) f = Math.max(f - h, this.j), m = rv(this, f, a, e, m);
			f = Ma(d, this.j, this.i);
			for (k = 0; f != this.i && k++ < g;) f = Math.min(f + h, this.i), m = rv(this, f, a, e, m);
			this.a.length = m
		}
		c.hb(null, this.ta);
		a = 0;
		for (f = this.b.length; a < f; ++a) h =
			this.b[a], c.Xb(h, null);
		a = 0;
		for (f = this.a.length; a < f; ++a) h = this.a[a], c.Xb(h, null)
	};
	l.setMap = function(a) { this.l && (this.l.K("postcompose", this.Hg, this), this.l.render());
		a && (a.I("postcompose", this.Hg, this), a.render());
		this.l = a };

	function sv(a, c, d, e, f, g, h) { Hi.call(this, a, c, d, 0, e);
		this.l = f;
		this.g = new Image;
	...
	sv.prototype.a = function(a) {
		if (void 0 !== a) {
			...
			return this.i[a] = c }
		return this.g };
	sv.prototype.s = function() { this.state = 3;
		this.c.forEach(sb);
		this.c = null;
		Ii(this) };
	sv.prototype.A = function() { void 0 === this.resolution && (this.resolution = Xc(this.extent) / this.g.height);
		this.state = 2;
		this.c.forEach(sb);
		this.c = null;
		Ii(this) };
	sv.prototype.load = function() { 0 == this.state && (this.state = 1, Ii(this), this.c = [xb(this.g, "error", this.s, this), xb(this.g, "load", this.A, this)], this.j(this, this.l)) };

	function tv(a, c, d, e, f) { pg.call(this, a, c);
		this.l = d;
		this.g = new Image;
	...
	y(tv, pg);
	l = tv.prototype;
	l.fa = function() { 1 == this.state && uv(this);
		this.a && Db(this.a);
		tv.ha.fa.call(this) };
	l.cb = function(a) {
		if (void 0 !== a) {
	...
	l.eb = function() {
		return this.l };
	l.sl = function() { this.state = 3;
		uv(this);
		qg(this) };
	l.tl = function() { this.state = this.g.naturalWidth && this.g.naturalHeight ? 2 : 4;
		uv(this);
		qg(this) };
	l.load = function() { 0 == this.state && (this.state = 1, qg(this), this.j = [xb(this.g, "error", this.sl, this), xb(this.g, "load", this.tl, this)], this.o(this, this.l)) };

	function uv(a) { a.j.forEach(sb);
		a.j = null };
	...
	function wv(a) { a = a.dataTransfer.files;
		var c, d, e;
		c = 0;
		for (d = a.length; c < d; ++c) { e = a.item(c);
			var f = new FileReader;
			f.addEventListener("load", qa(this.l, e).bind(this));
			f.readAsText(e) } }

	function xv(a) { a.stopPropagation();
		a.preventDefault();
	...
	vv.prototype.l = function(a, c) {
		...
		for (k = e.length; h < k; ++h) {
			...
			try { g = m.Ea(d, n) } catch (p) { g = null }
			if (g && 0 < g.length) break }
		this.b(new yv(zv, this, a, g, f)) };
	vv.prototype.setMap = function(a) { this.a && (this.a.forEach(sb), this.a = null);
	...
	function yv(a, c, d, e, f) { Eb.call(this, a, c);
		this.features = e;
		this.file = d;
		this.projection = f }
	y(yv, Eb);

	function Av(a, c) { this.x = a;
		this.y = c }
	y(Av, wf);
	...
	function Bv(a) { a = a ? a : {};
		Bj.call(this, { handleDownEvent: Cv, handleDragEvent: Dv, handleUpEvent: Ev });
	...
	function Fv(a, c) { Eb.call(this, a);
		this.feature = c }
	y(Fv, Eb);

	function Gv(a) {
		Bj.call(this, { handleDownEvent: Hv, handleEvent: Iv, handleUpEvent: Jv });
		this.wa = null;
		this.U = !1;
		...
		if (!c)
			if ("Circle" === this.aa) c = function(a, c) {
		...
		this.na = new H({ source: new bn({ useSpatialIndex: !1, wrapX: a.wrapX ? a.wrapX : !1 }), style: a.style ? a.style : Ov() });
	...
	function Ov() {
		...
		return function(c) {
			return a[c.X().W()] } }
	l = Gv.prototype;
	l.setMap = function(a) { Gv.ha.setMap.call(this, a);
		this.ei() };
	...
	function Hv(a) {
		if (this.ti(a)) return this.wa = a.pixel, !0;
		if (this.c !== Nv && this.c !== Lv || !this.oa(a)) return !1;
		this.wa = a.pixel;
		this.U = !0;
		this.s || Rv(this, a);
		return !0 }

	function Jv(a) { this.U = !1;
		var c = this.wa,
			d = a.pixel,
			e = c[0] - d[0],
			c = c[1] - d[1],
	...
	function Qv(a, c) {
		if (a.s) {
			...
			Uv(a) } else d = c.coordinate.slice(), a.H ? a.H.X().la(d) : (a.H = new Xl(new E(d)), Uv(a));
		return !0 }
			...
			if (e)
				for (var e = c.map, g = 0, h = f.length; g < h; g++) {
					var k = f[g],
						...
						m = n[1] - m[1],
						n = a.U && a.oa(c) ? 1 : a.aj;
					if (d = Math.sqrt(d * d + m * m) <= n) { a.s = k;
						break } } }
		return d }
	...
	function Rv(a, c) {
		var d = c.coordinate;
		a.s = d;
		a.c === Mv ? a.a = d.slice() : a.c === Lv ? (a.a = [
			[d.slice(), d.slice()]
		], a.S = a.a[0]) : (a.a = [d.slice(), d.slice()], a.c === Sv && (a.S = a.a));
	...
	function Pv(a, c) {
		var d = c.coordinate,
			e = a.o.X(),
			f, g;
		if (a.c === Nv) a.s = d.slice(), g = a.a, g.push(d.slice()), f = g.length > a.ya, a.D(g, e);
		else if (a.c === Lv) { g = a.a[0];
			g.push(d.slice());
			if (f = g.length > a.ya) a.s = g[0];
			a.D(a.a, e) }
		Uv(a);
		f && a.md() }
	l.ho = function() {
	...
	l.md = function() {
		var a = Vv(this),
			c = this.a,
			d = a.X();
		this.c === Nv ? (c.pop(), this.D(c, d)) : this.c === Lv && (c[0].pop(), c[0].push(c[0][0]), this.D(c, d)); "MultiPoint" === this.aa ? a.Pa(new pp([c])) : "MultiLineString" === this.aa ? a.Pa(new U([c])) : "MultiPolygon" === this.aa && a.Pa(new V([c]));
		this.b(new Fv("drawend", a));
		this.Fb && this.Fb.push(a);
		this.oc && this.oc.rb(a) };

	function Vv(a) { a.s = null;
		var c = a.o;
	...
	function Kv(a) {
		var c; "Point" === a || "MultiPoint" === a ? c = Mv : "LineString" === a || "MultiLineString" === a ? c = Nv : "Polygon" === a || "MultiPolygon" === a ? c = Lv : "Circle" === a && (c = Sv);
		return c }
	var Mv = "Point",
		Nv = "LineString",
		Lv = "Polygon",
	...
	function Wv(a, c, d) { Eb.call(this, a);
		this.features = c;
		this.mapBrowserPointerEvent = d }
	y(Wv, Eb);

	function Xv(a) {
		Bj.call(this, { handleDownEvent: Yv, handleDragEvent: Zv, handleEvent: $v, handleUpEvent: aw });
		...
		this.s = this.na = !1;
		this.o = null;
		this.S = new H({ source: new bn({ useSpatialIndex: !1, wrapX: !!a.wrapX }), style: a.style ? a.style : bw(), updateWhileAnimating: !0, updateWhileInteracting: !0 });
		this.aa = {
			Point: this.Zl,
			LineString: this.Zg,
			LinearRing: this.Zg,
	...
	function dw(a, c) { a.D || (a.D = !0, a.b(new Wv("modifystart", a.B, c))) }

	function ew(a, c) { fw(a, c);
	...
	function fw(a, c) {
		var d = a.a,
			e = [];
		d.forEach(function(a) { c === a.feature && e.push(a) });
		for (var f = e.length - 1; 0 <= f; --f) d.remove(e[f]) }
	l.setMap = function(a) { this.S.setMap(a);
		Xv.ha.setMap.call(this, a) };
	l.Tl = function(a) { this.pf(a.element) };
	l.Yg = function(a) { this.s || (a = a.target, ew(this, a), this.pf(a)) };
	l.Ul = function(a) { ew(this, a.element) };
	l.Zl = function(a, c) {
		var d = c.Y(),
			d = { feature: a, geometry: c, ka: [d, d] };
		this.a.za(c.G(), d) };
	l.Xl = function(a, c) {
		var d = c.Y(),
			e, f, g;
		f = 0;
		for (g = d.length; f < g; ++f) e = d[f], e = { feature: a, geometry: c, depth: [f], index: f, ka: [e, e] }, this.a.za(c.G(), e) };
	l.Zg = function(a, c) {
		var d = c.Y(),
			e, f, g, h;
		e = 0;
		for (f = d.length - 1; e < f; ++e) g = d.slice(e, e + 2), h = { feature: a, geometry: c, index: e, ka: g }, this.a.za(xc(g), h) };
	l.Wl = function(a, c) {
		var d = c.Y(),
			e, f, g, h, k, m, n;
		h = 0;
	...
	l.Yl = function(a, c) {
		...
		for (n = d.length; m < n; ++m)
			for (p = d[m], h = 0, k = p.length; h < k; ++h)
				for (e = p[h], f = 0, g = e.length - 1; f < g; ++f) q = e.slice(f, f + 2), r = { feature: a, geometry: c, depth: [h, m], index: f, ka: q }, this.a.za(xc(q), r) };
	l.Vl = function(a, c) {
		var d, e = c.i;
		for (d = 0; d < e.length; ++d) this.aa[e[d].W()].call(this, a, e[d]) };
	...
	function Yv(a) {
		...
		if (c) {
			...
			for (var g = 0, h = e.length; g < h; ++g) {
				...
				p && (n += "-" + p.join("-"));
				f[n] || (f[n] = Array(2));
				if (fc(m[0], c) && !f[n][0]) this.o.push([k, 0]), f[n][0] = k;
				else if (fc(m[1], c) && !f[n][1]) {
					if ("LineString" !== k.geometry.W() && "MultiLineString" !== k.geometry.W() || !f[n][0] || 0 !== f[n][0].index) this.o.push([k, 1]), f[n][1] = k } else x(m) in this.oa && !f[n][0] &&
					!f[n][1] && d.push([k, c])
			}
			d.length && dw(this, a);
			for (a = d.length - 1; 0 <= a; --a) this.Rk.apply(this, d[a])
		}
		return !!this.c
	}
	...
	function Zv(a) {
		...
		dw(this, a);
		a = a.coordinate;
		for (var c = 0, d = this.o.length; c < d; ++c) {
			for (var e = this.o[c], f = e[0], g = f.depth, h = f.geometry, k = h.Y(), m = f.ka, e = e[1]; a.length < h.qa();) a.push(0);
			switch (h.W()) {
				case "Point":
					k = a;
					m[0] = m[1] = a;
	...
	function aw(a) {
		for (var c, d = this.o.length - 1; 0 <= d; --d) c = this.o[d][0], Xm(this.a, xc(c.ka), c);
		...
		if (this.c && this.ya(a))
			if (a.type == ti && this.U) c = !0;
				...
				for (k = c.length - 1; 0 <= k; --k)
					if (g = c[k], p = g[0], h = p.geometry, f = h.Y(), q = x(p.feature), p.depth && (q += "-" + p.depth.join("-")), n = e = m = void 0, 0 === g[1] ? (e = p, m = p.index) : 1 == g[1] && (n = p, m = p.index + 1), q in d || (d[q] = [n, e, m]), g = d[q], void 0 !== n && (g[0] = n), void 0 !== e && (g[1] = e),
						...
						q && (this.a.remove(g[0]), this.a.remove(g[1]), e = h, this.s = !0, e.la(f), this.s = !1, f = { depth: p.depth, feature: p.feature, geometry: p.geometry, index: n, ka: [g[0].ka[0], g[1].ka[1]] }, this.a.za(xc(f.ka),
							f), iw(this, h, m, p.depth, -1), this.c && (this.S.da().nb(this.c), this.c = null))
					}
				c = !0;
		...
		if (0 < g.length) {
			...
			if (Math.sqrt(hc(c, m)) <= a.H) {
				...
				for (m = g.length; c < m; ++c)
					if (k = g[c].ka, fc(h[0], k[0]) && fc(h[1], k[1]) || fc(h[0], k[1]) && fc(h[1], k[0])) d[x(k)] = !0;
					else break;
				a.oa = d;
				return
			}
	...
	l.Rk = function(a, c) {
		for (var d = a.ka, e = a.feature, f = a.geometry, g = a.depth, h = a.index, k; c.length < f.qa();) c.push(0);
		switch (f.W()) {
			case "MultiLineString":
				k = f.Y();
	...
	function iw(a, c, d, e, f) { an(a.a, c.G(), function(a) { a.geometry === c && (void 0 === e || void 0 === a.depth || bb(a.depth, e)) && a.index > d && (a.index += f) }) }
	...
	function jw(a, c, d, e) { Eb.call(this, a);
		this.selected = c;
		this.deselected = d;
	...
	function kw(a) {
		...
		this.c = new H({ source: new bn({ useSpatialIndex: !1, features: c.features, wrapX: c.wrapX }), style: c.style ? c.style : mw(), updateWhileAnimating: !0, updateWhileInteracting: !0 });
		if (c.layers)
			if (ja(c.layers)) a = function(a) {
				return c.layers(a) };
			else {
				var d = c.layers;
				a = function(a) {
	...
	function lw(a) {
		...
		var c = this.B(a),
			...
			m = [],
			n = !1;
		if (f) g.od(a.pixel, function(a, c) {
			if (this.l(a, c)) { m.push(a);
				var d = x(a);
				this.a[d] = c;
				return !this.s } }, this, this.o), 0 < m.length && 1 == h.ac() && h.item(0) == m[0] || (n = !0, 0 !== h.ac() && (k = Array.prototype.concat(h.a), h.clear()), h.jf(m), 0 === m.length ? nb(this.a) : 0 < k.length && k.forEach(function(a) { a = x(a);
			delete this.a[a] }, this));
		else {
			g.od(a.pixel, function(a, f) {
				if (this.l(a, f)) {
					if (!c && !e || Va(h.a,
							a))(d || e) && Va(h.a, a) && (k.push(a), g = x(a), delete this.a[g]);
					else { m.push(a);
						var g = x(a);
						this.a[g] = f }
					return !this.s
	...
	function mw() {
		...
		return function(c) {
			return a[c.X().W()] } }
	l.am = function(a) { a = a.element;
		var c = this.A;
		c && c.ai(a) };
	l.dm = function(a) { a = a.element;
		var c = this.A;
		c && c.ci(a) };

	function nw(a) { Bj.call(this, { handleEvent: ow, handleDownEvent: fd, handleUpEvent: pw });
		a = a ? a : {};
		...
		this.a = new Wm;
		this.aa = { Point: this.jm, LineString: this.bh, LinearRing: this.bh, Polygon: this.km, MultiPoint: this.hm, MultiLineString: this.gm, MultiPolygon: this.im, GeometryCollection: this.fm } }
	y(nw, Bj);
	l = nw.prototype;
	l.rb = function(a, c) {
		var d = void 0 !== c ? c : !0,
	...
	l.pj = function(a) { this.rb(a) };
	l.qj = function(a) { this.nb(a) };
	l.$g = function(a) {
		var c;
	...
	l.ah = function(a) {
		...
		a instanceof gn ? c = a.feature : a instanceof Re && (c = a.element);
		this.nb(c) };
	l.em = function(a) { a = a.target;
		this.nb(a, !0);
		this.rb(a, !0) };
	l.pk = function(a) {
		if (this.J) {
			var c = x(a);
			c in this.B || (this.B[c] = a) } else this.di(a) };
	l.nb = function(a, c) {
		var d = void 0 !== c ? c : !0,
			e = x(a),
			f = this.U[e];
		if (f) {
			var g = this.a,
				h = [];
			an(g, f, function(c) { a === c.feature && h.push(c) });
	...
	l.bh = function(a, c) {
		var d = c.Y(),
			e, f, g, h;
		e = 0;
		for (f = d.length - 1; e < f; ++e) g = d.slice(e, e + 2), h = { feature: a, ka: g }, this.a.za(xc(g), h) };
	l.gm = function(a, c) {
		var d = c.Y(),
			e, f, g, h, k, m, n;
		h = 0;
	...
	l.hm = function(a, c) {
		var d = c.Y(),
			e, f, g;
		f = 0;
		for (g = d.length; f < g; ++f) e = d[f], e = { feature: a, ka: [e, e] }, this.a.za(c.G(), e) };
	l.im = function(a, c) {
		var d = c.Y(),
			e, f, g, h, k, m, n, p, q, r;
		m = 0;
		for (n = d.length; m < n; ++m)
			for (p = d[m], h = 0, k = p.length; h < k; ++h)
				for (e = p[h], f = 0, g = e.length - 1; f < g; ++f) q = e.slice(f, f + 2), r = { feature: a, ka: q }, this.a.za(xc(q), r) };
	l.jm = function(a, c) {
		var d = c.Y(),
			d = { feature: a, ka: [d, d] };
		this.a.za(c.G(), d) };
	...
	function rw(a, c, d) { Eb.call(this, a);
		this.features = c;
		this.coordinate = d }
	y(rw, Eb);

	function sw(a) { Bj.call(this, { handleDownEvent: tw, handleDragEvent: uw, handleMoveEvent: vw, handleUpEvent: ww });
		this.s = void 0;
		this.a = null;
	...
	function tw(a) { this.o = xw(this, a.pixel, a.map);
	...
	function vw(a) {
		...
		if (a = a.map.od(a.pixel, function(a) {
			...
			c.style.cursor = this.a ? d ? "grab" : "pointer" : "grabbing" } else c.style.cursor = void 0 !== this.s ? this.s : "", this.s = void 0 }
	...
	function X(a) {
		...
		"string" === typeof d ? e = function(a) {
				return a.get(d) } :
			e = d;
		this.c(function(a) { a = e(a);
			a = void 0 !== a ? Ma(a, 0, 1) : 1;
			var c = 255 * a | 0,
				d = this.S[c];
			d || (d = [new Kk({ image: new Wi({ opacity: a, src: this.U }) })], this.S[c] = d);
			return d }.bind(this));
	...
	l.qk = function() {
		for (var a = this.wg(), c = nh(1, 256), d = c.createLinearGradient(0, 0, 1, 256), e = 1 / (a.length - 1), f = 0, g = a.length; f < g; ++f) d.addColorStop(f * e, a[f]);
		c.fillStyle = d;
	...
	l.Hk = function(a) { a = a.context;
		...
		for (f = d.length; e < f; e += 4)
			if (g = 4 * d[e + 3]) d[e] = this.i[g], d[e + 1] = this.i[g + 1], d[e + 2] = this.i[g + 2];
		a.putImageData(c, 0, 0) };
	l.Mh = function(a) { this.set("blur", a) };
	l.Rh = function(a) { this.set("gradient", a) };
	l.fh = function(a) { this.set("radius", a) };

	function zw(a, c, d, e) {
		function f() { delete aa[h];
			g.parentNode.removeChild(g) }
		var g = aa.document.createElement("script"),
			h = "olc_" + x(c);
		g.async = !0;
		g.src = a + (-1 == a.indexOf("?") ? "?" : "&") + (e || "callback") + "=" + h;
		var k = aa.setTimeout(function() { f();
			d && d() }, 1E4);
		aa[h] = function(a) { aa.clearTimeout(k);
			f();
			c(a) };
	...
	function Aw(a, c, d, e, f, g, h, k, m, n, p) {
		...
		f = this.j.G();
		g = k ? $c(g, k) : g;
		if (0 === Tc(g)) this.state = 4;
		else if ((k = a.G()) && (f ? f = $c(f, k) : f = k), e = e.Z(this.s[0]), e = Il(a, d, Yc(g), e), !isFinite(e) || 0 >= e) this.state = 4;
		else if (this.A = new Ll(a, d, g, f, e * (void 0 !== n ? n : .5)), 0 === this.A.f.length) this.state = 4;
		else if (this.l = Dg(c, e), d = Nl(this.A), f && (a.b ? (d[1] = Ma(d[1],
				f[1], f[3]), d[3] = Ma(d[3], f[1], f[3])) : d = $c(d, f)), Tc(d))
			if (a = yg(c, d, this.l), 100 > (a.va - a.ra + 1) * (a.Aa - a.xa + 1)) {
				for (c = a.ra; c <= a.va; c++)
					for (d = a.xa; d <= a.Aa; d++)(n = m(this.l, c, d, h)) && this.g.push(n);
				0 === this.g.length && (this.state = 4) } else this.state = 3;
		else this.state = 4
	}
	y(Aw, pg);
	Aw.prototype.fa = function() { 1 == this.state && (this.Wc.forEach(sb), this.Wc = null);
		Aw.ha.fa.call(this) };
	...
	Aw.prototype.Bd = function() {
		var a = [];
		this.g.forEach(function(c) { c && 2 == c.V() && a.push({ extent: this.j.Da(c.ja), image: c.cb() }) }, this);
		this.g.length = 0;
			...
			this.g.forEach(function(c) {
				...
				if (0 == d || 1 == d) { a++;
					...
					e = D(c, "change", function() {
						var d = c.V();
						if (2 == d || 3 == d || 4 == d) sb(e), a--, 0 === a && (this.Wc.forEach(sb), this.Wc = null, this.Bd()) }, this);
					this.Wc.push(e) } }, this);
			this.g.forEach(function(a) { 0 == a.V() && a.load() });
			0 === a && aa.setTimeout(this.Bd.bind(this), 0) } };

	function Y(a) { un.call(this, { attributions: a.attributions, extent: a.extent, logo: a.logo, opaque: a.opaque, projection: a.projection, state: a.state, tileGrid: a.tileGrid, tileLoadFunction: a.tileLoadFunction ? a.tileLoadFunction : Bw, tilePixelRatio: a.tilePixelRatio, tileUrlFunction: a.tileUrlFunction, url: a.url, urls: a.urls, wrapX: a.wrapX });
	...
	l = Y.prototype;
	l.lh = function() {
		if (ng(this.a)) return !0;
		for (var a in this.i)
			if (ng(this.i[a])) return !0;
		return !1 };
	l.mh = function(a, c) {
		var d = this.td(a);
	...
	l.td = function(a) {
		var c = this.f;
		if (!c || Hd(c, a)) return this.a;
		a = x(a).toString();
		a in this.i || (this.i[a] = new mg);
		return this.i[a] };

	function Cw(a, c, d, e, f, g, h) { c = [c, d, e];
	...
	l.Qb = function(a, c, d, e, f) {
		if (this.f && f && !Hd(this.f, f)) {
			...
			if (lg(g, a)) return g.get(a);
			var h = this.f;
			d = this.Za(h);
			var k = this.Za(f),
				m = Lg(this, c, f);
			e = new Aw(h, d, f, k, c, m, this.uc(e), this.$e(), function(a, c, d, e) {
				return Dw(this, a, c, d, e, h) }.bind(this), this.oa, this.B);
			g.set(a, e);
			return e }
	...
	function Dw(a, c, d, e, f, g) {
		...
		if (lg(a.a, k)) {
			if (h = a.a.get(k), h.key != m) {
				...
				h.a && (h.a.a = null);
				a.a.replace(k, h) } } else h = Cw(a, c, d, e, f, g, m), a.a.set(k, h);
		return h }
	l.zb = function(a) {
	...
	function Bw(a, c) { a.cb().src = c };

	function Ew(a) { Y.call(this, { crossOrigin: "anonymous", opaque: !0, projection: qd("EPSG:3857"), reprojectionErrorThreshold: a.reprojectionErrorThreshold, state: "loading", tileLoadFunction: a.tileLoadFunction, wrapX: void 0 !== a.wrapX ? a.wrapX : !0 });
	...
	Ew.prototype.s = function(a) {
		if (200 != a.statusCode || "OK" != a.statusDescription || "ValidCredentials" != a.authenticationResultCode || 1 != a.resourceSets.length || 1 != a.resourceSets[0].resources.length) tg(this, "error");
		else {
			...
			a = Fg(this.f);
			var f = Hg({ extent: a, minZoom: d.zoomMin, maxZoom: e, tileSize: d.imageWidth == d.imageHeight ? d.imageWidth : [d.imageWidth, d.imageHeight] });
			this.tileGrid =
				f;
			var g = this.l;
			this.tileUrlFunction = rn(d.imageUrlSubdomains.map(function(a) {
				...
				return function(a) {
					if (a) return Ke(a[0], a[1], -a[2] - 1, c), e.replace("{quadkey}", Le(c)) } }));
				...
				a = d.imageryProviders.map(function(a) {
					...
					a.coverageAreas.forEach(function(a) {
						...
						for (k = c; k <= g; ++k) m = k.toString(),
							c = yg(f, a, k), m in d ? d[m].push(c) : d[m] = [c]
					});
					return new Qe({ html: c, tileRanges: d })
				});
				a.push(Fw);
				this.ma(a)
			}
	...
	function Gw(a) { bn.call(this, { attributions: a.attributions, extent: a.extent, logo: a.logo, projection: a.projection, wrapX: a.wrapX });
		this.B = void 0;
	...
	Gw.prototype.aa = function() {
		return this.s };
	Gw.prototype.Oc = function(a, c, d) { this.s.Oc(a, c, d);
		c !== this.B && (this.clear(), this.B = c, Hw(this), this.Gc(this.A)) };
	Gw.prototype.na = function() { this.clear();
		Hw(this);
		this.Gc(this.A);
		this.u() };

	function Hw(a) {
		if (void 0 !== a.B) { a.A.length = 0;
			for (var c = yc(), d = a.U * a.B, e = a.s.oe(), f = {}, g = 0, h = e.length; g < h; g++) {
				var k = e[g];
				x(k).toString() in f || (k = k.X().Y(), Jc(k, c), Ac(c, d, c), k = a.s.Ze(c), k = k.filter(function(a) { a = x(a).toString();
					return a in f ? !1 : f[a] = !0 }), a.A.push(Iw(k))) } } }
	...
	function Jw(a) { Pl.call(this, { projection: a.projection, resolutions: a.resolutions });
	...
	l.pd = function(a, c, d) {
		...
		d = this.aa ? d : 1;
		var e = this.i;
		if (e && this.H == this.g && e.Z() == c && e.f == d && Gc(e.G(), a)) return e;
	...
	l.sm = function() {
		return this.c };
	l.vm = function(a) { mb(this.j, a);
		this.u() };
	l.um = function(a) { this.i = null;
		this.c = a;
		this.u() };
	...
	function Kw(a) {
		...
		Pl.call(this, { attributions: c, logo: a.logo, projection: qd(a.projection) });
	...
	function Lw(a) { a = a || {};
		Pl.call(this, { attributions: a.attributions, logo: a.logo, projection: a.projection, resolutions: a.resolutions });
	...
	l.Bm = function(a, c, d, e) {
		if (void 0 !== this.j) {
			var f = Zc(a, c, 0, Nw),
				g = { SERVICE: "WMS", VERSION: "1.3.0", REQUEST: "GetFeatureInfo", FORMAT: "image/png", TRANSPARENT: !0, QUERY_LAYERS: this.i.LAYERS };
			mb(g, this.i, e);
	...
	l.pd = function(a, c, d, e) {
		...
		var f = (a[0] + a[2]) / 2,
			...
			h = Xc(a) / h,
			m = this.c;
		if (m && this.U == this.g && m.Z() == c && m.f == d && Gc(m.G(), a)) return m;
		if (1 != this.o) {
			var m = this.o * Wc(a) / 2,
				n = this.o * Xc(a) / 2;
			a[0] = f - m;
	...
	function Ow(a, c, d, e, f, g) { g[a.s ? "CRS" : "SRS"] = f.lb; "STYLES" in a.i || (g.STYLES = new String(""));
		if (1 != e) switch (a.aa) {
			case "geoserver":
				e = 90 * e + .5 | 0;
	...
	l.Em = function() {
		return this.j };
	l.Fm = function(a) { this.c = null;
		this.H = a;
		this.u() };
	l.Gm = function(a) { a != this.j && (this.j = a, this.c = null, this.u()) };
	l.Hm = function(a) { mb(this.i, a);
		Mw(this);
		this.c = null;
		this.u() };

	function Mw(a) { a.s = 0 <= Ka(a.i.VERSION || "1.3.0", "1.3") };

	function Pw(a) {
		var c = void 0 !== a.projection ? a.projection : "EPSG:3857",
			d = void 0 !== a.tileGrid ? a.tileGrid : Hg({ extent: Fg(c), maxZoom: a.maxZoom, tileSize: a.tileSize });
	...
	function Qw(a) { a = a || {};
		...
		Pw.call(this, { attributions: c, crossOrigin: void 0 !== a.crossOrigin ? a.crossOrigin : "anonymous", opaque: void 0 !== a.opaque ? a.opaque : !0, maxZoom: void 0 !== a.maxZoom ? a.maxZoom : 19, reprojectionErrorThreshold: a.reprojectionErrorThreshold, tileLoadFunction: a.tileLoadFunction, url: void 0 !== a.url ? a.url : "https://{a-c}.tile.openstreetmap.org/{z}/{x}/{y}.png", wrapX: a.wrapX }) }
	y(Qw, Pw);
	...
	function Sw(a) { a = a || {};
		var c = Tw[a.layer];
		this.c = a.layer;
		Pw.call(this, { attributions: c.attributions, crossOrigin: "anonymous", logo: "https://developer.mapquest.com/content/osm/mq_logo.png", maxZoom: c.maxZoom, reprojectionErrorThreshold: a.reprojectionErrorThreshold, opaque: c.opaque, tileLoadFunction: a.tileLoadFunction, url: void 0 !== a.url ? a.url : "https://otile{1-4}-s.mqcdn.com/tiles/1.0.0/" + this.c + "/{z}/{x}/{y}.jpg" }) }
	y(Sw, Pw);
	var Uw = new Qe({ html: 'Tiles Courtesy of <a href="http://www.mapquest.com/">MapQuest</a>' }),
		Tw = { osm: { maxZoom: 19, opaque: !0, attributions: [Uw, Rw] }, sat: { maxZoom: 18, opaque: !0, attributions: [Uw, new Qe({ html: "Portions Courtesy NASA/JPL-Caltech and U.S. Depart. of Agriculture, Farm Service Agency" })] }, hyb: { maxZoom: 18, opaque: !1, attributions: [Uw, Rw] } };
	...
	(function() {
		...
		(function(d) {
			...
			return function e(a, c, h) {
				...
				1: [function(a, c, g) { a = a("./processor");
					g.Hi = a }, { "./processor": 2 }],
				2: [function(a, c) {
					function g(a) {
						return function(c) {
							var e = c.buffers,
								...
								m = e[0].byteLength,
								C;
							if (c.imageOps) { m = Array(k);
								for (C = 0; C < k; ++C) m[C] = new ImageData(new Uint8ClampedArray(e[C]), g, h);
								g = a(m, f).data } else {
								g = new Uint8ClampedArray(m);
								h = Array(k);
								c = Array(k);
								for (C =
									0; C < k; ++C) h[C] = new Uint8ClampedArray(e[C]), c[C] = [0, 0, 0, 0];
								for (e = 0; e < m; e += 4) {
									for (C = 0; C < k; ++C) {
										var A = h[C];
										c[C][0] = A[e];
					...
					function h(a, c) {
						var e = Object.keys(a.lib || {}).map(function(c) {
								return "var " + c + " = " + a.lib[c].toString() + ";" }).concat(["var __minion__ = (" + g.toString() + ")(", a.operation.toString(), ");", 'self.addEventListener("message", function(__event__) {', "var buffer = __minion__(__event__.data);",
					...
					function k(a, c) {
						var e = g(a.operation);
						return { postMessage: function(a) { setTimeout(function() { c({ data: { buffer: e(a), fe: a.fe } }) }, 0) } } }
					...
					function m(a) {
						...
						var e = [];
						if (c)
							for (var f = 0; f < c; ++f) e[f] = h(a, this.Zf.bind(this, f));
						else e[0] = k(a, this.Zf.bind(this,
							0));
						this.Nd = e;
						this.ad = [];
					...
					m.prototype.In = function(a, c, e) { this.Ti({ wc: a, fe: c, gg: e });
						this.Wf() };
					m.prototype.Ti = function(a) {
						for (this.ad.push(a); this.ad.length > this.Wi;) this.ad.shift().gg(null, null) };
					m.prototype.Wf = function() {
						if (0 === this.Ld && 0 < this.ad.length) {
							...
							if (1 === g) this.Nd[0].postMessage({
								...
								for (var h = 4 * Math.ceil(a.wc[0].data.length / 4 / g), k = 0; k < g; ++k) {
									for (var m = k * h, C = [], A = 0, B = f.length; A < B; ++A) C.push(f[k].slice(m, m + h));
									this.Nd[k].postMessage({ buffers: C, meta: a.fe, imageOps: this.Oe, width: c, height: e }, C) }
						}
					};
					m.prototype.Zf = function(a, c) { this.ep || (this.Fc[a] = c.data, --this.Ld, 0 === this.Ld && this.Xi()) };
					m.prototype.Xi = function() {
						var a = this.Pe,
							c = this.Nd.length,
							e, f;
						if (1 === c) e = new Uint8ClampedArray(this.Fc[0].buffer), f = this.Fc[0].meta;
						else {
	...
	function Vw(a) {
		...
		this.c = Ww(a.sources);
		for (var c = 0, d = this.c.length; c < d; ++c) D(this.c[c], "change", this.u, this);
		this.i = nh();
		this.aa = new jj(function() {
			return 1 }, this.u.bind(this));
		for (var c = Xw(this.c), d = {}, e = 0, f = c.length; e < f; ++e) d[x(c[e].layer)] = c[e];
		this.j = this.o = null;
		this.U = {
			animate: !1,
			attributions: {},
	...
	y(Vw, Pl);
	Vw.prototype.s = function(a, c) { this.H = new Vm.Hi({ operation: a, Pk: "image" === this.ya, Kn: 1, lib: c, threads: this.qb });
		this.u() };
	...
	Vw.prototype.B = function(a, c, d, e) {
		...
		for (var f, g = 0, h = this.c.length; g < h; ++g)
			if (f = this.c[g].a.da(), "ready" !== f.V()) { d = !1;
				break }
		if (!d) return null;
		if (!Yw(this, a, c)) return this.j;
		d = this.i.canvas;
		f = Math.round(Wc(a) / c);
		g = Math.round(Xc(a) / c);
		...
		h.resolution = c;
		this.j = e =
			new Gl(a, c, 1, this.ea(), d, this.S.bind(this, f));
		this.o = { extent: a, resolution: c, oo: this.g };
		return e
	};
	Vw.prototype.S = function(a, c) {
		for (var d = this.c.length, e = Array(d), f = 0; f < d; ++f) {
			...
			if (g.l(h, k)) {
				...
				if (Zw) {
					var p = Zw.canvas;
					p.width !== m || p.height !== n ? Zw = nh(m, n) : Zw.clearRect(0, 0, m, n) } else Zw = nh(m, n);
				g.c(h, k, Zw);
				g = Zw.getImageData(0, 0, m, n) } else g = null;
			if (g) e[f] = g;
			else return }
		d = {};
		this.b(new $w(ax, a, d));
	...
	Vw.prototype.oa = function(a, c, d, e, f) { d ? c(d) : e && (this.b(new $w(bx, a, f)), Yw(this, a.extent, a.viewState.resolution / a.pixelRatio) || this.i.putImageData(e, 0, 0), c(null)) };
	var Zw = null;
	...
	function $w(a, c, d) { Eb.call(this, a);
	...
	var ax = "beforeoperations",
		bx = "afteroperations";
	var cx = { terrain: { tb: "jpg", opaque: !0 }, "terrain-background": { tb: "jpg", opaque: !0 }, "terrain-labels": { tb: "png", opaque: !1 }, "terrain-lines": { tb: "png", opaque: !1 }, "toner-background": { tb: "png", opaque: !0 }, toner: { tb: "png", opaque: !0 }, "toner-hybrid": { tb: "png", opaque: !1 }, "toner-labels": { tb: "png", opaque: !1 }, "toner-lines": { tb: "png", opaque: !1 }, "toner-lite": { tb: "png", opaque: !0 }, watercolor: { tb: "jpg", opaque: !0 } },
		dx = { terrain: { minZoom: 4, maxZoom: 18 }, toner: { minZoom: 0, maxZoom: 20 }, watercolor: { minZoom: 3, maxZoom: 16 } };

	function ex(a) {
		var c = a.layer.indexOf("-"),
			c = -1 == c ? a.layer : a.layer.slice(0, c),
			d = cx[a.layer];
		Pw.call(this, { attributions: fx, crossOrigin: "anonymous", maxZoom: dx[c].maxZoom, opaque: d.opaque, reprojectionErrorThreshold: a.reprojectionErrorThreshold, tileLoadFunction: a.tileLoadFunction, url: void 0 !== a.url ? a.url : "https://stamen-tiles-{a-d}.a.ssl.fastly.net/" + a.layer + "/{z}/{x}/{y}." + d.tb }) }
	y(ex, Pw);
	...
	function gx(a) { a = a || {};
		Y.call(this, { attributions: a.attributions, crossOrigin: a.crossOrigin, logo: a.logo, projection: a.projection, reprojectionErrorThreshold: a.reprojectionErrorThreshold, tileGrid: a.tileGrid, tileLoadFunction: a.tileLoadFunction, url: a.url, urls: a.urls, wrapX: void 0 !== a.wrapX ? a.wrapX : !0 });
		this.c = a.params || {};
		this.l = yc() }
	y(gx, Y);
	...
	gx.prototype.qc = function(a, c, d) {
		...
		if (!(e.Pb().length <= a[0])) {
			...
			mb(e, this.c);
			var h = this.urls;
			h ? (d = d.lb.split(":").pop(), e.SIZE = g[0] + "," + g[1], e.BBOX = f.join(","), e.BBOXSR = d, e.IMAGESR = d, e.DPI = Math.round(e.DPI ? e.DPI * c : 90 * c), a = (1 == h.length ? h[0] : h[$b((a[1] << a[0]) + a[2], h.length)]).replace(/MapServer\/?$/, "MapServer/export").replace(/ImageServer\/?$/, "ImageServer/exportImage"),
				a = Xq(Zq([a], e))) : a = void 0;
			return a
		}
	};
	gx.prototype.A = function(a) { mb(this.c, a);
		this.u() };

	function hx(a, c, d) { pg.call(this, a, 2);
		this.i = c;
		this.c = d;
		this.g = {} }
	y(hx, pg);
	hx.prototype.cb = function(a) { a = void 0 !== a ? x(a) : -1;
	...
	function ix(a) { Ig.call(this, { opaque: !1, projection: a.projection, tileGrid: a.tileGrid, wrapX: void 0 !== a.wrapX ? a.wrapX : !0 }) }
	y(ix, Ig);
	...
	function jx(a) { Y.call(this, { attributions: a.attributions, crossOrigin: a.crossOrigin, projection: qd("EPSG:3857"), reprojectionErrorThreshold: a.reprojectionErrorThreshold, state: "loading", tileLoadFunction: a.tileLoadFunction, wrapX: void 0 !== a.wrapX ? a.wrapX : !0 });
		if (a.jsonp) zw(a.url, this.l.bind(this), this.c.bind(this));
		else {
			...
			c.send() } }
	y(jx, Y);
	jx.prototype.A = function(a) { a = a.target;
		if (200 <= a.status && 300 > a.status) {
			var c;
			try { c = JSON.parse(a.responseText) } catch (d) { this.c();
				return }
			this.l(c) } else this.c() };
	jx.prototype.s = function() { this.c() };
	jx.prototype.l = function(a) {
		...
		var f = a.minzoom || 0,
			g = a.maxzoom || 22;
		this.tileGrid = d = Hg({ extent: Fg(d), maxZoom: g, minZoom: f });
		this.tileUrlFunction = qn(a.tiles, d);
		if (void 0 !== a.attribution && !this.ea()) { c = void 0 !== e ? e : c.G();
			e = {};
			for (var h; f <= g; ++f) h = f.toString(), e[h] = [yg(d, c, f)];
			this.ma([new Qe({ html: a.attribution, tileRanges: e })]) }
		tg(this, "ready") };
	jx.prototype.c = function() { tg(this, "error") };

	function kx(a) { Ig.call(this, { projection: qd("EPSG:3857"), state: "loading" });
	...
	l.bk = function() {
		return this.c };
	l.oj = function(a, c, d, e, f) { this.tileGrid ? (c = this.tileGrid.Zd(a, c), lx(this.Qb(c[0], c[1], c[2], 1, this.f), a, d, e, f)) : !0 === f ? bh(function() { d.call(e, null) }) : d.call(e, null) };
	l.Jm = function(a) {
		var c = qd("EPSG:4326"),
			d = this.f,
			e;
		...
		var h = a.grids;
		if (h) { this.i = qn(h, d);
			if (void 0 !== a.attribution) { c = void 0 !== e ? e : c.G();
				for (e = {}; f <= g; ++f) h = f.toString(), e[h] = [yg(d, c, f)];
				this.ma([new Qe({ html: a.attribution, tileRanges: e })]) }
			tg(this, "ready") } else tg(this, "error") };
	l.Qb = function(a, c, d, e, f) {
		var g = this.Db(a, c, d);
		if (lg(this.a, g)) return this.a.get(g);
		a = [a, c, d];
	...
	function mx(a, c, d, e, f) { pg.call(this, a, c);
		this.l = d;
		this.g = e;
		this.o = f;
	...
	function lx(a, c, d, e, f) { 0 == a.state && !0 === f ? (xb(a, "change", function() { d.call(e, this.getData(c)) }, a), nx(a)) : !0 === f ? bh(function() { d.call(e, this.getData(c)) }, a) : d.call(e, a.getData(c)) }
	l.eb = function() {
		return this.l };
	l.nk = function() { this.state = 3;
		qg(this) };
	l.Im = function(a) { this.c = a.grid;
		this.i = a.keys;
		this.j = a.data;
		this.state = 4;
		qg(this) };

	function nx(a) { 0 == a.state && (a.state = 1, zw(a.l, a.Im.bind(a), a.nk.bind(a))) }
	l.load = function() { this.o && nx(this) };

	function ox(a) {
		a = a || {};
		var c = a.params || {};
		Y.call(this, { attributions: a.attributions, crossOrigin: a.crossOrigin, logo: a.logo, opaque: !("TRANSPARENT" in c ? c.TRANSPARENT : 1), projection: a.projection, reprojectionErrorThreshold: a.reprojectionErrorThreshold, tileGrid: a.tileGrid, tileLoadFunction: a.tileLoadFunction, url: a.url, urls: a.urls, wrapX: void 0 !== a.wrapX ? a.wrapX : !0 });
	...
	l.Km = function(a, c, d, e) { d = qd(d);
		...
		if (!(f.Pb().length <= c[0])) {
			...
			k = { SERVICE: "WMS", VERSION: "1.3.0", REQUEST: "GetFeatureInfo", FORMAT: "image/png", TRANSPARENT: !0, QUERY_LAYERS: this.c.LAYERS };
			mb(k, this.c, e);
	...
	function sx(a, c, d, e, f, g, h) {
		...
		if (k) {
			...
			h.BBOX = e.join(",");
			return Xq(Zq([1 == k.length ? k[0] : k[$b((c[1] <<
				c[0]) + c[2], k.length)]], h))
		}
	}
	l.uc = function(a) {
	...
	l.qc = function(a, c, d) {
		var e = this.tileGrid;
		e || (e = this.Za(d));
		if (!(e.Pb().length <= a[0])) { 1 == c || this.S && void 0 !== this.A || (c = 1);
			var f = e.Z(a[0]),
				g = e.Da(a, this.U),
	...
	l.Mm = function(a) { mb(this.c, a);
		qx(this);
		px(this);
		rx(this);
		this.u() };

	function rx(a) { a.l = 0 <= Ka(a.c.VERSION || "1.3.0", "1.3") };

	function tx(a) { this.j = a.matrixIds;
		ug.call(this, { extent: a.extent, origin: a.origin, origins: a.origins, resolutions: a.resolutions, tileSize: a.tileSize, tileSizes: a.tileSizes, sizes: a.sizes }) }
	y(tx, ug);
	...
	function ux(a, c) {
		...
		a.TileMatrix.forEach(function(a) { e.push(a.Identifier);
		...
		return new tx({ extent: c, origins: f, resolutions: d, matrixIds: e, tileSizes: g, sizes: h })
	};

	function Z(a) {
		function c(a) { a = "KVP" == e ? Xq(Zq([a], g)) : a.replace(/\{(\w+?)\}/g, function(a, c) {
		...
		var e = this.aa = void 0 !== a.requestEncoding ? a.requestEncoding : "KVP",
			f = a.tileGrid,
			g = { layer: this.H, style: this.S, tilematrixset: this.s };
		"KVP" == e && mb(g, { Service: "WMTS", Request: "GetTile", Version: this.U, Format: this.A });
		var h = this.c,
	...
	function wx(a) {
		...
		g.reverse();
		var c = [0, -c[1], c[0], 0],
			c = new ug({ extent: c, origin: Sc(c), resolutions: g }),
			k = a.url;
		Y.call(this, { attributions: a.attributions, crossOrigin: a.crossOrigin, logo: a.logo, reprojectionErrorThreshold: a.reprojectionErrorThreshold, tileClass: xx, tileGrid: c, tileUrlFunction: function(a) {
				if (a) {
					var c = a[0],
						d = a[1];
					a = -a[2] - 1;
	...
	function xx(a, c, d, e, f) { tv.call(this, a, c, d, e, f);
		this.i = {} }
	y(xx, tv);
	...
	function Jk(a, c, d, e, f, g) {
		if (d + a.b > a.g || e + a.b > a.g) return null;
		f = yx(a, !1, c, d, e, f);
		if (!f) return null;
		a = yx(a, !0, c, d, e, void 0 !== g ? g : gd);
		return { offsetX: f.offsetX, offsetY: f.offsetY, image: f.image, Ig: a.image } }
		...
		for (n = h.length; m < n; ++m) {
			...
			a: {
				var p = k,
					...
					v = g,
					w = void 0,
					z = void 0;k = void 0;z = 0;
				for (k = p.a.length; z < k; ++z)
					if (w = p.a[z], w.width >= r + p.b && w.height >= t + p.b) {
						k = { offsetX: w.x + p.b, offsetY: w.y + p.b, image: p.g };
						p.f[q] = k;
						...
						p = t + p.b;
						v = t = void 0;
						w.width - r > w.height - p ? (t = { x: w.x + r, y: w.y, width: w.width - r, height: w.height }, v = { x: w.x, y: w.y + p, width: r, height: w.height - p }, zx(q, z, t, v)) : (t = { x: w.x + r, y: w.y, width: w.width - r, height: p },
							v = { x: w.x, y: w.y + p, width: w.width, height: w.height - p }, zx(q, z, t, v));
						break a
					}
				k = null
			}
	...
	function Bx(a) {
		...
		var c = a.atlasManager,
			...
			g = null,
			h, k = 0;
		this.a && (h = Ze(this.a.b), k = this.a.a, void 0 === k && (k = 1), g = this.a.g, Ah || (g = null), e = this.a.c, void 0 === e && (e = "round"), d = this.a.f, void 0 === d && (d = "round"), f = this.a.i, void 0 ===
			f && (f = 10));
		var m = 2 * (this.g + k) + 1,
			d = { strokeStyle: h, Dd: k, size: m, lineCap: d, lineDash: g, lineJoin: e, miterLimit: f };
		if (void 0 === c) { this.f = document.createElement("CANVAS");
			this.f.height = m;
			this.f.width = m;
			var c = m = this.f.width,
				n = this.f.getContext("2d");
			this.sh(d, n, 0, 0);
			this.o ? this.T = this.f : (n = this.T = document.createElement("CANVAS"), n.height = d.size, n.width = d.size, n = n.getContext("2d"), this.rh(d, n, 0, 0)) } else m = Math.round(m), (e = !this.o) && (n = this.rh.bind(this, d)), f = this.a ? Hk(this.a) : "-", g = this.o ? Bk(this.o) : "-", this.c &&
	...
	l.sh = function(a, c, d, e) {
		...
		for (d = 0; d <= this.b; d++) e = 2 * d * Math.PI / this.b - Math.PI / 2 + this.l, f = 0 === d % 2 ? this.g : this.i, c.lineTo(a.size / 2 + f * Math.cos(e), a.size / 2 + f * Math.sin(e));
		...
		c.closePath() };
	l.rh = function(a, c, d, e) { c.setTransform(1, 0, 0, 1, 0, 0);
		c.translate(d, e);
		c.beginPath();
		this.i !== this.g && (this.b *= 2);
		var f;
		for (d = 0; d <= this.b; d++) f = 2 * d * Math.PI / this.b - Math.PI / 2 + this.l, e = 0 === d % 2 ? this.g : this.i, c.lineTo(a.size / 2 + e * Math.cos(f), a.size / 2 + e * Math.sin(f));
		c.fillStyle = wk;
		c.fill();
		this.a && (c.strokeStyle = a.strokeStyle, c.lineWidth = a.Dd, a.lineDash && c.setLineDash(a.lineDash), c.stroke());
		c.closePath() };
	...
	u("ol.extent.getSize", function(a) {
		return [a[2] - a[0], a[3] - a[1]] }, OPENLAYERS);
	...
	u("ol.loadingstrategy.tile", function(a) {
		return function(c, d) {
			...
			for (e[1] = f.ra; e[1] <= f.va; ++e[1])
				for (e[2] = f.xa; e[2] <= f.Aa; ++e[2]) g.push(a.Da(e));
			return g } }, OPENLAYERS);
	...
	u("ol.render.toContext", function(a, c) {
		...
		return new Rk(a, f, d, e, 0) }, OPENLAYERS);
	...
	u("ol.style.AtlasManager", function(a) { a = a || {};
		...
		this.f = this.a;
		this.i = [new Ax(this.f, this.b)] }, OPENLAYERS);
	...
	u("ol.source.WMTS.optionsFromCapabilities", function(a, c) {
		...
		f = 1 < d.TileMatrixSetLink.length ? "projection" in c ? eb(d.TileMatrixSetLink, function(a) {
			return $a(e, function(c) {
				return c.Identifier == a.TileMatrixSet }).SupportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/, "$1:$3") == c.projection }) : eb(d.TileMatrixSetLink, function(a) {
			return a.TileMatrixSet == c.matrixSet }) : 0;
		0 > f && (f = 0);
		...
		var p = d.WGS84BoundingBox,
			q, r;
		void 0 !== p &&
			(r = qd("EPSG:4326").G(), r = p[0] == r[0] && p[2] == r[2], q = Ld(p, "EPSG:4326", n), (p = n.G()) && (Gc(p, q) || (q = void 0)));
		var m = ux(m, q),
			t = [];
		q = c.requestEncoding;
		q = void 0 !== q ? q : "";
		if (a.hasOwnProperty("OperationsMetadata") && a.OperationsMetadata.hasOwnProperty("GetTile") && 0 !== q.indexOf("REST"))
			for (var d = a.OperationsMetadata.GetTile.DCP.HTTP.Get, p = 0, v = d.length; p < v; ++p) {
				var w = $a(d[p].Constraint, function(a) {
					return "GetEncoding" == a.name }).AllowedValues.Value;
				0 < w.length && Va(w, "KVP") && (q = "KVP", t.push(d[p].href)) } else q = "REST",
				d.ResourceURL.forEach(function(a) { "tile" == a.resourceType && (h = a.format, t.push(a.template)) });
		return { urls: t, layer: c.layer, matrixSet: g, format: h, projection: n, requestEncoding: q, tileGrid: m, style: f, dimensions: k, wrapX: r }
	}, OPENLAYERS);
	...
	u("ol.proj.setProj4", function(a) { pd = a }, OPENLAYERS);
	...
	u("ol.proj.fromLonLat", function(a, c) {
		return Kd(a, "EPSG:4326", void 0 !== c ? c : "EPSG:3857") }, OPENLAYERS);
	u("ol.proj.toLonLat", function(a, c) {
		return Kd(a, void 0 !== c ? c : "EPSG:3857", "EPSG:4326") }, OPENLAYERS);
	...
	u("ol.events.condition.altKeyOnly", function(a) { a = a.originalEvent;
		return a.altKey && !(a.metaKey || a.ctrlKey) && !a.shiftKey }, OPENLAYERS);
	...
	u("ol.events.condition.doubleClick", function(a) {
		return a.type == si }, OPENLAYERS);
	u("ol.events.condition.noModifierKeys", xj, OPENLAYERS);
	u("ol.events.condition.platformModifierKeyOnly", function(a) { a = a.originalEvent;
		return !a.altKey && (yh ? a.metaKey : a.ctrlKey) && !a.shiftKey }, OPENLAYERS);
